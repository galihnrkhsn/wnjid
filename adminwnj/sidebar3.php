    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapsePP" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Pilihan:</h6>
            <a class="collapse-item" href="produk.php?id=0">Produk Pusat</a>
            <a class="collapse-item" href="produkb.php">Produk GB</a>
  ...
  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
   ...
   <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="ticketDropdown" role="button"
                                ...
                                <i class="fas fa-fw fa-line-chart fa-fw fa-2x"></i>
                                <!-- Counter - Alerts -->
                                 <?php 
                             include "koneksi.php";
                                 
                            
                            $sql = "SELECT COUNT(*) as jumlah FROM adsmitra WHERE status='Antrian' ";
                            $query = $koneksi->query($sql);
                            $jumlahads = $query->fetch_assoc();
                        
                            
                             ?>
                                
                                <h4><span class="badge badge-danger badge-counter"><?php echo $jumlahads['jumlah']; ?></span></h4>
                            </a>
                            <!-- Dropdown - Alerts -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                             ...
                             $tampilkanads =$koneksi->query("SELECT admin_mitra.namamitra,adsmitra.status,adsmitra.targetkota
  FROM adsmitra inner join admin_mitra ON adsmitra.idmitra=admin_mitra.idadmin
  WHERE adsmitra.status='Antrian' limit 3");
                                
                            while($tampilAds=$tampilkanads->fetch_assoc()){
                            ?>
                            
                                <a class="dropdown-item d-flex align-items-center" href="dataads.php">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Status : <?php echo $tampilAds['status']; ?></div>
                                        <span class="font-weight-bold">Nama : <?php echo $tampilAds['namamitra']; ?></span>
                                        <br>
                                        <span class="font-weight-bold">Target Kota : <?php echo $tampilAds['targetkota']; ?></span>
                                    </div>
                                </a>
                                 <?php } ?>
                                <a class="dropdown-item text-center small text-gray-500" href="dataads.php">Lihat Semua</a>
                            </div>
                        </li>
      ...
      <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            $sql = "SELECT COUNT(*) as jumlah FROM pendaftaran WHERE status='Pendaftar Baru' ";
                            $query = $koneksi->query($sql);
                            $jumlahbaru = $query->fetch_assoc();
                        
                            
                             ?>
                                
                                <h4><span class="badge badge-danger badge-counter"><?php echo $jumlahbaru['jumlah']; ?></span></h4>
                            </a>
                            <!-- Dropdown - Alerts -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                             ...
                             $tampil =$koneksi->query("SELECT * FROM pendaftaran where status='Pendaftar Baru' limit 3");
                                
                            while($tampilCalon=$tampil->fetch_assoc()){
                            ?>
                            <?php if($tampilCalon['daftarsebagai']=="Distributor"){ ?>
                                <a class="dropdown-item d-flex align-items-center" href="daftarbaru.php?id=<?= $tampilCalon["idpendaftaran"]; ?>">
                                    <?php } else{?>
                                        <a class="dropdown-item d-flex align-items-center" href="daftarbarusubdb.php?id=<?= $tampilCalon["idpendaftaran"]; ?>">
                                    <?php }?>
                                    <div class="mr-3">
                                        <div class="icon-circle bg-primary">
                                            <i class="fas fa-user-circle text-white"></i>
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Status : <?php echo $tampilCalon['status']; ?></div>
                                        <span class="font-weight-bold">Nama : <?php echo $tampilCalon['namalengkap']; ?></span>
                                        <br>
                                        <span class="font-weight-bold">Email : <?php echo $tampilCalon['email']; ?></span>
                                    </div>
                                </a>
                                 <?php } ?>
                                <a class="dropdown-item text-center small text-gray-500" href="datapendaftaran.php">Lihat Semua</a>
                            </div>
                        </li>
                        <div class="topbar-divider d-none d-sm-block"></div>
<!-- Nav Item - Alerts -->
      <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="ticketDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-ticket-alt fa-fw fa-2x"></i>
                                <!-- Counter - Alerts -->
                                 <?php 
                             include "koneksi.php";
                                 
                            
                            $sql = "SELECT COUNT(*) as jumlah FROM support_ticket WHERE status='Ticket Diajukan' ";
                            $query = $koneksi->query($sql);
                            $jumlahticket = $query->fetch_assoc();
                        
                            
                             ?>
                                
                                <h4><span class="badge badge-danger badge-counter"><?php echo $jumlahticket['jumlah']; ?></span></h4>
                            </a>
                            <!-- Dropdown - Alerts -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="ticketDropdown">
                                <h6 class="dropdown-header">
                                    Daftar Ticket Support
                                </h6>
                                <?php 
                             include "koneksi.php";
                                 
                            
                             $tampil =$koneksi->query("SELECT admin_mitra.namamitra,support_ticket.status,support_ticket.masalah,support_ticket.idsupport
  FROM support_ticket inner join admin_mitra ON support_ticket.idadmin=admin_mitra.idadmin
  WHERE support_ticket.status='Ticket Diajukan' limit 3");
                                
                            while($tampilTicket=$tampil->fetch_assoc()){
                            ?>
                            
                                <a class="dropdown-item d-flex align-items-center" href="detailsupport.php?id=<?= $tampilTicket["idsupport"]; ?>">
                                    <div class="mr-3">
                                        <div class="icon-circle bg-primary">
                                            <i class="fas fa-user-circle text-white"></i>
                                        </div>
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Status : <?php echo $tampilTicket['status']; ?></div>
                                        <span class="font-weight-bold">Nama : <?php echo $tampilTicket['namamitra']; ?></span>
                                        <br>
                                        <span class="font-weight-bold">Masalah : <?php echo $tampilTicket['masalah']; ?></span>
                                    </div>
                                </a>
                                 <?php } ?>
                                <a class="dropdown-item text-center small text-gray-500" href="return.php">Lihat Semua</a>
                            </div>
                        </li>
                        <div class="topbar-divider d-none d-sm-block"></div>

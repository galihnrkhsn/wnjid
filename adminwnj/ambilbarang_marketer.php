              ...
              <th>Ambil</th>
                      ...
                      <tbody>
                          <?php 
                            ...
                            INNER JOIN produk 
                            on ordermarketer.idproduk=produk.idproduk and ordermarketer.idmitramarketer=mitramarketer.idmitramarketer
...
if($datacocok==1){
      $sqlnya = $koneksi->query("UPDATE surat_jalan_subdb set progres=progres + '$progres' where idorder='$updateid'");
                    ...
                    $data=$koneksi->query("SELECT * FROM ordermarketer
                ...
                if ($sqlnya) {
                  ...
                  echo "<script>location='ambilbarang_marketer.php?invoice=$invoice';</script>";  
                  }else{

 ...
 <?php include "sidebar.php"; ?>
                      ...
                      <tbody>
                            ...
                            $no = 1;
                              $dataproduk = $koneksi->query("SELECT kategori.namakategori,produk.idproduk,produk.berat,produk.namaproduk,produk.harga,produk.tgl,produk.stock,produk.foto  FROM produk inner join kategori ON 
                                produk.idkategori=kategori.idkategori where produk.idkategori=2 order by produk.namaproduk asc");
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <form method="post">  <input type="hidden" name="idproduk" value="<?php echo $tampilkan['idproduk']; ?>">
                                    <input type="text" class="form-control" name="stok" size="1">
                                    <button type="submit" class="btn btn-success btn-xs" name="ubah">Ubah</button>
                                </form>
                            </td>
                            <td>
                                <a href="editproduk.php?idproduk=<?php echo $tampilkan['idproduk']; ?>">Edit</a><hr>
                                <?php 
                                    if($tampilkan['foto']=='') {  
                                ...
                                <hr>
                                <form method="post"> 
                                    <input type="hidden" name="id" value=<?php echo $tampilkan['idproduk']; ?>>
  ...
  <?php
                            ...
                            if(isset($_POST["hapus"])){
                                ...
                                $id = $_POST['id'];
                                $koneksi->query("DELETE FROM produk WHERE idproduk='$id'" );

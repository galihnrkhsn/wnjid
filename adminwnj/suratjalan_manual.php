      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Surat Jalan Manual</h1>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">List Surat Jalan Manual</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div>
            ...
            ORDER BY 
                ...
                <td>
                  <?php if (strtotime($tampilkan['waktu']) > strtotime('2024-11-02 23:59:59')) :?>
                    <a href="detail_surat_manual2.php?no_sj=<?= $tampilkan['no_sj'] ?>"><?= $tampilkan['no_sj'] ?></a>
                    <?php else : ?>

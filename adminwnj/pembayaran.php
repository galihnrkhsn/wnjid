                        ...
                        <?php
                            if(isset($_POST["done"])){
                                ...
                                for ($x = 0; $x < $jumlah_dipilih; $x++) {
                                    $koneksi->query("UPDATE ordermitra set payment = 'Lunas', status = 'Proses', status_progres = 0 WHERE invoice = '$invoice[$x]'");

                                    $dataqty            = $koneksi->query("SELECT SUM(jumlah) as jumlah_qty, invoice, idmitra, tgl FROM ordermitra WHERE invoice = '$invoice[$x]'");

                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Ambil Barang Manual Pre Order</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div>
...
<div  id="tabel" name="tabel"></div>   
  <br>
<button type="submit" name="but_save_po" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Ke Keranjang</button>
<a href="keranjang_manual_po.php" class="btn btn-success" style="float: right;"><i class="fa fa-shopping-cart"></i> Keranjang Manual</a>   
</form>
                                    </div>
                                </div>
                            </div>
...
$sqlnya = $koneksi->query("INSERT INTO surat_jalan_manual (id_sj,no_sj,idadmin,idproduk,progres,status,waktu) 
                VALUES (null,null,'0','$updateid','$progres','PO','$tanggal $waktu')");
}
                ...
                if ($sqlnya) {
                  ...
                  echo "<script>location='ambilbarang_manualpo.php';</script>";  
                  }else{

 ...
 <?php include "sidebar.php"; ?>
   ...
   <h3><strong>Invoice <?php echo $invoice ?></strong></h3><br>
          ...
          <div class="row">
           ...
           <a class="btn btn-success" href="cetakorderreseller.php?invoice=<?php echo $invoice; ?>" target="blank">Cetak</a>  &nbsp&nbsp&nbsp 
           <!-- <a class="btn btn-primary" href="cetak_suratjalan_reseller.php?invoice=<?php echo $invoice; ?>" target="blank">Cetak SJ</a>      --> 
	...
	<div class="table-responsive">
              ...
              <th style="text-align: right"><i class="fas fa-cog"></i></th>           
                      ...
                      <?php 
                       	$jumlah=0;
          			        $subtotal=0;
          			        $ongkir=0;
                        $datapo=$koneksi->query("SELECT mitrareseller.namaagen,produk.namaproduk,orderreseller.idorder,
                          orderreseller.invoice,orderreseller.harga,orderreseller.jumlah,orderreseller.subtotal 
                          FROM orderreseller inner join mitrareseller 
                          inner join produk on orderreseller.idproduk=produk.idproduk 
                          and orderreseller.idmitrareseller=mitrareseller.idmitrareseller 
                        ...
                        <tr>
                         ...
                         <td>
                          ...
                          <?php 
                          if($_SESSION["administrator"]["nama"]=='Delita' or $_SESSION["administrator"]["nama"]=='Master'){
                            echo "<td>";
			 ...
			 <?php
    $totala=0;
    $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk=orderreseller.idproduk WHERE orderreseller.invoice='$invoice' and orderreseller.jumlah>0 and produk.idkategori>0 and produk.idkategori<>2";
	$query = $koneksi->query($sql);
        ...
        ?>
                        ...
                        if(isset($_POST["done"])){
                           ...
                           <?php if(isset($_POST["hapus"])){
                                ...
                                $koneksi->query("DELETE FROM orderreseller WHERE idorder='$id'" );

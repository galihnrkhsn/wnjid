...
<h3><strong>Input Transaksi</strong></h3>
...
<form method="post">
    ...
    <select name="idadmin" class="form-control">
        <?php 
        include "koneksi.php";
        $ambil=$koneksi->query("SELECT * FROM admin_mitra");
    ...
    <input type="text" name="jumlah" class="form-control"><br><br>
...
if(isset($_POST["save"])){
	...
	$jumlah = $_POST["jumlah"];
		...
		$koneksi->query("INSERT INTO transaksi (idtransaksi,idadmin,tgl,invoice,transaksi,jumlah)
			VALUES ('null','$idadmin',NOW(),'$invoice','$transaksi','$jumlah')");


			echo "<script>alert('data berhasil ditambah');</script>";
		echo "<script>location='index.php?page=inputtransaksi';</script>";

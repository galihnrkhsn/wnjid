...
header("Content-Disposition: attachment; filename=$namapo Dropship Luar Pulau Jawa.xls");
?>
...
LEFT JOIN admin_mitra_cs ON (admin_mitra.idadmin = admin_mitra_cs.idadmin 
                                                        ...
                                                        and (podropship.provinsi <> 3 
                                                          and podropship.provinsi <> 5 
                                                          and podropship.provinsi <> 6
                                                          and podropship.provinsi <> 9
                                                          and podropship.provinsi <> 10
                                                          and podropship.provinsi <> 11)

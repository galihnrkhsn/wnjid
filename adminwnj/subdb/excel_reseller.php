...
header("Content-Disposition: attachment; filename=Data Reseller WNJ.xls");
?>
...
<div class="row" style="margin-top: 2%;">
   ...
   <tr>
    ...
    <tbody>
        <?php 
        $no=1;
        $ambil=$koneksi->query("SELECT admin_mitra.namamitra,mitrareseller.namaagen,mitrareseller.email,
                            mitrareseller.whatsapp,mitrareseller.alamat,mitrareseller.status,

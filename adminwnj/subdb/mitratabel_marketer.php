...
<!-- Start Table -->
                      <div class="table-responsive">
                        <button class="btn btn-outline-success btn-icon-split"  onclick="JavaScript:window.location.href='subdb/excel_marketer.php';">
                            ...
                            <br>
                            <br>
                        <table class="table table-striped table-bordered table-hover" id="tbmitramarketer">
                          <thead>
                            <tr>
                        ...
                        <?php
                          $no=1;
                          $tampil =$koneksi->query("SELECT admin_mitra.namamitra,mitramarketer.namaagen,mitramarketer.password,
                            mitramarketer.email,mitramarketer.whatsapp,mitramarketer.alamat,mitramarketer.status 
                        ...
                        <tr>
                            <td><?php echo $no++; ?></td>
                            <td><i class="fas fa-users"></i> <?php echo $tampilMas['namaagen']; ?></td>
...
<?php
  if(isset($_POST["hapusmarketer"])){
    $idmarketer= $_POST['idmarketer'];
    $koneksi->query("delete from t_marketer where idmarketer='$idmarketer';");

...
<?php
include "koneksi.php";
$sql = $koneksi->query("SELECT * FROM podropship_kolibri inner join poproduk on podropship_kolibri.idpoproduk=poproduk.idpoproduk WHERE podropship_kolibri.iddropship = '$_GET[id]' ");
...
<td><img src="ekspedisi/ekpedisi/<?php echo $data['ekspedisi']; ?>.jpg" alt="<?php echo $data['ekspedisi']; ?>" width="100" height="30" style="margin-top:2px;"></td>
...
<br><?php echo $data['alamatpenerima']; ?><br>Telp : <?php echo $data['tlppenerima']; ?>
 ...
 note :<br><b><?php echo $data['namapo']; ?><b><br>

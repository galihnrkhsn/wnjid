...
include "koneksi.php"; 
  ...
  $jenis = $_GET['jenis'];
            $datasj=$koneksi->query("SELECT * FROM surat_jalan_subdb 
                            where no_sj='$no_sj'");
...
<?php
if ($jenis=='Agen') {
            $datamitra=$koneksi->query("SELECT admin_mitra.idadmin,mitraagen.namaagen, mitraagen.idmitraagen as idsubmitra, admin_mitra.namamitra, admin_mitra_cs.namacs FROM mitraagen
...
if ($jenis=='Reseller') {
            $datamitra=$koneksi->query("SELECT admin_mitra.idadmin,mitrareseller.namaagen, mitrareseller.idmitrareseller as idsubmitra, admin_mitra.namamitra, admin_mitra_cs.namacs FROM mitrareseller
...
if ($jenis=='Marketer') {
            $datamitra=$koneksi->query("SELECT admin_mitra.idadmin,mitramarketer.namaagen, mitramarketer.idmitramarketer as idsubmitra, admin_mitra.namamitra, admin_mitra_cs.namacs FROM mitramarketer
  ...
  <div class="row align-items-start">
    <div class="col">
    	<!-- <h5><strong style="float:left"> Nama DB : <?php echo $tampilnama['namamitra']; ?> <br> Nama Sub DB : <?php echo $tampilnama['namaagen']; ?></strong></h5> -->

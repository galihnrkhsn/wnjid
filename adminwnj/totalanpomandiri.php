...
WHERE pomitra.idpoproduk='$idpoproduk' and pomitra.jumlah>0 and pomitra.idmitra='$idadmin' GROUP BY podetail.variant");
                            $no=1;
                            while($tampilkan2=$datapo2->fetch_assoc()){
                            ?>
                      <tr>

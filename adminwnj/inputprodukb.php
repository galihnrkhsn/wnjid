...
<h3><strong>Input Produk</strong></h3>
...
<form method="post" enctype="multipart/form-data">
    ...
    <input type="text" name="stock" class="form-control"><br><br>
...
if(isset($_POST["save"])){
	...
	$stock = $_POST["stock"];
		...
		$koneksi->query("INSERT INTO produkb (idproduk,idkategori,namaproduk,stock,tgl)
			VALUES (null,'$idkategori','$namaproduk','$stock',NOW())");


			echo "<script>alert('data berhasil ditambah');</script>";
		echo "<script>location='inputprodukb.php';</script>";

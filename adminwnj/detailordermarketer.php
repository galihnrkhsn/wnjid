 ...
 <?php include "sidebar.php"; ?>
   ...
   <h3><strong>Invoice <?php echo $invoice ?></strong></h3><br>
          ...
          <div class="row">
           ...
           <a class="btn btn-success" href="cetakordermarketer.php?invoice=<?php echo $invoice; ?>" target="blank">Cetak</a>    

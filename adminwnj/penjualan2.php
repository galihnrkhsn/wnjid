                ...
                <div class="container-fluid">
                    ...
                    <?php if (isset($_POST["cari"])): ?>
                        ...
                        <div class="table-responsive col mt-2">
                            <form method="post" action="excel_penjualan2.php" target="_blank">
                            ...
                            <br>
                            <form method="post" action="excel_penjualan_db2.php" target="_blank">
                                <input type="hidden" name="filter" value="<?= $filter ?>">
                                <input type="hidden" name="tanggal" value="<?= $tanggal ?>">
                                <input type="hidden" name="namacs" value="<?= $namacs ?>">
                                <?php if ($filter=="Harian"): 
                                            ...
                                            <?php 
                                                if ($filter == "Harian") {
                                                    $data_inv = $koneksi->query("SELECT surat_jalan_manual.invoice,
                                                                                        ...
                                                                                        surat_jalan_manual.id_sj, products.namaproduk, 
                                            ...
                                            <?php 
                                                if ($filter == "Harian") {
                                                    $datapo = $koneksi->query("SELECT surat_jalan_subdb.invoice, SUM(surat_jalan_subdb.progres) as jumlah,
                                                                                    ...
                                                                                    surat_jalan_subdb.no_sj, products.namaproduk, variants.harga, 

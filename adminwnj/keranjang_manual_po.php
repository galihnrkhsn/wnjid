...
<form method="post">              
              ...
              <th>QTY</th>
                      ...
                      <tbody>
                          <?php 
                            ...
                            and surat_jalan_manual.status = 'PO'
                            ");
                            $no=1;
 ...
 <a href="ambilbarang_manualpo.php" class="btn btn-warning" style="float: right;"><i class="fa fa-arrow-left"></i> Kembali</a>        
      </form>                    
</div>                  
                                    </div>
                                </div>
...
$sqlnya = $koneksi->query("UPDATE surat_jalan_manual set idadmin='$idadmin', no_sj='SJPO-$idadmin-$tglnya-$waktunya' where id_sj='$updateid'");


                }
                if ($sqlnya) {
                  echo "<script>alert('data berhasil disimpan');</script>";
                  echo "<script>location='suratjalan_manualpo.php';</script>";  
                  }else{
        ...
        if(isset($_POST['but_hapus'])){
            ...
            if(isset($_POST['update'])){
                ...
                if ($sqlnya) {
                  ...
                  echo "<script>location='keranjang_manual_po.php';</script>";  
                  }else{
...
$sqlnya = $koneksi->query("UPDATE surat_jalan_manual set idadmin='$idadmin', 
                            invoice='D$idadmin-$tglnya-$waktunya', 
                            no_sj='SJPO-$idadmin-$tglnya-$waktunya',
                            waktu='$tanggal $waktu', 
                            status='IPO' where id_sj='$updateid'");


                }
                if ($sqlnya) {
                  echo "<script>alert('data berhasil disimpan');</script>";
                  echo "<script>location='po_manual.php';</script>";  
                  }else{
                    echo "<script>alert('data gagal disimpan');</script>";
                    echo "<script>location='po_manual.php';</script>";
                }

<?php 
    ...
    $sql        = "SELECT orderreseller.invoice, mitrareseller.namaagen 
                    FROM orderreseller 
                            ...
                            if(isset($_POST['but_update'])){
                                ...
                                if(isset($_POST['update'])){
                                    foreach($_POST['update'] as $updateid){
                                        ...
                                        if($datacocok == 1){
                                            $sqlnya = $koneksi->query("UPDATE surat_jalan_subdb SET progres = progres + '$progres' 
                                            ...
                                            $sqlnya     = $koneksi->query("INSERT INTO surat_jalan_subdb 
                                                                            ...
                                                                            VALUES 
                                                                                (null, '$updateid', '$idproduk', '$invoice', '$progres', 
                                    ...
                                    if ($sqlnya) {
                                        ...
                                        echo "<script>location='ambilbarang_reseller2.php?invoice=$invoice';</script>";  
                                    } else {

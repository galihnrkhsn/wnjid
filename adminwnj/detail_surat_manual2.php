<?php 
    ...
    $no_sj      = $_GET["no_sj"];
    $sql        = "SELECT admin_mitra.namamitra, surat_jalan_manual.status, surat_jalan_manual.invoice 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                    <div class="row mt-3">
                        <?php $statusnya = $datadb['status']; ?>
                        <div class="table-responsive col">
                            <a href="cetak_surat_manual2.php?no_sj=<?= $no_sj; ?>" class="btn btn-success btn-icon-split" target="_blank()">
                            ...
                            <?php if ($statusnya=='INV' or $statusnya=='IPO'): ?>
                                <h3><strong>Inv. <?= $invoice ?></strong></h3>
                            <?php else: ?>
                                <h3><strong>No. <?= $no_sj ?></strong></h3>    
                            <?php endif ?>    
                                ...
                                <tbody>
                                    <?php 
                                        if ($statusnya == 'RS' or $statusnya == 'INV') {     
                                            $datapo=$koneksi->query("SELECT surat_jalan_manual.no_sj, products.namaproduk,
                                                                            variants.harga, surat_jalan_manual.progres, variants.variant, variants.size
                                                                        FROM surat_jalan_manual
                                                                        JOIN variants on variants.id = surat_jalan_manual.idproduk
                                        ...
                                        if ($statusnya=='PO' or $statusnya=='IPO' ) {     
                                            $datapo=$koneksi->query("SELECT surat_jalan_manual.no_sj, podetail.variant as namaproduk,
                                                                            podetail.harga, surat_jalan_manual.progres
                                                                        FROM surat_jalan_manual
                            ...
                            <table style="float: right;width: 100%">
                                <tbody  style="float: right;">
                                    <tr>
                                        ...
                                        <td style="padding-bottom: 5%;"><?= $jumlah_qty; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Total</th>
                                        <td>:</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>Rp. <?= number_format($diskonya); ?></td>
                                    </tr>
                                    <tr>
                                        <th>GrandTotal</th>
                                        <td>:</td>
                                        <td>Rp. <?= number_format($tgrandtotal); ?></td>
                                    </tr>
                                </tbody>
                            </table> 
                            <?php }?>

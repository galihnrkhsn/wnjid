...
$sum=0;
  ...
  $datamitra=$koneksi->query("SELECT poproduk.namapo,admin_mitra.namamitra,mitraagen.namaagen as agen,mitrareseller.namaagen as reseller,mitramarketer.namaagen as marketer,podropship_kolibri.namapenerima FROM pokolibri INNER JOIN podropship_kolibri on pokolibri.invoice=podropship_kolibri.invoice LEFT JOIN mitraagen on pokolibri.idmitraagen=mitraagen.idmitraagen LEFT JOIN mitrareseller on mitrareseller.idmitrareseller=pokolibri.idmitrareseller LEFT JOIN mitramarketer on pokolibri.idmitramarketer=mitramarketer.idmitramarketer INNER JOIN admin_mitra on pokolibri.idadmin=admin_mitra.idadmin or (admin_mitra.idadmin=mitraagen.idadmin or admin_mitra.idadmin=mitrareseller.idadmin or admin_mitra.idadmin=mitramarketer.idadmin) INNER JOIN poproduk on poproduk.idpoproduk=pokolibri.idpoproduk WHERE pokolibri.invoice='$invoice'");
...
<center><h5>Invoice <?php echo $invoice; ?></h5></center>
    ...
    <strong> Nama Mitra : <?php echo $tampilnama['agen']; ?><?php echo $tampilnama['reseller']; ?><?php echo $tampilnama['marketer']; ?> </strong><br>
	...
	<div class="table-responsive">
				<table class="table table-bordered">
					...
					FROM poproduk inner JOIN pokategori inner join podetail inner join pokolibri inner join admin_mitra on poproduk.idpoproduk=pokolibri.idpoproduk and pokategori.idpo=pokolibri.idpo and podetail.idpodetail=pokolibri.idpodetail and admin_mitra.idadmin=pokolibri.idadmin WHERE pokolibri.invoice='$invoice' and pokolibri.jumlah>0");
                            ...
                            $datapo=$koneksi->query("SELECT poproduk.namapo,pokategori.namakategori,podetail.variant,pokolibri.idpokolibri,pokolibri.jumlah,pokolibri.invoice,pokolibri.total,podetail.harga FROM pokolibri INNER JOIN poproduk on pokolibri.idpoproduk=poproduk.idpoproduk INNER JOIN pokategori on pokolibri.idpo=pokategori.idpo INNER JOIN podetail on pokolibri.idpodetail=podetail.idpodetail WHERE pokolibri.invoice='$invoice' and pokolibri.jumlah>0 ");
                            $no=$mulai+1;
                          }

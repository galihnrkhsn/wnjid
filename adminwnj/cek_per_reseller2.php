        ...
        <div class="table-responsive">
            ...
            <form method="post" action="suratjalan_print_reseller.php" target="_blank">  
                <table class="table table-striped" id="tb_multiprint_1">
                    ...
                    <tbody>
                        <?php 
                            $datapo = $koneksi->query("SELECT surat_jalan_subdb.invoice, products.namaproduk,
                                                            orderreseller.jumlah, surat_jalan_subdb.progres,
                                                            surat_jalan_subdb.status, surat_jalan_subdb.waktu,
                                                            surat_jalan_subdb.id_sj, surat_jalan_subdb.idorder,
                                                            orderreseller.idmitrareseller, orderreseller.tgl,
                        ...
                        <?php } ?>
                        <?php 
                            $datapo = $koneksi->query("SELECT surat_jalan_subdb.invoice, produk.namaproduk,
                                                            orderreseller.jumlah, surat_jalan_subdb.progres,
                                                            surat_jalan_subdb.status, surat_jalan_subdb.waktu,
                                                            surat_jalan_subdb.id_sj, surat_jalan_subdb.idorder,
                                                            orderreseller.idmitrareseller, orderreseller.tgl
                ...
                <table class="table table-striped" id="tb_multiprint" target="_blank">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $no++; ?></td>  
                            <td>
                                <a href="suratjalan_print_subdb2.php?no_sj=<?= $tampilkan['no_sj'] ?>&idadmin=<?= $tampilkan['idmitrareseller'] ?>&jenis=Reseller" target="_blank"><i class="fa fa-print"></i> <?= $tampilkan['no_sj']; ?></a>
                            </td>   
                            <td><?= $tampilkan['invoice']; ?></td>
                        ...
                        <tr>
                            ...
                            <td><?= $no++; ?></td>  
                            <td>
                                <a href="suratjalan_print_subdb.php?no_sj=<?= $tampilkan['no_sj'] ?>&idadmin=<?= $tampilkan['idmitrareseller'] ?>&jenis=Reseller" target="_blank"><i class="fa fa-print"></i> <?= $tampilkan['no_sj']; ?></a>
                            </td>   
                            <td><?= $tampilkan['invoice']; ?></td>
                            <td><?= $tampilkan['jumlahnya']; ?></td>
                            <td><?= $tampilkan['status']; ?></td>

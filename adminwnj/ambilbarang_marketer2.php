<?php 
    ...
    $sql        = "SELECT ordermarketer.invoice, mitramarketer.namaagen FROM ordermarketer join mitramarketer on mitramarketer.idmitramarketer = ordermarketer.idmitramarketer WHERE invoice='$invoice' ";
    ...
    <div class="table-responsive">
        <form method="post">              
            <table class="table table-bordered" style="  font-size: 12px;">
                ...
                <tbody>
                    <?php 
                        $datapo=$koneksi->query("SELECT mitramarketer.namaagen, products.namaproduk, ordermarketer.idorder, 
                                                        ordermarketer.idproduk, ordermarketer.invoice, ordermarketer.jumlah,
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $tampilkan['namaproduk']; ?> <?= $tampilkan['variant']; ?> <?= $tampilkan['size'] ?></td>
                            <td><?php echo $tampilkan['jumlah']; ?></td>
                            <td style="width:22%">
                                <input type="number" name="progres_<?= $id ?>" class="form-control" value="0" min="0" max="<?= $kurang; ?>" required>
                            </td>
            ...
            if(isset($_POST['update'])){
                foreach($_POST['update'] as $updateid){
                    ...
                    if($datacocok == 1){
                        ...
                        $data       = $koneksi->query("SELECT * FROM ordermarketer WHERE idorder = '$updateid'");
                ...
                if ($sqlnya) {
                    ...
                    echo "<script>location='ambilbarang_marketer2.php?invoice=$invoice';</script>";  
                }else{

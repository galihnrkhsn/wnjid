<?php 
  ...
  header("Content-Disposition: attachment; filename=Saldo Mitra.xls");
session_start();
...
<table class="table table-striped table-bordered table-hover" id="tb_sisasaldo">
        ...
        $totalsaldo=0;
            ...
            $datamitra=$koneksi->query("SELECT admin_mitra_cs.namamitra,admin_mitra_cs.namacs,saldo.debit,saldo.credit,(sum(saldo.debit) - sum(saldo.credit)) AS sisa, saldo.idadmin FROM saldo inner join admin_mitra_cs ON 
        ...
        ?>
                        <tr>
                          ...
                          <td style="text-align: center;">
                              <i class="fas fa-money"></i> <a href="detailsaldo.php?nama=<?php echo $tampilkan['namamitra']; ?>">
                              <?php if ($idadmin==233): ?>
                                Rp. <?php echo number_format($totalsaldo); ?>
                              <?php else: ?>

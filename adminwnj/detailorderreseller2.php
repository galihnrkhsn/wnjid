 ...
 <?php include "sidebar.php"; ?>
   ...
   <h3><strong>Invoice <?php echo $invoice ?></strong></h3><br>
          ...
          <div class="row">
           ...
           <a class="btn btn-success" href="cetakorderreseller2.php?invoice=<?php echo $invoice; ?>" target="blank">Cetak</a>  &nbsp&nbsp&nbsp 
					...
					<tr>
                      ...
                      <?php 
                       	$jumlah=0;
          			        $subtotal=0;
          			        $ongkir=0;
                            $datapo=$koneksi->query("SELECT mitrareseller.namaagen, products.namaproduk, orderreseller.idorder,
                                                        ...
                                                        inner join variants on orderreseller.idproduk = variants.id
    ...
    $sql = "SELECT * FROM orderreseller 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderreseller.invoice='$invoice' 
            and orderreseller.jumlah>0 and products.idkategori=2";
	$query = $koneksi->query($sql);
...
<?php
    ...
    $sql = "SELECT * FROM orderreseller 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderreseller.invoice = '$invoice' 
            and orderreseller.jumlah > 0 and products.idkategori = 5";
	$query = $koneksi->query($sql);
...
<?php
    ...
    $sql = "SELECT * FROM orderreseller 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderreseller.invoice = '$invoice' 
            and orderreseller.jumlah > 0 and products.idkategori = 10";
	$query = $koneksi->query($sql);
    ...
    $sql = "SELECT * FROM orderreseller 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderreseller.invoice = '$invoice' 
            and orderreseller.jumlah > 0 and products.idkategori = 15";
	$query = $koneksi->query($sql);
    ...
    $sql = "SELECT * FROM orderreseller 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderreseller.invoice = '$invoice' 
            and orderreseller.jumlah > 0 and products.idkategori = 17";
	$query = $koneksi->query($sql);
    ...
    $sql = "SELECT * FROM orderreseller 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderreseller.invoice = '$invoice' 
            and orderreseller.jumlah > 0 and products.idkategori = 20";
	$query = $koneksi->query($sql);
    ...
    $sql = "SELECT * FROM orderreseller 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderreseller.invoice = '$invoice' 
            and orderreseller.jumlah > 0 and products.idkategori = 25";
	$query = $koneksi->query($sql);
    ...
    $dropship=$pengiriman['berat'];
        ...
        $grandtotal=($totala+$totalb+$ongkir+$biayad)-($diskona+$diskonFlash+$diskonb+$diskon5+$diskon10+$diskon15+$diskon17+$diskon20+$diskon25);
    ...
    if($ongkir==0){
      if($kurir=='Ahsan' or $kurir=='Gosend' or $kurir=='Ambil ke Pusat') {
        ...
        if ($jenis == 'Flash') {
            echo "Diskon Tambahan : Rp. -$flashSale";
        }
        if($diskonb>0){
    ...
    echo "<p align='right'><b>GrandTotal : Rp. $tgrandtotal</b><br></br></p>";
        ...
        ?>
                        ...
                        if(isset($_POST["done"])){
					               ...
					               $koneksi->query("update orderreseller set status='Sedang DiKirim' where invoice='$invoice';");
        		                   	echo "<script>alert('data sudah terupdate');</script>";
        		                   	echo "<script>location='orderreseller.php';</script>";
        					                     }                  

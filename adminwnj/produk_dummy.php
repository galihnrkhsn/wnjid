        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <h3><strong>Stock Produk</strong></h3>
                ...
                <a class="btn btn-success" href="excelproduk.php"><span class="fas fa-print"></span> Export Excel</a><br><br>
                
                <p align="left"><input type="radio" name="radio" onclick="javascript:window.location.href='produk.php?id=0'; "> Publish  &nbsp&nbsp<input type="radio" name="radio" onclick="javascript:window.location.href='produk.php?id=1'; "> Unpublish</p>
                <form method="post">

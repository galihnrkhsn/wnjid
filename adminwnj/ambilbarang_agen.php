...
$invoice=$_GET["invoice"];
  ...
  $sql = "SELECT orderagen.invoice, mitraagen.namaagen FROM orderagen join mitraagen on mitraagen.idmitraagen = orderagen.idmitraagen WHERE invoice='$invoice' ";
              ...
              <th>Ambil</th>
                      ...
                      <tbody>
                          <?php 
                            ...
                            INNER JOIN produk 
                            on orderagen.idproduk=produk.idproduk and orderagen.idmitraagen=mitraagen.idmitraagen
...
if($datacocok==1){
      $sqlnya = $koneksi->query("UPDATE surat_jalan_subdb set progres=progres + '$progres' where idorder='$updateid'");
                    ...
                    $data=$koneksi->query("SELECT * FROM orderagen
                ...
                if ($sqlnya) {
                  ...
                  echo "<script>location='ambilbarang_agen.php?invoice=$invoice';</script>";  
                  }else{

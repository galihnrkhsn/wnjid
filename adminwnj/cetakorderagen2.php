...
<h4>	<div class="table-responsive">
					...
					<tr>
                      ...
                      <tbody>
                          ...
                          if(isset($_POST["cari"])){
                           ...
                           $page    =isset($_GET["halaman"]) ? (int)$_GET["halaman"] : 1;
                           $mulai    =($page>1) ? ($page * $halaman) - $halaman : 0;
                            $datasaldo=$koneksi->query("SELECT mitraagen.namaagen,variants.variant,variants.size,products.namaproduk,orderagen.invoice,orderagen.idorder,orderagen.harga,orderagen.jumlah,orderagen.subtotal 
                                                        FROM orderagen 
                            ...
                            $datapo=$koneksi->query("SELECT mitraagen.namaagen,variants.variant,variants.size,products.namaproduk,orderagen.idorder,orderagen.invoice,orderagen.harga,orderagen.jumlah,orderagen.subtotal 
                                                        FROM orderagen 
                                                        INNER JOIN mitraagen on orderagen.idmitraagen = mitraagen.idmitraagen 
                                                        INNER JOIN variants on orderagen.idproduk = variants.id
                                                        INNER JOIN products on products.id = variants.idproducts 
  ...
  <?php
    ...
    $sql = "SELECT * FROM orderagen 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderagen.invoice = '$invoice' 
            and orderagen.jumlah > 0 and products.idkategori = 2";
	$query = $koneksi->query($sql);
...
<?php
    ...
    $sql = "SELECT * FROM orderagen 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderagen.invoice = '$invoice' 
            and orderagen.jumlah > 0 and products.idkategori = 5";
	$query = $koneksi->query($sql);
    ...
    $sql = "SELECT * FROM orderagen 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderagen.invoice = '$invoice' 
            and orderagen.jumlah > 0 and products.idkategori = 10";
	$query = $koneksi->query($sql);
    ...
    $sql = "SELECT * FROM orderagen 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderagen.invoice = '$invoice' 
            and orderagen.jumlah > 0 and products.idkategori = 15";
	$query = $koneksi->query($sql);
    ...
    $sql = "SELECT * FROM orderagen 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderagen.invoice = '$invoice' 
            and orderagen.jumlah > 0 and products.idkategori = 20";
	$query = $koneksi->query($sql);
    ...
    $sql = "SELECT * FROM orderagen 
            ...
            INNER JOIN products ON products.id = variants.idproducts
            WHERE orderagen.invoice = '$invoice' 
            and orderagen.jumlah > 0 and products.idkategori = 25";
	$query = $koneksi->query($sql);

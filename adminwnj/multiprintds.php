    ...
    if (isset($_POST['portal'])) {
        if (isset($_POST['update'])) {
            ...
            for($x = 0; $x < $countUpdatedId; $x++) {
                ...
                // echo "Nama CS: " . $namacs . "<br />";
                // echo "Nama Mitra: " . $namamitra . "<br />";
                // echo "ID Admin: " . $idadmin . "<br />";
                // echo "Nama Pengirim: " . $namapengirim . "<br />";
                // echo "Telp Pengirim: " . $tlppengirim . "<br />";
                // echo "Nama Penerima: " . $namapenerima . "<br />";
                // echo "Telp Penerima: " . $tlppenerima . "<br />";
                // echo "Ekspedisi: " . $ekspedisi . "<br />";
                // echo "Alamat Penerima: " . $alamatpenerima . "<br />";
                // echo "Invoice: " . $invoice . "<br />";
                // echo "Jenis Mitra: WNJ <br />";

                $sql = $koneksi2->query("INSERT INTO logistik3

...
<body id="page-top" class="sidebar-toggled">
 ...
 <?php 
        $id=$_GET["id_voucher"];
        $ambil=$koneksi->query("SELECT * FROM voucher where id_voucher='$id'");
        while($data=$ambil->fetch_assoc()){
        ?>

<form method="post">
        
        <input type="hidden" name="id" value="<?php echo $data['id_voucher']; ?>">
...
$waktu = date("H:i:s");
		...
		$koneksi->query("UPDATE voucher set transaksi='$transaksi',debit='$debit',credit='$credit', waktu='$waktu' where id_voucher='$id'");

			echo "<script>alert('data berhasil diubah');</script>";
		echo "<script>location='voucher.php';</script>";

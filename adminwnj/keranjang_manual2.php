                                    ...
                                    <form method="post">              
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="idadmin" id="idadmin" required>
                                                ...
                                                ?>
                                                    <option value="<?= $tampilkan['idadmin']; ?>"><?= $tampilkan['namamitra']; ?> (<?= $tampilkan['idadmin']; ?>)</option>
                                                <?php } ?>                       
                                            </select>      
                                        </div>             
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php 
                                                    $datapo = $koneksi->query("SELECT products.namaproduk, surat_jalan_manual.id_sj, 
                                                                                    surat_jalan_manual.progres, surat_jalan_manual.idproduk,
                ...
                <?php 
                    ...
                    if(isset($_POST['but_save_inv'])){
                        ...
                        if(isset($_POST['update'])){
                            foreach($_POST['update'] as $updateid){
                                $progres = $_POST['progres'.$updateid];
                                $sqlnya = $koneksi->query("UPDATE surat_jalan_manual SET idadmin = '$idadmin',  invoice = '$idadmin-$tglnya-$waktunya', 
                                                                no_sj = 'SJ-$idadmin-$tglnya-$waktunya', waktu = '$tanggal $waktu', status = 'INV' 
                                                            WHERE id_sj = '$updateid'");
                            }
                            if ($sqlnya) {
                                echo "<script>alert('data berhasil disimpan');</script>";

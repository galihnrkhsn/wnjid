<?php 
    ...
    $sql        = "SELECT ordermitra.invoice, admin_mitra.namamitra 
                    FROM ordermitra 
                ...
                <div class="table-responsive">
                    <form method="post">              
                        <table class="table table-bordered" style="  font-size: 12px;">
                            ...
                            <tbody>
                                <?php 
                                    $datapo = $koneksi->query("SELECT admin_mitra.namamitra, products.namaproduk, ordermitra.idorder,
                                                                    ordermitra.idproduk, ordermitra.invoice, ordermitra.jumlah, variants.variant, variants.size
                                                                FROM ordermitra 
                    ...
                    if(isset($_POST['but_update'])){
                        ...
                        if(isset($_POST['update'])){
                            foreach($_POST['update'] as $updateid){
                                ...
                                if($datacocok == 1){
                                    ...
                                    $sqlnya     = $koneksi->query("INSERT INTO surat_jalan (id_sj, idorder, idproduk, invoice, progres, status, waktu) 
                                                                    VALUES (null,'$updateid','$idproduk','$invoice','$progres','Ambil Barang',
                                                                            '$tanggal $waktu')
                                                                ");
                                }
                            }
                            if ($sqlnya) {
                                ...
                                echo "<script>location='ambilbarang2.php?invoice=$invoice';</script>";  
                            } else {

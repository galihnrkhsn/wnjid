...
<?php include "sidebar.php"; ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><strong>Data <?= $datapo['namapo']; ?></strong></h1>           
          </div>
...
<table class="table table-striped" id="tb_multiprint">
          ...
          <tr>       
           <th><input type='checkbox' id='checkAll' > Check</th>
            <th>No</th>
            <th>Nama DB</th>
            <?php if($idpoproduk == '239' || $idpoproduk == '259' || $idpoproduk == '267' || $idpoproduk == '277') : ?>
            <th>Nama CS</th>
            <?php endif; ?>
            <th>Sub DB</th>
            <th>Kemitraan</th>
            ...
            <?php 
            $idpoproduk=$_GET["id"];
            $datapo=$koneksi->query("SELECT admin_mitra_cs.namacs, admin_mitra.idadmin,admin_mitra.namamitra,poproduk.namapo,mitraagen.namaagen as agen,mitrareseller.namaagen as reseller,mitramarketer.namaagen as marketer,pomitra.invoice,pomitra.status,pomitra.tgl,poproduk.namapo,poproduk.idpoproduk FROM pomitra LEFT JOIN mitraagen on pomitra.idmitraagen=mitraagen.idmitraagen 
              ...
              INNER JOIN admin_mitra_cs on admin_mitra_cs.idadmin = admin_mitra.idadmin
              WHERE pomitra.jumlah>0 and pomitra.idpoproduk='$idpoproduk' 
              GROUP BY pomitra.invoice ORDER BY pomitra.invoice asc");
                            $no=1;

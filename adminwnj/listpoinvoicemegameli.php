...
<?php include "sidebar.php"; ?>
        ...
        <div class="container-fluid">
          ...
          <h3><strong>List PO Mitra</strong></h3><br>
<!-- <a class="btn btn-warning" href="sumpomitra.php">Summary PO Maximus</a> <a class="btn btn-info" href="sumpomitradb.php">Summary PO PerDB</a>
 -->
<hr>
          <!-- Content Row -->
          <div class="row">
...
<table class="table table-striped" id="tbmaximus">
          ...
          <tr>       
            ...
            <tbody>
            <?php 
            $datapo=$koneksi->query("SELECT  pomitra.idmitra,pomitra.idmitraagen,pomitra.idmitrareseller,pomitra.idmitramarketer,admin_mitra.namamitra,poproduk.namapo,mitraagen.namaagen as agen,mitrareseller.namaagen as reseller,mitramarketer.namaagen as marketer,pomitra.invoice,pomitra.status,pomitra.tgl,poproduk.namapo FROM pomitra LEFT JOIN mitraagen on pomitra.idmitraagen=mitraagen.idmitraagen LEFT JOIN mitrareseller on pomitra.idmitrareseller=mitrareseller.idmitrareseller LEFT JOIN mitramarketer on pomitra.idmitramarketer=mitramarketer.idmitramarketer LEFT JOIN admin_mitra on pomitra.idmitra=admin_mitra.idadmin or mitraagen.idadmin=admin_mitra.idadmin or mitrareseller.idadmin=admin_mitra.idadmin or mitramarketer.idadmin=admin_mitra.idadmin INNER JOIN poproduk on pomitra.idpoproduk=poproduk.idpoproduk 
              WHERE pomitra.jumlah>0 AND (pomitra.idpoproduk=73 OR pomitra.idpoproduk=74 OR pomitra.idpoproduk=76) GROUP BY pomitra.invoice ORDER BY pomitra.idpomitra DESC ");
                            $no=1;
            ...
            <tr>
              ...
              <td>
                <a href="detailinvoicemegameli.php?id=<?php echo $tampilkan['idmitra']; ?><?php echo $tampilkan['idmitraagen']; ?><?php echo $tampilkan['idmitrareseller']; ?><?php echo $tampilkan['idmitramarketer']; ?>&invoice=<?php echo $tampilkan['invoice']; ?>">

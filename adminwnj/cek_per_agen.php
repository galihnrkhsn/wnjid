<?php 
    ...
    $queryOrder     = $koneksi->query("SELECT * FROM orderagen WHERE idmitraagen = '$idmitraagen'");
        ...
        <div class="table-responsive">
            ...
            <form method="post" action="suratjalan_print_agen.php" target="_blank">  
                <table class="table table-striped" id="tb_multiprint_1">
                    ...
                    <tbody>
                        <?php 
                            $datapo = $koneksi->query("SELECT surat_jalan_subdb.invoice, products.namaproduk, orderagen.jumlah,
                                                            surat_jalan_subdb.progres, surat_jalan_subdb.status, surat_jalan_subdb.waktu,
                                                            surat_jalan_subdb.id_sj, surat_jalan_subdb.idorder, orderagen.idmitraagen,
                        ...
                        <?php
                            ...
                            $datapo = $koneksi->query("SELECT surat_jalan_subdb.invoice, products.namaproduk, variants.variant, orderagen.jumlah,
                                                            surat_jalan_subdb.progres, surat_jalan_subdb.status, surat_jalan_subdb.waktu,
                                                            surat_jalan_subdb.id_sj, surat_jalan_subdb.idorder, orderagen.idmitraagen,
                                                            orderagen.tgl
                                                        FROM surat_jalan_subdb
                                                        JOIN variants on variants.id = surat_jalan_subdb.idproduk
                                                        JOIN products on products.id = variant.idproducts
                                                        JOIN orderagen on (orderagen.idorder = surat_jalan_subdb.idorder and orderagen.invoice = surat_jalan_subdb.invoice)
                                                        WHERE orderagen.idmitraagen = '$idmitraagen' 
                                                        AND surat_jalan_subdb.progres > 0 
                                                        AND surat_jalan_subdb.status = 'Ambil Barang'
                    ...
                    <tbody>
                        <?php
                            $datapo = $koneksi->query("SELECT surat_jalan_subdb.invoice, products.namaproduk, orderagen.jumlah,
                                                            ...
                                                            surat_jalan_subdb.waktu, surat_jalan_subdb.id_sj, orderagen.idmitraagen,
                                                            orderagen.tgl
                                                        FROM surat_jalan_subdb
                                                        JOIN variants on variants.id = surat_jalan_subdb.idproduk
                                                        JOIN products on products.id = variants.idproducts
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $no++; ?></td>  
                                <td><a href="suratjalan_print_subdb2.php?no_sj=<?= $tampilkan['no_sj'] ?>&idadmin=<?= $tampilkan['idmitraagen'] ?>&jenis=Agen" target="_blank"><i class="fa fa-print"></i> <?= $tampilkan['no_sj']; ?></a></td>   
                                <td><?= $tampilkan['invoice']; ?></td>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $no++; ?></td>  
                                <td><a href="suratjalan_print_subdb.php?no_sj=<?= $tampilkan['no_sj'] ?>&idadmin=<?= $tampilkan['idmitraagen'] ?>&jenis=Agen" target="_blank"><i class="fa fa-print"></i> <?= $tampilkan['no_sj']; ?></a></td>   
                                <td><?= $tampilkan['invoice']; ?></td>
                                <td><?= $tampilkan['jumlahnya']; ?></td>
                                <td><?= $tampilkan['status']; ?></td>
                                <td><?= $tampilkan['waktu']; ?></td>

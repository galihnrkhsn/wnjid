            ...
            <tbody>
                <?php
                    ...
                    $datapo = $koneksi->query("
                        SELECT poproduk.diskon, podetail.variant, pomitra.idpomitra,
                            pomitra.jumlah, pomitra.invoice, pomitra.total,
                            pomitra.custom, podetail.harga
                        FROM poproduk
                        INNER JOIN pomitra ON poproduk.idpoproduk = pomitra.idpoproduk
                ...
                <tr>
                    <td><?= $no++; ?></td>
                    <?php if (is_null($tampilkan['custom'])) : ?>

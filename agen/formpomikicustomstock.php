                   ...
                   $nobaru=$no+$ab;
                             ...
                             $jumlah_dipilih = count($jmlh);
                                ...
                                $sisa = $query->fetch_assoc();
                                             ...
                                             if($sisa['stok']>$jmlh[$x]){
                                      $koneksi->query("insert into pomitra (idpomitra,idmitraagen,idpoproduk,idpo,idpodetail,jumlah,custom,total,invoice,status,tgl) values
                                     (null,'$idmitraagen','$idpoproduk','$idpo[$x]','$idpodetail[$x]','$jmlh[$x]','$custom[$x]','$total','A$idpoproduk-$idmitraagen','Belum Acc DB',NOW())");
                                    ...
                                    // $koneksi->query("update pokategori set stok=stok-'$jmlh[$x]' where idpo='$idpo'");
                                      echo "<script>alert('data berhasil dikirim');</script>";
                                            echo "<script>location='datapom.php?invoice=A$idpoproduk-$idmitraagen&id=$idpoproduk';</script>";
                                      }else{ 
                                          $jmlh[$x]=0;
                                          $total=0;
                                     $koneksi->query("insert into pomitra (idpomitra,idmitraagen,idpoproduk,idpo,idpodetail,jumlah,custom,total,invoice,status,tgl) values

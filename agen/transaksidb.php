...
<div class="container row fixed-top navbaru" >
  ...
  <div class="col-2"><a href="storedb.php"><span class="glyphicon glyphicon-chevron-left"</span></a></div>
		...
		<div class="tab-content">
			<div id="home" class="tab-pane fade in active">
				...
				<p>		<?php
					...
					$idmitra=$_SESSION['mitraagen']['idmitraagen'];
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT DISTINCT * FROM `orderagendb` inner join mitraagen on mitraagen.idmitraagen=orderagendb.idmitraagen where orderagendb.idmitraagen='$idmitra' and orderagendb.payment='Belum Bayar' GROUP BY invoice ORDER BY idorderdb DESC limit 20 ");
			...
			<div id="menu1" class="tab-pane fade">
				...
				<p>		<?php
					...
					$idmitra=$_SESSION['mitraagen']['idmitraagen'];
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT mitraagen.namaagen,orderagendb.invoice,orderagendb.payment,orderagendb.status,orderagendb.tgl FROM `pomitra` inner join poproduk
                    on pomitra.idpoproduk=poproduk.idpoproduk where pomitra.idmitra='$idmitra' and poproduk.status='open' order by pomitra.tgl desc");
					...
					$idmitra=$_SESSION['mitraagen']['idmitraagen'];
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT DISTINCT mitraagen.namaagen,orderagendb.invoice,orderagendb.payment,orderagendb.status,orderagendb.tgl FROM `orderagendb` inner join mitraagen on mitraagen.idmitraagen=orderagendb.idmitraagen where orderagendb.idmitraagen='$idmitra' and orderagendb.payment='Lunas'  GROUP BY invoice ORDER BY idorderdb DESC limit 20 ");

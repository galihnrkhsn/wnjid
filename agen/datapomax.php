...
if(!isset($_SESSION["mitraagen"])){
 ...
 $idpoproduk = $_GET['id'];
  ...
  $query = "SELECT COUNT(*) as jumlah,poproduk.idpoproduk,poproduk.namapo,poproduk.status,poproduk.note FROM poproduk inner join pomaximus on poproduk.idpoproduk=pomaximus.idpoproduk WHERE poproduk.idpoproduk='$idpoproduk' AND pomaximus.idmitraagen='$idmitraagen'";
...
<input type="text" name="namaproduk">  <button type="submit" class="btn btn-primary" name="cari">Cari</button>  <button type="submit" class="btn btn-primary" name="tampil">Tampil Semua</button></form></pre>-->  
		...
		//	echo "<p align='right'><a class='btn btn-info' href='formdropship.php?idmitraagen=$idmitraagen&idpo=$idpoproduk&invoice=$data2[invoice]' id='linkdropshipz'>Dropship</a>  <p align='right' id='demodropshipz'></p> </p>";
		//	}else 
		...
		echo "Dropship bisa di lihat di <a href='listnewpo.php'>Menu Listdropship</a>";
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					FROM poproduk inner JOIN pokategori inner join podetail inner join pomaximus on poproduk.idpoproduk=pomaximus.idpoproduk and pokategori.idpo=pomaximus.idpo and podetail.idpodetail=pomaximus.idpodetail WHERE pomaximus.idmitraagen='$idmitraagen' and pomaximus.idpoproduk='$idpoproduk' and pomaximus.jumlah>0");
					...
					?>
				        ...
				        ?>
				        <p align="center"><strong>Jumlah Agen PO 50% : </strong>Rp. <?php echo number_format($dp); ?></p><br>
				           <br>

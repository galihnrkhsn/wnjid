            ...
            <div class="card shadow-sm mb-5">
                <div class="card-body" style="font-size: .875rem">
                    ...
                    <div>
                        ...
                        <p class="mb-0 fw-medium">Penerima: <span class="fw-normal"><?= $queryUser['namaagen'] ?></span></p>
                                    ...
                                    <?php if ($now <= $dtpo['tgl_bayar']) : ?>
                                        ...
                                        <?php else : ?>
                                            ...
                                            <?php elseif ($status == 'Belum DP') : ?>
                                                <a href="popembayaran.php?idpo=<?= $idpoproduk ?>&invoice=<?= $invoice ?>&total=<?= $dp1 ?>&jenis=Payment1&bayar=<?= $dp1 ?>" class="btn btn-primary btn-sm">Konfirmasi Pembayaran</a>
                                            <?php elseif ($status == 'Sudah Confirm Payment1') : ?>
                                                <a href="popembayaran.php?idpo=<?= $idpoproduk ?>&invoice=<?= $invoice ?>&total=<?= $dp2 ?>&jenis=Payment2&bayar=<?= $dp2 ?>" class="btn btn-primary btn-sm">Konfirmasi Pembayaran</a>
                                            <?php elseif ($status == 'Sudah Confirm Payment2') : ?>
                                                <a href="popembayaran.php?idpo=<?= $idpoproduk ?>&invoice=<?= $invoice ?>&total=<?= $pelunasan ?>&jenis=Pelunasan&bayar=<?= $pelunasan ?>" class="btn btn-primary btn-sm">Konfirmasi Pembayaran</a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </div>

...
<body>
    ...
    <?php
        ...
        if ($jenisCheck == 'b1g1') {
            $total_b1g1     = $koneksi->query("SELECT orderagen.*, variants.harga as harga_variant
                                                FROM orderagen
                                                INNER JOIN variants ON variants.id = orderagen.idproduk
                                                INNER JOIN products ON variants.idproducts = products.id
                                                WHERE orderagen.invoice = '$invoice' 
            ...
            $sql    = "SELECT * FROM orderagen 
                        ...
                        INNER JOIN products ON variants.idproducts = products.id
                        WHERE orderagen.invoice = '$invoice' 
                        AND orderagen.jumlah > 0 AND products.idkategori > 0 AND products.idkategori <> 2";
            $query = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql    = "SELECT * FROM orderagen 
                    INNER JOIN variants ON variants.id = orderagen.idproduk
                    INNER JOIN products ON variants.idproducts = products.id 
                    WHERE orderagen.invoice = '$invoice' AND orderagen.jumlah > 0 AND products.idkategori = 2";
        $query  = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM orderagen 
                        INNER JOIN variants ON variants.id = orderagen.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderagen.invoice = '$invoice' AND orderagen.jumlah > 0 AND products.idkategori = 5";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM orderagen 
                        INNER JOIN variants ON variants.id = orderagen.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderagen.invoice = '$invoice' AND orderagen.jumlah > 0 AND products.idkategori = 10";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM orderagen 
                        INNER JOIN variants ON variants.id = orderagen.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderagen.invoice = '$invoice' AND orderagen.jumlah > 0 AND products.idkategori = 15";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM orderagen 
                        INNER JOIN variants ON variants.id = orderagen.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderagen.invoice = '$invoice' AND orderagen.jumlah > 0 AND products.idkategori = 17";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM orderagen 
                        INNER JOIN variants ON variants.id = orderagen.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderagen.invoice = '$invoice' AND orderagen.jumlah > 0 AND products.idkategori = 20";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM orderagen 
                        INNER JOIN variants ON variants.id = orderagen.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderagen.invoice = '$invoice' AND orderagen.jumlah > 0 AND products.idkategori = 25";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql    = "SELECT MAX(variants.harga) AS subtotal 
                    ...
                    INNER JOIN variants ON variants.id = orderagen.idproduk
                    INNER JOIN products ON variants.idproducts = products.id 
                    WHERE orderagen.invoice = '$invoice' AND orderagen.jumlah > 0 AND products.idkategori = 52";
        $query  = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM orderagen 
                        INNER JOIN variants ON variants.id = orderagen.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderagen.invoice = '$invoice' AND orderagen.jumlah > 0 AND products.idkategori = 51";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql = "SELECT * FROM orderagen 
                    INNER JOIN variants ON variants.id = orderagen.idproduk
                    INNER JOIN products ON variants.idproducts = products.id  
                    WHERE orderagen.invoice = '$invoice' AND orderagen.jumlah > 0 AND products.idkategori BETWEEN 52 AND 80";
        $query = $koneksi->query($sql);
    ...
    <?php
        ...
        $p              = 0;
        $dummy          = "SELECT MAX(variants.harga) as harga FROM orderagen 
                            INNER JOIN variants ON variants.id = orderagen.idproduk
        ...
        if($ongkir == 0){
            if($kurir == 'Ahsan' or $kurir == 'Gosend' or $kurir == 'Ambil ke Pusat' or $kurir == 'Disatukan') {
                ...
                echo "Diskon sub DB 25% : Rp. -$tdiskona<br>";
                if (isset($disc) && $disc > 0) {
                    echo "Diskon Tambahan $disc% : Rp. -$tdTambahan";
                }
                if($diskonb>0){
        ...
        //     }
        //     echo "Estimasi Ongkir : Rp. $tongkir<br>";
        //     echo "Diskon sub DB 25% : Rp. -$tdiskon52<br>";
...
?>
      <center><button type="submit" class="btn btn-sm" name="cari" id="linkmiki<?= $tampilkan['idorder']; ?>">
        ...
        <a class='btn btn-info btn-lg' href='formpembayaran.php?id=<?= $invoice;?>&total=<?= $totalForLink;?>&jenis=<?= $jenis ?>'>Konfirmasi Pembayaran</a>

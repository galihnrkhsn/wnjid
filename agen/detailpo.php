        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                <tr>
                    ...
                    <?php endif; ?>
                    <th class="text-center">List Dropship</th>
                </tr>
                <?php
                ...
                while ($data = mysqli_fetch_array($sql)) { // Ambil semua data dari hasil eksekusi $sql
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <?php if ($data['status'] == 'Belum DP' && !in_array($idpoproduk, [182, 183, 186, 187, 194])): ?>
                                <?php
                                ...
                                <center>
                                    ...
                                    <div id="link2<?= $data['idpomitra']; ?>">
                                        ...
                                        <?php elseif (in_array($idpoproduk, $kolibri)): ?>
                                            <a class="aText" href="datapokolibri3.php?id=<?= $data['idpoproduk']; ?>&invoice=<?= $data['invoice']; ?>"><?= $data['invoice']; ?></a>
                                        ...
                                        <?php elseif ($idpoproduk == '331') : ?>
                                            <a href="datapocustom2.php?id=<?= $idpoproduk ?>&invoice=<?= $invoice ?>"><?= $invoice ?></a>
                                        ...
                                        <?php elseif ($idpoproduk === '339') : ?>
                                            <a target="_blank" class="aText" href="datapoinner.php?id=<?= $idpoproduk ?>&invoice=<?= $data['invoice'] ?>"><?= $data['invoice'] ?></a>
                                        <?php elseif ($idpoproduk === '355' || $idpoproduk == '361' || $idpoproduk == '366' || $idpoproduk == '371' || $idpoproduk == '374') : ?>
                                            <a target="_blank" class="aText" href="datapobundling.php?id=<?= $idpoproduk ?>&invoice=<?= $data['invoice'] ?>"><?= $data['invoice'] ?></a>
                                        <?php elseif (substr($data['invoice'], 0, 1) == "A"): ?>
                                            PO Reguler
                                            <br>
                            ...
                            <?php else: ?>
                                <center>
                                    ...
                                    <?php elseif ($data['jenis_po'] == 'PO Bundling 2'): ?>
                                        <a class="aText" href="datapobundling2.php?id=<?= $data['idpoproduk']; ?>&invoice=<?= $data['invoice']; ?>"><?= $data['invoice']; ?></a>
                                    <?php elseif (substr($data['invoice'], 0, 1) != "A"): ?>
                                        <a class="bText" target="_blank" href="datapom.php?id=<?php echo $data['idpoproduk']; ?>&invoice=<?php echo $data['invoice']; ?>"><?php echo $data['invoice']; ?></a>
                                    <?php elseif (in_array($idpoproduk, $kolibri)): ?>
                                        <a class="aText" href="datapokolibri3.php?id=<?= $data['idpoproduk']; ?>&invoice=<?= $data['invoice']; ?>"><?= $data['invoice']; ?></a>
                                    <?php elseif (substr($data['invoice'], 0, 2) == "DI"): ?>
                                        <a target="_blank" href="datapom.php?id=<?php echo $data['idpoproduk']; ?>&invoice=<?php echo $data['invoice']; ?>"><?php echo $data['invoice']; ?></a>
                                    <?php elseif ($idpoproduk == '269'): ?>
                                        <a target="_blank" href="datapom3.php?id=<?php echo $data['idpoproduk']; ?>&invoice=<?php echo $data['invoice']; ?>"><?php echo $data['invoice']; ?></a>
                                    <?php elseif ($idpoproduk == '331') : ?>
                                        <a href="datapocustom2.php?id=<?= $idpoproduk ?>&invoice=<?= $data['invoice'] ?>" class="text-primary"><?= $data['invoice'] ?></a>
                                    <?php elseif ($idpoproduk === '339') : ?>
                                        <a target="_blank" class="aText" href="datapoinner.php?id=<?= $idpoproduk ?>&invoice=<?= $data['invoice'] ?>"><?= $data['invoice'] ?></a>
                                    <?php elseif ($idpoproduk === '355' || $idpoproduk == '361' || $idpoproduk == '366' || $idpoproduk == '371' || $idpoproduk == '374') : ?>
                                        <a target="_blank" class="aText" href="datapobundling.php?id=<?= $idpoproduk ?>&invoice=<?= $data['invoice'] ?>"><?= $data['invoice'] ?></a>
                                    <?php elseif (substr($data['invoice'], 0, 1) == "A"): ?>
                                        <a class="bText" href="datapo.php?id=<?php echo $data['idpoproduk']; ?>&invoice=<?php echo $data['invoice']; ?>"><?php echo $data['invoice']; ?></a>
                                    <?php endif; ?>
                                </center>
                            <?php endif; ?>
                        </td>
                        ...
                        <?php endif; ?>
                        <td><a href="listds.php?id=<?= $idpoproduk ?>&invoice=<?= $data['invoice'] ?>" class="btn btn-secondary btn-sm">List Dropship</a></td>
                    </tr>
                <?php } ?>
            </table>
        </div>

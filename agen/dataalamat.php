...
<body>
    ...
    <?php 
        ...
        $cekalamat=$koneksi->query("SELECT count(provinsi) as jumlah FROM mitraagen where idmitraagen='$idmitraagen'"); 
            ...
            <table class="table table-striped table-bordered border-secondary table-hover">
                ...
                <tbody>
                    ...
                    $ambil=$koneksi->query("SELECT
                                            ...
                                            FROM mitraagen 
                                            JOIN tb_ro_provinces ON mitraagen.provinsi = tb_ro_provinces.province_id
                                            ...
                                            where mitraagen.idmitraagen='$idmitraagen' and tb_ro_subdistricts.subdistrict_id = mitraagen.kecamatan"); 

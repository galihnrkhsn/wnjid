...
<div class="container">
<p>Mitra yang sudah ditambahkan bisa mengakses web submitra pada link berikut : <br> Reseller : wnj.web.id/reseller <br> Marketer : wnj.web.id/marketer <br> di web tersebut bisa melihat stock distributor, pricelist, info resi, dll</p>
...
-->    
    		...
    		<ul class="nav nav-tabs">
    			<li class="active"><a data-toggle="tab" href="#home">Reseller</a></li>
 ...
 <div class="tab-content">
               ...
               <div class="table-responsive">
                ...
                <thead>
            	 ...
            	 $limit_start = ($page - 1) * $limit;
                  ...
                  $no=1;
                  $ambil=$koneksi->query("SELECT * FROM mitrareseller where idmitraagen='$idmitraagen' LIMIT ".$limit_start.",".$limit.""); 
  	...
  	<ul class="pagination">
				...
				$idmitraagen=$_SESSION["mitraagen"]["idmitraagen"];
				$sql2 = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM mitrareseller where idmitraagen='$idmitraagen'");
               ...
               <div class="table-responsive">
                ...
                <thead>
            	 ...
            	 $limit_start = ($page - 1) * $limit;
            	    $idmitraagen=$_SESSION["mitraagen"]["idmitraagen"];				
                  $no=1;
                  $ambil=$koneksi->query("SELECT * FROM mitramarketer where idmitraagen='$idmitraagen' LIMIT ".$limit_start.",".$limit.""); 
                  while($distributor=$ambil->fetch_assoc()){
                  ?>
                  <tr>
  	...
  	<ul class="pagination">
				...
				// Buat query untuk menghitung semua jumlah data
				$idmitraagen=$_SESSION["mitraagen"]["idmitraagen"];	
				$sql2 = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM mitramarketer where idmitraagen='$idmitraagen'");
				$get_jumlah = mysqli_fetch_array($sql2);

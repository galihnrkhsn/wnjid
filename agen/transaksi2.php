...
<body>
								...
								<tr>
									...
									<td>
										Inv :
											...
											<a class="text-primary" href="detailorder_get.php?id=<?php echo $data['invoice']; ?>"> 		
											<?php else: ?>
											<a class="text-primary" href="detailorderb.php?id=<?php echo $data['invoice']; ?>">	
											<?php endif ?>#<?php echo $data['invoice'];?>
											</a>
											<br>
						...
						<table class="table table-striped table-bordered" id="tb_datareseller">
							...
							<?php
								...
								$sql = mysqli_query($koneksi, "SELECT DISTINCT mitraagen.namaagen, orderagen.invoice, orderagen.payment, 
																orderagen.status,orderagen.tgl 
														FROM `orderagen` 
														INNER JOIN mitraagen 
														ON mitraagen.idmitraagen = orderagen.idmitraagen 
														WHERE orderagen.idmitraagen='$idmitra' 
								...
								<tr>
									...
									<td>Inv: 
										<?php if (substr($data2['invoice'],0,1)=="F"): ?>
											<a class="text-primary" href="detailorder_get.php?id=<?php echo $data2['invoice']; ?>"> 		
										<?php else: ?>
											<a class="text-primary" href="detailorder.php?id=<?php echo $data2['invoice']; ?>">	
										<?php endif ?> 						  		
										#<?php echo $data2['invoice'];?></a>
	...
	$koneksi->query("UPDATE orderagen SET status='Selesai',payment='LUNAS' where invoice='$invoice' "); 

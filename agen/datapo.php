<?php
    ...
    $query2 = "SELECT 
                ...
                FROM poproduk 
                inner join pomitra on poproduk.idpoproduk=pomitra.idpoproduk 
                WHERE poproduk.idpoproduk='$idpoproduk' AND pomitra.idmitraagen='$idmitraagen' AND pomitra.invoice = '$invoice'";
...
<body>
                        ...
                        <tbody style="float: right;">
                            ...
                            <?php if ($angka1 % 3 == 0 and $angka2 % 3 == 0 and $angka3 % 3 == 0): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            $sqlharga2 = "SELECT MAX(total) as totalnya, invoice FROM `pomitra` WHERE `idpoproduk`= '$idpoproduk' AND idmitraagen = '$idmitraagen' GROUP BY invoice;";
    ...
    <?php if ($data2['status'] == "Belum DP" || $data2['status'] == "Belum Acc DB" || $data2['status'] == "Sudah Acc DB") : ?>
        <?php 
            ...
            <div class="d-flex justify-content-center">
                <?php if ($tampilkan['jenis_po'] == "PO Custom Tab"): ?>
                    <div name="cari" id="linkmiki<?= $tampilkan['idbpo']; ?>">
                        <a href="ubahpo.php?id=<?= $idpoproduk; ?>&invoice=<?= $invoice; ?>" class="btn btn-success btn-sm">Ubah Data</a> 
                    </div>     
                <?php endif ?>  
            </div>
            <div class="d-flex justify-content-center">

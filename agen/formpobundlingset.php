                            ...
                            <script>
                                document.addEventListener('change', function (e) {
                                    if (e.target.classList.contains('warnaSelect')) {
                                        ...
                                        if (idpo) {
                                            fetch('../distributor/api/get_kulot.php?idpo=' + idpo)
                                            ...
                                            fetch('../distributor/api/get_bergo.php?idpo=' + idpo)
                                            .then(response => response.json())
                                            .then(data => {
                                            ...
                                            fetch('../distributor/api/get_tunik.php?idpo=' + idpo)
                                            .then(response => response.json())
                                            .then(data => {
            ...
            try {
                ...
                for ($x = 0; $x < $count; $x++) {
                    ...
                    $sql = $koneksi->query("INSERT INTO pomitra
                                                ...
                                                VALUES
                                                    (NULL, '$idmitraagen', '$idpoproduk', '$idpo_item', '$idpodetail_item', '$qty_item', '$custom_item', '$total_harga', '$invoice', 'Belum DP', NOW(), '$waktu')
                                            ");

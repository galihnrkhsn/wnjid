        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
            ...
            <div class="col-sm-12 text-center">
              ...
              <?php if ($datapo['status'] == "Belum Acc DB") : ?>
                <div class="alert alert-danger text-center mt-3" role="alert">
                  <?php if ($datapengiriman['province_name'] == "") : ?>
                    <p class="fw-bold mb-0" style="font-size: .75rem">Silahkan Isi Alamat.</p>
                  <?php else : ?>
                    <p class="fw-bold mb-0" style="font-size: .75rem">Belum Di Acc DB</p>
                  <?php endif; ?>
              ...
              <?php elseif($datapo['status'] == "Approve DB") : ?>
                <div class="alert alert-success mt-3" role="alert">
                  <p class="fw-bold" style="margin-bottom: 0;">Sudah Di Approve DB</p>
                </div>
              <?php endif; ?>
            </div>
          </div>
            ...
            <?php
              $sqlprogres = mysqli_query($koneksi,
                          "SELECT 
                            ...
                            WHERE pomitra.idmitraagen = '$idadmin' 

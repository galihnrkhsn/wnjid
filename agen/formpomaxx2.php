...
echo "
    ...
    <center><b>Anda sudah mengisi Formulir $namapo , Klik Tombol Dibawah ini Jika ingin melihat atau merevisi Invoice, 
      ...
      <a class='btn btn-info' href='datapomax.php?idmitra=$idmitraagen&id=$id'> INVOICE</a> </center>";
    }
?>
  </table>
  </div><br><br>
                                           ...
                                           // for($x=0;$x<$jmlhtotal;$x++){
                                            //echo number_format($total, 2);
                                             ...
                                             if($sisa['stok']>$jmlh[$x]){
        					                   ...
        					                   (null,'0','$idmitraagen','0','0','$idpoproduk','$idpo[$x]','$idpodetail[$x]','$jmlh[$x]','$total','A$idpoproduk-$idmitraagen','Belum Acc DB',NOW())");

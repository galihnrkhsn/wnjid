...
<!--================ NAVBARU END =================-->
  ...
  <h4><center><?php echo $_SESSION["mitraagen"]["namaagen"]; ?> (Cust ID : <?php echo $_SESSION["mitraagen"]["idmitraagen"]; ?> )</center></h4><br>               
  ...
  <form method="post">
      ...
      <label>Invoice</label>
       ...
       <?php  $idmitraagen=$_SESSION["mitraagen"]["idmitraagen"];				

...
include "koneksi.php";
	...
	$sql = "SELECT subtotal FROM orderagen WHERE invoice='$invoice' ";
	...
	while($row = $query->fetch_assoc()){
	 ...
	 $total=$total+$ongkir;
	  $query = "insert into orderpengiriman (idorderp,namapengirim,tlppengirim,namapenerima,tlppenerima,alamat,provinsi,kota,kecamatan,ekspedisi,layanan,berat,ongkir,dropship,kodepos,invoice,total,tgl) values

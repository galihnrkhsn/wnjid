...
$ambil=$koneksi->query("SELECT * FROM mitraagen where idmitraagen='$idmitraagen' ");
...
<div class="container row fixed-top navbaru" >
  ...
  <div class="col-8" ><p>PRE ORDER AGEN</p></div>
  <div class="col-2"></div>
</div>
...
<div class="container">
    <div class="jumbotron" >
      ...
      <div class="col-6"><b><?php echo $mode['namaagen'] ?></b><br>
    <b style="font-size: 13px"><?php echo "(Agen_".$mode['idmitraagen'].')';?></b><br>
...
?>
      <button type="submit" class="btn btn-primary btn-lg" name="cari" id="linkmiki<?= $tampilkan['idbpo']; ?>">
        ...
        <?php if ($tampilkan['jenis_po']=="PO Custom Inner"): ?>
            <a  style="color:white" href="formpoinner_custom?id=<?php echo $tampilkan['idpoproduk']; ?>&idadmin=<?= $idmitraagen ?>">Link <?php echo $tampilkan['namapo']; ?></a>
        <?php endif ?>
        <?php if ($tampilkan['idpoproduk'] == '261') : ?>
            <a  style="color:white" href="formpocustomlegging2.php?id=<?php echo $tampilkan['idpoproduk']; ?>&idadmin=<?= $idmitraagen ?>">Link <?php echo $tampilkan['namapo']; ?></a>
        <?php elseif ($tampilkan['idpoproduk'] == '260') : ?>
            <a  style="color:white" href="formpocustomlegging.php?id=<?php echo $tampilkan['idpoproduk']; ?>&idadmin=<?= $idmitraagen ?>">Link <?php echo $tampilkan['namapo']; ?></a>
        <?php endif; ?>
        <?php if ($tampilkan['idpoproduk'] == '281' ): ?>
...
<?php } ?> 
        ...
        <div class="d-block">
            <h3>Resi</h3>
            <a href="resi.php" class="btn btn-primary">Data Resi</a>
        </div>
...
<?php endif ?>
               <?php }elseif(substr($data['invoice'],0,1)<>"A"){ ?>
                ...
                <?php } elseif($data['idpoproduk'] == '261' or $data['idpoproduk'] == '260') { ?>
            ...
            <center>
              ...
              <td class="align-middle">
<a href="listdropship.php?&invoice=<?= $data['invoice']; ?>&idmitra=<?= $idmitraagen; ?>&id=<?= $data['idpoproduk']; ?>" class="btn btn-sm btn-primary">List Dropship</a>                
            </td>

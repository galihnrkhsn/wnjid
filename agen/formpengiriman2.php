<?php 
	...
	$provinsi		= $dataAgen["provinsi"];
	$kabupaten		= $dataAgen["kota"];
	$kecamatan		= $dataAgen["kecamatan"];
?>
  
<html lang="en">
<head>
	<title>Mitra <?= $dataAgen['namaagen']; ?>| Wanoja</title>
	<meta charset="utf-8">
					...
					<div class="col-md-6">
						...
						<form method="post">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="namapengirim" value="<?= $dataAgen['namaagen']; ?>" required>
							</div>
							<div class="form-group">
								<label>Telepon Pengirim</label>
								<input type="text" class="form-control" name="tlppengirim" value="<?= $dataAgen['whatsapp']; ?>" required maxlength="17">
							</div>
							<hr>
							<div class="form-group">
								<label>Nama Penerima</label>
								<input type="text" class="form-control" name="namapenerima" value="<?= $dataAgen['namaagen']; ?>" required>
							</div>
							<div class="form-group">
								<label>Telepon Penerima</label>
								<input type="text" class="form-control" name="tlppenerima" value="<?= $dataAgen['whatsapp']; ?>" required maxlength="17">
							</div>
							<div class="form-group">
								<label>Alamat</label>
								<textarea class="form-control" name="alamat" required><?= $dataAgen['alamat']; ?></textarea>
							</div>
							<div class="form-group">
								<label>Kode POS</label>
								<input type="text" class="form-control" name="kodepos" value="<?= $dataAgen['kodepos']; ?>" required>
							</div>
							<div class="form-group">

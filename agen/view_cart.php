...
<body>
    ...
    <div class="container mt-2">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#short">Buy 1 Get 1</a></li>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#flash">Cuci Gudang</a></li>
        </ul>
        <div class="tab-content">
            <div id="home" class="tab-pane fade show active">
                <br>
                <form method="POST" action="save_cart2.php" id="cartForm">
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql = "SELECT keranjang.*, keranjang.status AS statusnya, variants.*, products.namaproduk FROM keranjang
                                        ...
                                        WHERE keranjang.idagen = '$idmitra'
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    ...
                                    <?php if ( $row['statusnya'] == "Active" ): ?>
                                        <input type="checkbox" name="idkeranjang[]" class="item-checkbox" data-jmlh="<?= (int) $row['jmlh']; ?>" data-subtotal="<?= $subtotalDinamis; ?>" value="<?= $row['idkeranjang']; ?>"/>
                                    <?php endif ?>
                                </td>
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <div class="p-2">
                            <a href="store2.php" class="btn btn-warning btn-s"><i class="fa-solid fa-chevron-left"></i></a>
                        </div>
                        <div class="p-2"></div>
                        <div class="p-2">
                            <button type="submit" class="btn btn-success btn-s" name="save">Ubah Stock</button>
                        </div>
                    </div>

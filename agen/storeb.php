...
<div class="container">
            ...
            <div class="row">
				 ...
				 // Include / load file koneksi.php
					...
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT * from produk WHERE stock>0 and harga>0 and idkategori=2 LIMIT ".$limit_start.",".$limit);
					...
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT * from produk WHERE stock>0 and harga>0 and idkategori=2 order by namaproduk asc LIMIT ".$limit_start.",".$limit);
			...
			<ul class="pagination">
				...
				$sql2 = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM produk where stock>0 and harga>0 and idkategori=2");

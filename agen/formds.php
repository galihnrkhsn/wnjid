            ...
            <div style="padding: 0 15px;">
                <form method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="namapengirim" required value="<?= $dataAgen['namaagen'] ?>">
                    </div>
                    <div class="form-group">
                        <label>Telepon Pengirim</label>
                        <input type="number" class="form-control" name="tlppengirim" required value="<?= $dataAgen['whatsapp'] ?>">
                    </div>
                    <hr>
                    <div class="form-group">

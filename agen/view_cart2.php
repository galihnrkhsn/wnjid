                        ...
                        <tbody>
                            <?php
                                ...
                                $sql = "SELECT *, keranjang.status as statusnya 
                                        ...
                                        WHERE keranjang.idagen='$idmitraagen' 
                            ...
                            <tr>
                                ...
                                <input type="hidden" name="idmitraagen" value="<?php echo $idmitraagen; ?>">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql = "SELECT 
                                                *, keranjang.status AS statusnya
                                            FROM
                                                keranjang
                                                    INNER JOIN
                                                produk ON keranjang.idproduk = produk.idproduk
                                            WHERE
                                                keranjang.idagen = '$idmitraagen'
                                                    AND keranjang.jmlh > 0
                                                    AND (produk.idkategori < 50)

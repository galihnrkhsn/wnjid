  ...
  <?php
	...
	$sql = "SELECT COUNT(*) as jumlah FROM mitraagen WHERE idmitraagen='$idmitraagen' AND password = '$passwordlama' ";
	...
	//     cek pass
	    ...
	    if ($hasil['jumlah']==1) {
	      $query = "UPDATE mitraagen SET password='".$passwordbaru."' WHERE idmitraagen='".$idmitraagen."'  ";
	      $sql = mysqli_query($koneksi, $query);
	      echo "<script>

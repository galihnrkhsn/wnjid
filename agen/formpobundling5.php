...
<head>
    ...
    <title>Wanoja | Form PO Bundling</title>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control form-control-sm" min="0" value="0" name="qty[]" id="form3" required>
                                            <input type="hidden" class="form-control form-control-sm" min="0" value="0" name="qty[]" id="form4" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label class="mb-0" for="v1">Variant 4</label>
                                            <select class="form-select form-select-sm" name="variant[]">
                                                <?php
                                                    $sql = $koneksi->query("SELECT 
                                                                                    *
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label class="mb-0" for="v1">Variant 5</label>
                                            <select class="form-select form-select-sm" name="variant[]">
                                                <?php
                                                    $sql = $koneksi->query("SELECT 
                                                                                    *
            ...
            try {
                ...
                for ($x = 0; $x < $count; $x++) {
                    ...
                    $sql = $koneksi->query("INSERT INTO pomitra
                                                    (idpomitra, idmitraagen, idpoproduk, idpo, idpodetail, jumlah, custom, total, invoice, status, tgl, waktu)
                                                VALUES
                                                    (NULL, '$idmitraagen', '$idpoproduk', '$idpo', '$idpodetail', '$qty_item', '$custom', '$total_harga', '$invoice', 'Belum DP', NOW(), '$waktu')
                                            ");

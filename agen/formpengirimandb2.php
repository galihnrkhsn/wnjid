...
<form method="post">
    ...
    <input type="text" class="form-control" name="namapenerima" value="<?php echo $_SESSION["mitraagen"]['namaagen']; ?>">
    </div>
    
    <div class="form-group">
    <label>Telepon Penerima</label>
    <input type="text" class="form-control" name="tlppenerima" value="<?php echo $_SESSION["mitraagen"]['whatsapp']; ?>" >
    </div>

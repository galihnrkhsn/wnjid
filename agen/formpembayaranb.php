    ...
    <table class="table" id="tb_belumbayar_agen">
        ...
        <?php
            ...
            $sql = mysqli_query($koneksi, "SELECT DISTINCT *,
                ...
                inner join orderpengiriman on orderpengiriman.invoice = orderagen.invoice   

                where orderagen.idmitraagen='$idmitra' and (orderagen.payment<>'Lunas' or orderagen.payment<>'LUNAS') GROUP BY orderagen.invoice ORDER BY orderagen.idorder DESC");

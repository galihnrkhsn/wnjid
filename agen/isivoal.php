...
$invoice = $_GET['id'];
  ...
  $sql = "SELECT SUM(jumlah) as jumlah FROM orderagen WHERE invoice='$invoice'";
...
<table class="table table-bordered">
  <tr>
   ...
   // $total=0;
    $nomorurut = 1;
    $sql = "SELECT * FROM orderagen inner join produk on produk.idproduk=orderagen.idproduk WHERE orderagen.invoice='$invoice' and orderagen.jumlah>0 ";
  $query = $koneksi->query($sql);
...
<label>Item 1</label>
  <select style="width: auto;" class="form-control" name="idpodetail1[]" required>
    ...
    <?php 
      $ambil=$koneksi->query("SELECT * FROM orderagen inner join produk on produk.idproduk=orderagen.idproduk WHERE orderagen.invoice='$invoice' and orderagen.jumlah>0
                                ");     

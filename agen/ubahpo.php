...
<body>
    ...
    <div class="container d-flex justify-content-center mt-3 pb-5">
        ...
        <?php if ($idpoproduk == '282') : ?>
            <a class="btn btn-primary" href="datapom3.php?id=<?php echo $idpoproduk; ?>&invoice=<?php echo $invoice; ?>">Kembali Ke Invoice</a>
        ...
        <?php elseif (in_array($idpoproduk, $kolibri)) : ?>
            <a class="btn btn-primary" href="datapokolibri3.php?id=<?php echo $idpoproduk; ?>&invoice=<?php echo $invoice; ?>">Kembali Ke Invoice</a>
        <?php else : ?>
            <a class="btn btn-primary" href="datapo.php?id=<?php echo $idpoproduk; ?>&invoice=<?php echo $invoice; ?>">Kembali Ke Invoice</a>
        <?php endif; ?>
    </div>

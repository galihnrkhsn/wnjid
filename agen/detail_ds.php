        ...
        <form method="POST" enctype="multipart/form-data">
            <div id="variantContainer">
                <div class="row mx-0" id="variantForm_0">
                    <div class="col-12">
                        <h6 class="text-uppercase">Variant 1</h6>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                        ...
                        if ($jumlah > 0) {
                            ...
                            if ($checkQuery) {
                                if ($checkQuery->num_rows > 0) {
                                    ...
                                    $insertPomitra = $koneksi->query("INSERT INTO pomitra (idpomitra, idmitraagen, idpoproduk, idpo, idpodetail, jumlah, total, invoice, status, tgl, waktu) VALUES
                                    (null, '$idmitraagen', '$idpoproduk', '$idpo', '$variant', '$jumlah', '$total', '$invoice', 'Belum DP', NOW(), '$waktu')");

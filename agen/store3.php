                    ...
                    <tr>
                        <td>
                            <?php if ($data['status'] == 0): ?>
                                <a class="btn btn-info btn-xs" href="add_chart2.php?id=<?= $data['id']; ?>&harga=<?= $data['harga']; ?>" class="btn btn-primary"> <span class="fas fa-cart-shopping"></span></a>
                            <?php else: ?>
                        ...
                        <td>
                            <?= $data['namaproduk'] . ' ' . $data['variant'] . ' - ' . $data['size']; ?>

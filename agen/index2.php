...
.custom-select{
  ...
  <p align="left"><input type="radio" onclick="javascript:window.location.href='#'; " checked="checked"> Mode Hemat &nbsp&nbsp <input type="radio" onclick="javascript:window.location.href='index.php'; "> Mode Cantik</p>
            ...
            <td>
             ...
             <a class="btn btn-info btn-xs" href="add_chart.php?namaproduk=<?php echo $_GET['namaproduk']; ?>&id=<?php echo $data['idproduk']; ?>&harga=<?php echo $data['harga']; ?>"> <span class="glyphicon glyphicon-plus"></span></a>
             <?php else: ?>

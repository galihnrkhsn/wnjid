...
<body>
    ...
    <div class="container">
        <div class="text-center mt-3">
            <h6 class="outset">Menu informasi resi pengiriman semua ekspedisi </h6>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover" id="example">
                    ...
                    <tbody>
                        ...
                        $query = "SELECT * FROM logistik3 WHERE idmitrareseller = '$idmitrareseller' ORDER BY idlogistik DESC LIMIT 1000 ";

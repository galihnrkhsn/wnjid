...
$hak = $_GET['hak'];
 $idpoproduk = $_GET['id'];
  ...
  $query = "SELECT COUNT(*) as jumlah,poproduk.idpoproduk,poproduk.namapo,poproduk.status FROM poproduk inner join pomitra on poproduk.idpoproduk=pomitra.idpoproduk WHERE poproduk.idpoproduk='$idpoproduk' AND pomitra.idmitrareseller='$idmitrareseller' and pomitra.invoice='$invoice'";
...
<input type="text" name="namaproduk">  <button type="submit" class="btn btn-primary" name="cari">Cari</button>  <button type="submit" class="btn btn-primary" name="tampil">Tampil Semua</button></form></pre>-->  
			...
			<?php
					...
					FROM poproduk inner JOIN pokategori inner join podetail inner join pomitra on poproduk.idpoproduk=pomitra.idpoproduk and pokategori.idpo=pomitra.idpo and podetail.idpodetail=pomitra.idpodetail WHERE pomitra.idmitrareseller='$idmitrareseller' and pomitra.idpoproduk='$idpoproduk' and pomitra.invoice='$invoice'");
  ...
  <?php $stok= $stok['stok']; } ?>
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					FROM poproduk inner JOIN pokategori inner join podetail inner join pomitra on poproduk.idpoproduk=pomitra.idpoproduk and pokategori.idpo=pomitra.idpo and podetail.idpodetail=pomitra.idpodetail WHERE pomitra.idmitrareseller='$idmitrareseller' and pomitra.idpoproduk='$idpoproduk'");

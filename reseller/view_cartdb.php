...
if(!isset($_SESSION["mitraagen"])){
  echo "<script>alert('anda harus login terlebih dahulu');</script>";
   ...
   exit();
						...
						$sql2 = "SELECT * FROM keranjangdb  WHERE idreseller='$idmitrareseller' ";
			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					<?php
						...
						$sql = "SELECT * FROM keranjangdb inner join produkdb on keranjangdb.idprodukdb=produkdb.idprodukdb WHERE idreseller='$idmitrareseller' and jmlh>0 ";
					...
					?>
								<tr>
									...
									<input type="hidden" name="idmitra" value="<?php echo $idmitrareseller; ?>">

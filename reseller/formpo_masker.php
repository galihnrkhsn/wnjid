  ...
  <div class="container panel panel-default">
		...
		<div style="padding: 0 15px;">
					...
					<?php
						...
						$total = 0;
						$index = 0;
						$sql = "SELECT * FROM poproduk inner join pokategori inner join podetail on poproduk.idpoproduk=pokategori.idpoproduk and pokategori.idpo=podetail.idpo where poproduk.idpoproduk='$idpoproduk' order by podetail.variant";
						...
						<form method="POST">			
								...
								<div class="form-group">
								    ...
								    <input type="text" name="jmlh[]" class="form-control" style="width:80px;">

<?php
    ...
    $sqlmitra = $koneksi->query("SELECT * FROM mitrareseller WHERE idmitrareseller = '$idmitrareseller'");
    ...
    <body>
        ...
        <div class="container mt-3">
            <div class="col-sm-12 text-center">
                <h4>Formulir Tambah Variant <?= $namapo ?><br /><?= $data['invoice'] ?></h4>
            </div>
                ...
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="tab-content mt-2" id="myTabContent">
                            <?php
                                $firstLoopIds = [];
                                $frstloop = $koneksi->query("SELECT idpodetail FROM pomitra WHERE invoice = '$invoice' AND jumlah > 0");
                                    ...
                                    <div class="row">
                                        <?php
                                            $sql = $koneksi->query("SELECT 
                                                                        ...
                                                                        WHERE
                                                                            podetail.idpodetail NOT IN ($idpodetailString) AND pokategori.idpoproduk = '$idpoproduk'
                                                                        ...
                                                                        WHERE
                                                                            podetail.idpodetail NOT IN ($idpodetailString) AND pokategori.idpoproduk = '$idpoproduk'
                                                                                AND (podetail.variant LIKE '%Khimar%'
                                                                                    AND podetail.variant NOT LIKE '%French Khimar%')
                                                                ");
                                            while ($dataproduk = $sql->fetch_assoc()) {
                                        ?>
                                            <div class="col-sm-4 mb-2">
                    ...
                    for ($x = 0; $x < $count; $x++) {
                        ...
                        if ($jumlah > 0) {
                            ...
                            $ins_po = $koneksi->query("INSERT INTO pomitra VALUES (
                                                            NULL, '$idadmin', NULL, '$idmitrareseller', NULL,
                            ...
                            if ($ins_po) {
                                echo "
                                    <script>
                                        alert('Berhasil menambah variant!')

...
if(!isset($_SESSION["mitraagen"])){
 ...
 $idpoproduk = $_GET['id'];
  ...
  $query = "SELECT COUNT(*) as jumlah,poproduk.idpoproduk,poproduk.namapo,poproduk.status,poproduk.note FROM poproduk inner join pomaximus on poproduk.idpoproduk=pomaximus.idpoproduk WHERE poproduk.idpoproduk='$idpoproduk' AND pomaximus.idmitrareseller='$idmitrareseller'";
...
<input type="text" name="namaproduk">  <button type="submit" class="btn btn-primary" name="cari">Cari</button>  <button type="submit" class="btn btn-primary" name="tampil">Tampil Semua</button></form></pre>-->  
			...
			<p align="left">No Invoice  : <?php echo $data2['invoice']; ?> </p>
			 <?php 
		  //  if($idpoproduk==18) {
		//	echo "<p align='right'><a class='btn btn-info' href='formdropship.php?idmitrareseller=$idmitrareseller&idpo=$idpoproduk&invoice=$data2[invoice]' id='linkdropship'>Dropship</a>  <p align='right' id='demodropship'></p> </p>";
		//	}else if($idpoproduk==19) {
		//	echo "<p align='right'><a class='btn btn-info' href='formdropship.php?idmitrareseller=$idmitrareseller&idpo=$idpoproduk&invoice=$data2[invoice]' id='linkdropshipz'>Dropship</a>  <p align='right' id='demodropshipz'></p> </p>";
		//	}else 
		...
		echo "Dropship bisa di lihat di <a href='listnewpo.php'>Menu Listdropship</a>";
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					FROM poproduk inner JOIN pokategori inner join podetail inner join pomaximus on poproduk.idpoproduk=pomaximus.idpoproduk and pokategori.idpo=pomaximus.idpo and podetail.idpodetail=pomaximus.idpodetail WHERE pomaximus.idmitrareseller='$idmitrareseller' and pomaximus.idpoproduk='$idpoproduk' and pomaximus.jumlah>0");
					...
					?>
				           ...
				           <p align="left">Total Qty : <?php echo $sum; ?> </p>  
				            ...
				            <p align="right">Diskon Reseller  Rp. -<?php echo number_format($diskon); ?> </p><br>      

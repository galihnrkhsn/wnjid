<?php
    ...
    $ambil = $koneksi->query("SELECT mitrareseller.idmitrareseller, mitrareseller.namaagen FROM mitrareseller where idmitrareseller = '$idmitrareseller'");
    ...
    <div class="container my-3">
        <div class="row">
            ...
            <?php if ($idpoproduk == 331) : ?>
                ...
                <div class="col-sm-6 text-center">
                    <a class="btn btn-primary d-block" href="formpocustom.php?id=<?= $idpoproduk ?>&jenis=Set">Link Set <?= $tampilkan['namapo'] ?></a>
                </div>
            <?php else : ?>
                <div class="col-sm-6 text-center">

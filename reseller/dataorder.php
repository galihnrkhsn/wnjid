    ...
    <body>
        ...
        <div class="container mx-auto mt-2 mb-3">
            ...
            <?php
                ...
                $sqlcheck2 = $koneksi->query("SELECT * FROM orderreseller WHERE invoice = '$invoice'");
                        ...
                        <?php
                            ...
                            $sql = $koneksi->query("SELECT 
                                                        ...
                                                        FROM
                                                            orderreseller
                                                                INNER JOIN
                                                            produk ON produk.idproduk = orderreseller.idproduk
                                                        WHERE
                                                            orderreseller.invoice = '$invoice'
                            ...
                            <div class="d-flex align-items-center justify-content-end">
                                <table>
                                    <tr>
                                        ...
                                        <td width="20"></td>
                                        <td>Rp. </td>
                                        <td class="text-end"><?= number_format($totala) ?></td>
                                    </tr>
                                    <?php if ($apaja === "ya") : ?>
                                        <tr>
                                    ...
                                    <?php if ($jenis !== "Sale") : ?>
                                        <tr>
                                            ...
                                            <td>-</td>
                                            <td>Rp. </td>
                                            <td class="text-end"><?= number_format($diskonpromo) ?></td>
                                        </tr>
                                    <?php endif; ?>
                                    <tr>
                                        <th>Total Bayar</th>

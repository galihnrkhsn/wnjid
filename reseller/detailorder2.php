...
<html lang="en">
    ...
    <?
        ...
        $sql    = "SELECT * FROM orderreseller 
                    ...
                    INNER JOIN products ON variants.idproducts = products.id
                    WHERE orderreseller.invoice = '$invoice' 
                    AND orderreseller.jumlah > 0 AND products.idkategori > 0 AND products.idkategori <> 2";
        $query = $koneksi->query($sql);
    ...
    <?
        ...
        $sql    = "SELECT * FROM orderreseller 
                    INNER JOIN variants ON variants.id = orderreseller.idproduk
                    INNER JOIN products ON variants.idproducts = products.id 
                    WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0 AND products.idkategori = 2";
        $query  = $koneksi->query($sql);
    ...
    <?
        ...
        $sql        = "SELECT * FROM orderreseller 
                        INNER JOIN variants ON variants.id = orderreseller.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0 AND products.idkategori = 5";
        $query      = $koneksi->query($sql);
    ...
    <?
        ...
        $sql        = "SELECT * FROM orderreseller 
                        INNER JOIN variants ON variants.id = orderreseller.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0 AND products.idkategori = 10";
        $query      = $koneksi->query($sql);
    ...
    <?
        ...
        $sql        = "SELECT * FROM orderreseller 
                        INNER JOIN variants ON variants.id = orderreseller.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0 AND products.idkategori = 15";
        $query      = $koneksi->query($sql);
    ...
    <?
        ...
        $sql        = "SELECT * FROM orderreseller 
                        INNER JOIN variants ON variants.id = orderreseller.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0 AND products.idkategori = 17";
        $query      = $koneksi->query($sql);
    ...
    <?
        ...
        $sql        = "SELECT * FROM orderreseller 
                        INNER JOIN variants ON variants.id = orderreseller.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0 AND products.idkategori = 20";
        $query      = $koneksi->query($sql);
    ...
    <?
        ...
        $sql        = "SELECT * FROM orderreseller 
                        INNER JOIN variants ON variants.id = orderreseller.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0 AND products.idkategori = 25";
        $query      = $koneksi->query($sql);
    ...
    <?
        ...
        $sql    = "SELECT MAX(variants.harga) AS subtotal 
                    ...
                    INNER JOIN variants ON variants.id = orderreseller.idproduk
                    INNER JOIN products ON variants.idproducts = products.id 
                    WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0 AND products.idkategori = 52";
        $query  = $koneksi->query($sql);
    ...
    <?
        ...
        $sql        = "SELECT * FROM orderreseller 
                        INNER JOIN variants ON variants.id = orderreseller.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0 AND products.idkategori = 51";
        $query      = $koneksi->query($sql);
    ...
    <?
        ...
        $sql = "SELECT * FROM orderreseller 
                    INNER JOIN variants ON variants.id = orderreseller.idproduk
                    INNER JOIN products ON variants.idproducts = products.id  
                    WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0 AND products.idkategori BETWEEN 52 AND 80";
        $query = $koneksi->query($sql);
    ...
    <?
        ...
        $p              = 0;
        $dummy          = "SELECT MAX(variants.harga) as harga FROM orderreseller 
                            INNER JOIN variants ON variants.id = orderreseller.idproduk
        ...
        if($ongkir == 0){
            if($kurir == 'Ahsan' or $kurir == 'Gosend' or $kurir == 'Ambil ke Pusat' or $kurir == 'Disatukan') {
                $ceksql = "SELECT * FROM orderreseller 
                            INNER JOIN variants ON variants.id = orderreseller.idproduk
                            INNER JOIN products ON variants.idproducts = products.id 
                            WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0 AND products.idkategori = 52";
                ...
                echo "Diskon subDB 15% : Rp. -$tdiskona<br>";
        ...
        //     }
        //     echo "Estimasi Ongkir : Rp. $tongkir<br>";
        //     echo "Diskon subDB 15% : Rp. -$tdiskon52<br>";

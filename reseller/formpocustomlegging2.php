<?php
  ...
  $query = "SELECT COUNT(*) AS jumlah,
            ...
            AND pomitra.idmitrareseller = '$idadmin'
...
<body>
          ...
          <div class="card card-body">
            ...
            <?php else : ?>
              <div class="col-sm-12">
                ...
                <a href="datapom2.php?idmitrareseller=<?= $idadmin; ?>&id=<?= $id; ?>&invoice=<?= $invoice; ?>" class="btn btn-sm btn-success">Invoice</a>
              </div>
            <?php endif; ?>
          </div>
        </div>
  ...
  <?php
    if(isset($_POST["save"])){
      ...
      $invoice = 'RLC' . $idadmin . '-' . $idpoproduk;
      $queries = array();
      ...
      for ($i = 0; $i < $countQty; $i++) {
        ...
        if (!empty($idpodetail_item) && $jmlh_item >= 0 && $custom_item !== null && $font_item !== null) {
          $queries[] = "INSERT INTO pomitra (idpomitra, idmitrareseller, idpoproduk, idpo, idpodetail, jumlah, custom, font, total, invoice, status, tgl, waktu) VALUES

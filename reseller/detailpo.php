                                ...
                                <center>
                                    ...
                                    <div id="link2<?= $data['idpomitra']; ?>">
                                        ...
                                        <?php elseif ($idpoproduk === '339'): ?>
                                            <a target="_blank" class="aText" href="datapoinner.php?id=<?php echo $data['idpoproduk']; ?>&invoice=<?php echo $data['invoice']; ?>"><?php echo $data['invoice']; ?></a>
                                        <?php elseif ($idpoproduk === '355' || $idpoproduk == '361' || $idpoproduk == '366' || $idpoproduk == '371' || $idpoproduk == '374'): ?>
                                            <a target="_blank" class="aText" href="datapobundling.php?id=<?php echo $data['idpoproduk']; ?>&invoice=<?php echo $data['invoice']; ?>"><?php echo $data['invoice']; ?></a>

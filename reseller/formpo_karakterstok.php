...
if(!isset($_SESSION["mitraagen"])){
 ...
 <title>Mitra <?php echo $_SESSION['mitrareseller']['namaagen']; ?>| WNJ </title>
<html lang="en">
<head>
  <meta charset="utf-8">
...
<!--================ NAVBARU END =================-->
  <div class="container"> 
    ...
    <?php        
    $namapo=$data['namapo'];
     echo "<center> <h4> <b>Formulir Pemesanan $namapo $idmitrareseller</b> </h4> </center>";
    ?>
    </table>
...
if(isset($_POST["save"])){
  ...
  $invoice = 'KA'.$idpoproduk.'-'.$idmitrareseller.'-'.$nobaru;

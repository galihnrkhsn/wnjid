...
$password=$_POST['password'];
  ...
  $query = "INSERT INTO mitrareseller (idmitrareseller,idadmin,namaagen,status,email,password) VALUES ('null','$idadmin','$namaagen','$status','$email','$password')";    
  $sql = mysqli_query( $koneksi, $query);
  if($sql){ // Cek jika proses simpan ke database sukses atau tidak
    // Jika Sukses, Lakukan :
    header("location: dataagen.php"); // Redirect ke halaman index.php
  ...
  $query = "INSERT INTO mitramarketer (idmitramarketer,idadmin,namaagen,status,email,password) VALUES ('null','$idadmin','$namaagen','$status','$email','$password')";    
  $sql = mysqli_query( $koneksi, $query);
  if($sql){ // Cek jika proses simpan ke database sukses atau tidak
    // Jika Sukses, Lakukan :
    header("location: dataagen.php"); // Redirect ke halaman index.php

<?php
    ...
    $getUser            = $koneksi->query("SELECT * FROM mitrareseller WHERE idmitrareseller = '$idmitrareseller'");
...
<head>
    ...
    <title>WNJ.ID | Form PO Inner</title>
...
<body>
    ...
    <div class="container mt-3">
        ...
        <form method="post" class="">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select form-select-sm" name="variant[]" required>
                                            ...
                                            ?>
                                                <option value="<?= $data['idpodetail'] ?> | <?= $data['idpo'] ?> | Bundling 1 Sarung"><?= $data['variant'] ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select form-select-sm" name="variant[]" required>
                                                        ...
                                                        <?php
                                                            ...
                                                            while ($data = $sql->fetch_assoc()) {
                                                        ?>
                                                            <option value="<?= $data['idpodetail'] ?> | <?= $data['idpo'] ?> | Bundling ${formCount + 1} Sarung"><?= $data['variant'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
            ...
            <!-- INNER KNIT END -->
            <?php 
                    $query  = "SELECT COUNT(*) as jumlah,poproduk.idpoproduk,poproduk.namapo,poproduk.status, pomitra.invoice FROM poproduk inner join pomitra on poproduk.idpoproduk=pomitra.idpoproduk WHERE poproduk.idpoproduk='$idpoproduk' AND pomitra.idmitrareseller = '$idmitrareseller'";
            ...
            try {
                ...
                for ($x = 0; $x < $count; $x++) {
                    ...
                    $sql = $koneksi->query("INSERT INTO pomitra
                                                    (idpomitra, idmitrareseller, idpoproduk, idpo, idpodetail, jumlah, custom, total, invoice, status, tgl, waktu)
                                                VALUES
                                                    (NULL, '$idmitrareseller', '$idpoproduk', '$idpo', '$idpodetail', '$qty_item', '$custom', '$total_harga', '$invoice', 'Belum DP', NOW(), '$waktu')
                                            ");
                    ...
                    if ($sql) {
                        echo "
                            <script>
                                ...
                                location='datapobundling.php?id=$idpoproduk&invoice=$invoice'
                            </script>
                        ";
                    } else {
                        echo "
                            <script>
                                ...
                                location='formpobundling.php?id=$idpoproduk'
                            </script>
                        ";
                    }
                }

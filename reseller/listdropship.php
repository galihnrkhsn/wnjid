...
?>
      ...
      <button type="submit" class="btn btn-primary btn-sm" name="cari" id="linkmiki1<?= $tampilkan['idbpo']; ?>">
        <a  style="color:white" href="formdropship.php?idmitrareseller=<?php echo $idmitrareseller; ?>&idpo=<?php echo $tampilkan['idpoproduk'];?>&invoice=<?php echo$invoice;?>">Tambah Dropship <?php echo $tampilkan['namapo']; ?></a>
      </button>
...
?>	
	<div class="table-responsive">
				<table class="table table-bordered">
					...
					$sql = mysqli_query($koneksi, "SELECT * FROM podropship where invoice='$invoice' and idmitrareseller='$idmitrareseller' ");
					$no = 1;

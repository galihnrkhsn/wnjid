    ...
    <?php
        if (isset($_POST['kirim'])) {
            try {
                ...
                $invoice = 'R' . $idmitrareseller . '-' . $idpoproduk . $angka_acak;
                $sql = $koneksi->query("INSERT INTO podropship VALUES (
                                            NULL, '$idadmin', '0',
                                            '$idmitrareseller', '0', '$idpoproduk',
                                            '$invoice', NULL, NULL,
                ...
                if ($sql) {
                    ...
                    echo "
                        <script>
                            alert('Data Gagal Dikirim!')
                            location='pokonin.php?id=$idpoproduk'
                        </script>
                    ";
                }
            } catch (Exception $e) {

...
<div class="container row fixed-top navbaru" >
  ...
  <div class="col-8" ><p>STOCK AGEN</p></div>
...
<!--================ NAVBARU END =================-->
      ...
      $ambil=$koneksi->query("SELECT tgl FROM produk order by tgl desc limit 1 ");
		...
		<div style="padding: 0 15px;">
		      ...
		      <form method="post"><input type="text" name="namaproduk">  <button type="submit" class="btn btn-primary btn-xs" name="cari">Cari</button> <button type="submit" class="btn btn-primary btn-xs" name="tampil">Tampil Semua</button></form><br>
                ...
                <thead>
					...
					$sql = mysqli_query($koneksi,  "SELECT stockmitra.idstockmitra,produk.idproduk,produk.namaproduk,stockmitra.stock FROM stockmitra inner join produk inner join mitrareseller
					ON stockmitra.idproduk=produk.idproduk and stockmitra.idmitraagen=mitrareseller.idmitraagen WHERE stockmitra.idmitraagen='$idmitraagen' and produk.namaproduk LIKE '%$nama%' and stockmitra.idmitraagen<>0 ");
					...
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT stockmitra.idstockmitra,produk.idproduk,produk.namaproduk,stockmitra.stock FROM stockmitra inner join produk inner join mitrareseller
					ON stockmitra.idproduk=produk.idproduk and stockmitra.idmitraagen=mitrareseller.idmitraagen WHERE stockmitra.idmitraagen='$idmitraagen' and stockmitra.idmitraagen<>0 LIMIT ".$limit_start.",".$limit);

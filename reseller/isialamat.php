<?php
    ...
    $query = "SELECT * FROM mitrareseller 
    LEFT JOIN tb_ro_provinces on mitrareseller.provinsi = tb_ro_provinces.province_id
    LEFT JOIN tb_ro_cities on mitrareseller.kota = tb_ro_cities.city_id
    LEFT JOIN tb_ro_subdistricts on mitrareseller.kecamatan = tb_ro_subdistricts.subdistrict_id
...
<body>
    ...
    <?php
        ...
        if(isset($_POST['kirim'])){
            ...
            $koneksi->query("UPDATE mitrareseller set alamat='$alamat', provinsi='$provinsi', kota='$kabupaten', kecamatan='$kecamatan', kodepos='$kodepos', titikkordinat='$titikkordinat' where idmitrareseller='$idmitrareseller' ");

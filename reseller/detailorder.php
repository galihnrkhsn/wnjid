<?php 
    ...
    $queryUser  = $koneksi->query("SELECT * FROM mitrareseller WHERE idmitrareseller = '$idmitrareseller'");
...
<html lang="en">
    ...
    <div class="container mt-4">
        ...
        <h3><center>Invoice #<?= $invoice; ?></center></h3>
        <hr>
    
    <h4><center><?= $getUser['namaagen'] ?> (Cust ID : <?= $getUser['idmitrareseller']; ?> )</center></h4><br>
  ...
  $status = $query->fetch_assoc();
    ...
    $sqlcek2 = "SELECT * FROM orderreseller WHERE invoice='$invoice' ";
    ...
    if ($pengirimancek) {
          ...
          echo "<b>Alamat belum diisi. Silahkan isi alamat <a class='link text-danger' href='formpengiriman.php?id=$invoice&berat=$beratnya'>disini.</a></b>";
      }
...
<table class="table table-bordered">
  <tr>
   ...
   // $total=0;
    $nomorurut = 1;
    $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk=orderreseller.idproduk 
...
<tr>
  ...
  <?php endif ?>
    ...
    <?php
        ...
        $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk = orderreseller.idproduk 
                    WHERE orderreseller.invoice='$invoice' 
                    and orderreseller.jumlah > 0 and produk.idkategori > 0 
    ...
    <!----------------------------------------------------------------------------------------------------------------------------->
      ...
      <?php
    $totalb=0;
    $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk=orderreseller.idproduk WHERE orderreseller.invoice='$invoice' and orderreseller.jumlah>0 and produk.idkategori=2";
  $query = $koneksi->query($sql);
  while ($gb = $query->fetch_assoc()){
    ...
    <?php
    $totald5=0;
    $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk=orderreseller.idproduk WHERE orderreseller.invoice='$invoice' and orderreseller.jumlah>0 and produk.idkategori=5";
  $query = $koneksi->query($sql);
  while ($d5 = $query->fetch_assoc()){
    ...
    <?php
    $totald10=0;
    $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk=orderreseller.idproduk WHERE orderreseller.invoice='$invoice' and orderreseller.jumlah>0 and produk.idkategori=10";
  $query = $koneksi->query($sql);
  while ($d10 = $query->fetch_assoc()){
    ...
    <?php
    $totald15=0;
    $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk=orderreseller.idproduk WHERE orderreseller.invoice='$invoice' and orderreseller.jumlah>0 and produk.idkategori=15";
  $query = $koneksi->query($sql);
  while ($d15 = $query->fetch_assoc()){
    ...
    <?php
    $totald17=0;
    $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk=orderreseller.idproduk WHERE orderreseller.invoice='$invoice' and orderreseller.jumlah>0 and produk.idkategori=17";
  $query = $koneksi->query($sql);
  while ($d17 = $query->fetch_assoc()){
    ...
    <?php
    $totald20=0;
    $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk=orderreseller.idproduk WHERE orderreseller.invoice='$invoice' and orderreseller.jumlah>0 and produk.idkategori=20";
  $query = $koneksi->query($sql);
  while ($d20 = $query->fetch_assoc()){
    ...
    <?php
    $totald25=0;
    $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk=orderreseller.idproduk WHERE orderreseller.invoice='$invoice' and orderreseller.jumlah>0 and produk.idkategori=25";
  $query = $koneksi->query($sql);
  while ($d25 = $query->fetch_assoc()){
    ...
    <?php
        $ttl52 = 0;
        $sql = "SELECT MAX(produk.harga) as subtotal FROM orderreseller INNER JOIN produk ON produk.idproduk = orderreseller.idproduk WHERE orderreseller.invoice='$invoice' AND orderreseller.jumlah > 0 AND produk.idkategori = 52";
        // $sql = "SELECT * FROM orderreseller INNER JOIN produk ON produk.idproduk = orderreseller.idproduk WHERE orderreseller.invoice AND orderreseller.jumlah > 0 AND produk.idkategori = 52";
        $query = $koneksi->query($sql);
    ...
    <?php
    $totald51=0;
    $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk=orderreseller.idproduk WHERE orderreseller.invoice='$invoice' and orderreseller.jumlah>0 and produk.idkategori=51";
  $query = $koneksi->query($sql);
  ...
  while ($dfree = $query->fetch_assoc()){
    ...
    $dropship=$pengiriman['berat'];
        ...
        $p = 0;
        $dummy = "SELECT MAX(produk.harga) as harga FROM orderreseller INNER JOIN produk ON produk.idproduk = orderreseller.idproduk WHERE orderreseller.invoice='$invoice' AND orderreseller.jumlah > 0 AND produk.idkategori = 52";
    ...
    if($ongkir==0){
      if($kurir=='Ahsan' or $kurir=='Gosend' or $kurir=='Ambil ke Pusat' or $kurir=='Disatukan') {
            $ceksql = "SELECT * FROM orderreseller INNER JOIN produk ON produk.idproduk = orderreseller.idproduk WHERE orderreseller.invoice='$invoice' AND orderreseller.jumlah > 0 AND produk.idkategori = 52";
      ...
      //echo "<p align='right'>Diskon Manual : Rp. -$diskonramadhan<br>";
            // $sql = "SELECT * FROM orderreseller inner join produk on produk.idproduk=orderreseller.idproduk WHERE namaproduk LIKE '%Esacus Dress%' AND orderreseller.invoice='$invoice' and orderreseller.jumlah>0 ";
            // $query = $koneksi->query($sql);
...
?>
      <center><button type="submit" class="btn btn-sm" name="cari" id="linkmiki<?= $tampilkan['idorder']; ?>">
        <?php
            ...
            //         WHERE orderreseller.invoice = '$invoice' AND orderreseller.jumlah > 0";
            // $query = $koneksi->query($sql);
            // $grandTotalToShow = $tgrandtotal; // Default grand total value

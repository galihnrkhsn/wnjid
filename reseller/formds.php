...
<body>
    ...
    <?php
        if(isset($_POST['kirim'])){
            ...
            VALUES (NULL, '0', '0', '$idmitrareseller', '0', '$idpoproduk', '$invoice', '$no_ds', '$namapengirim', '$tlppengirim', '$namapenerima', '$tlppenerima', '$alamatpenerima', '$provinsi', '$kabupaten', '$kecamatan', '$keterangannya', '$ekspedisi')";

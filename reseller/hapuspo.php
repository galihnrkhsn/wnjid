					...
					?>
						<tr>
							...
							<form method="POST"><input type="hidden" name="harga" value=<?php echo $data['harga']; ?>>
							                    ...
							                    <button type="submit" class="btn btn-danger" name="hapus"><span class="glyphicon glyphicon-trash"></span></button></td>
		                    </form>
							<td class="align-middle"><?php echo $data['jumlah']; ?></td>
							<td class="align-middle"><?php echo $data['namapo']; ?> <?php echo $data['variant']; ?></td>
                            ...
                            if(isset($_POST["edit"])){
                                            ...
                                            //echo number_format($total, 2);
                                              ...
                                              //$tot=0;
        					                   $koneksi->query("UPDATE pomitra set jumlah='$jmlh', total='$total' where idpomitra='$idpomitra';");
		                                        ...
		                                        echo "<script>location='hapuspo.php?id=$idpo';</script>";
        					                     }
        					   elseif(isset($_POST["hapus"])){
					               ...
					               $koneksi->query("delete from pomitra where idpomitra='$idpomitra';");
        		                   	...
        		                   	echo "<script>location='hapuspo.php?id=$idpoproduk';</script>";
        					                     }                  

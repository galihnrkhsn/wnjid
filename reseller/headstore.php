        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="#">Katalog <span class="sr-only"></span></a></li>
                   <li class="active"><a href="#">Keranjang Belanja <span class="sr-only"></span></a></li>
                    <li class="active"><a href="#">Data Pesanan <span class="sr-only"></span></a></li>
                    <li class="active"><a href="#">Konfirmasi Pembayaran <span class="sr-only"></span></a></li>
                    <li class="active"><a href="#">Info & Rekening <span class="sr-only"></span></a></li>

...
<input type="text" name="namaproduk">  <button type="submit" class="btn btn-primary" name="cari">Cari</button>  <button type="submit" class="btn btn-primary" name="tampil">Tampil Semua</button></form></pre>-->
    ...
    <tbody>
     ...
     <?php
      ...
      $ambil=$koneksi->query("SELECT * FROM produk where namaproduk LIKE '%$nama%' and stock>0 LIMIT ".$limit_start.",".$limit." ");       
	  ...
	  $limit = 20; 
	  $limit_start = ($page - 1) * $limit;
      $ambil=$koneksi->query("SELECT * FROM produk where stock>0  LIMIT ".$limit_start.",".$limit." "); 
      }else{
	  ...
	  $limit = 20; 
	  $limit_start = ($page - 1) * $limit;
      $ambil=$koneksi->query("SELECT * FROM adsmitra where idmitra='$idadmin' order by tgl desc LIMIT ".$limit_start.",".$limit." "); 
      }
...
<ul class="pagination">
				...
				$sql2 = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM adsmitra");

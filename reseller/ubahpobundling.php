                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select form-select-sm" name="variant[]" required>
                                                ...
                                                ?>
                                                    <option value="<?= $data['idpodetail'] ?> | <?= $data['idpo'] ?> | Bundling <?= $angkaBaru; ?> Sarung"><?= $data['variant'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
            ...
            try {
                ...
                for ($x = 0; $x < $count; $x++) {
                    ...
                    $sql = $koneksi->query("INSERT INTO pomitra
                                                    (idpomitra, idmitra, idmitrareseller, idpoproduk, idpo, idpodetail, jumlah, custom, total, invoice, status, tgl, waktu)
                                                VALUES
                                                    (NULL, '$idmitra', '$idmitrareseller', '$idpoproduk', '$idpo', '$idpodetail', '$qty_item', '$custom', '$total_harga', '$invoice', 'Belum DP', NOW(), '$waktu')
                                            ");

...
if(!isset($_SESSION["admin_mitra"])){
 ...
 $idpoproduk = $_GET['id'];
  ...
  $query = "SELECT COUNT(*) as jumlah,poproduk.idpoproduk,poproduk.namapo,poproduk.status FROM poproduk inner join pomaximus on poproduk.idpoproduk=pomaximus.idpoproduk WHERE poproduk.idpoproduk='$idpoproduk' AND pomaximus.idadmin='$idadmin'";
...
<input type="text" name="namaproduk">  <button type="submit" class="btn btn-primary" name="cari">Cari</button>  <button type="submit" class="btn btn-primary" name="tampil">Tampil Semua</button></form></pre>-->  
			...
			<?php
					...
					FROM poproduk inner JOIN pokategori inner join podetail inner join pomaximus on poproduk.idpoproduk=pomaximus.idpoproduk and pokategori.idpo=pomaximus.idpo and podetail.idpodetail=pomaximus.idpodetail WHERE pomaximus.idadmin='$idadmin' and pomaximus.idpoproduk='$idpoproduk'");

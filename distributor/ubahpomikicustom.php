...
<div class="container row fixed-top navbaru" >
  ...
  <div class="col-2"><a href="datapom.php?id=<?=$idpoproduk;?>&invoice=<?= $invoice; ?>"><i class="glyphicon glyphicon-chevron-left"></i></a></div>
				...
				<table class="table table-bordered">
					...
					?>
						<tr>
							...
							<td class="align-middle">
							<input type="text" name="custom[]" class="form-control" value="<?php echo $data['custom']; ?>">
		                   ...
		                   <td class="align-middle">
		                   	<select name="fontku[]" class="form-control">
							...
							<td class="align-middle">
								<a class="btn btn-danger" href="hapusmiki.php?id=<?php echo $data['idpomitra']; ?>" 

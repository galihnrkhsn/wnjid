...
<div class="container row fixed-top navbaru" >
  ...
  <div class="col-8" ><p>GRADE B</p></div>
...
<div class="container">
		...
		?>	    
		<p align="right"><input type="radio" onclick="javascript:window.location.href='storeb2.php'; "> Mode Hemat  &nbsp&nbsp<input type="radio" onclick="javascript:window.location.href='storeb.php'; " checked="checked"> Mode Cantik</p>
...
<div class="container">
            ...
            <div class="row">
				  ...
				  // Include / load file koneksi.php
					...
					$sql = mysqli_query($koneksi, "SELECT * from produkb WHERE stock>0 and harga>0 and namaproduk LIKE '%$namaproduk%' and idkategori=2 and status=0");
				 ...
				 // Include / load file koneksi.php
					...
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT * from produk WHERE stock>0 and harga>0 and idkategori=2 and status=0 LIMIT ".$limit_start.",".$limit);
					...
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT * from produk WHERE stock>0 and harga>0 and idkategori=2 and status=0 order by namaproduk asc LIMIT ".$limit_start.",".$limit);
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-6">
                   ...
                   <div class="card img" style="width:500px">
                    <img class="card-img-top" src="foto/<?php echo $data['foto']; ?>" alt="Card image" style="width:100%">
                    <div class="card-body">
                      <h4 class="card-title"><?php echo $data['namaproduk']; ?> <br></h4>
                      <p class="card-text">
						(<?php echo $data['stock']; ?>)Pcs 	&nbsp&nbsp&nbsp
                      <a href="add_chartb.php?id=<?php echo $data['idproduk']; ?>&harga=<?php echo $data['harga']; ?>" class="btn btn-primary">Beli</a></p>
                    </div>
                    </div>
                    <!-- MODIF AKHIR -->
			...
			<ul class="pagination">
				...
				$sql2 = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM produk where stock>0 and harga>0 and idkategori=2 and status=0");

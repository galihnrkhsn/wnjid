...
<head>
    ...
    <title>WNJ | <?= $_SESSION["namamitra"] ?></title>
...
<body>
    ...
    <div class="row fixed-top navbaru py-2">
        <div class="col-2">
            <a href="detailpo.php?id=<?= $idpoproduk; ?>">
                    ...
                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                ...
                                ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <form method="post">
                                                    <input type="hidden" class="form-control form-control-sm" name="idpomitra" value="<?= $data['idpomitra'] ?>">
                                                    <div class="d-flex align-items-center">
                                                        <input type="number" class="form-control form-control-sm mr-2" name="qty" value="<?= $data['jumlah'] ?>">
                                                        <?php if ($idpoproduk == 314) : ?>
                                                            <button class="btn btn-success btn-sm" name="ubah_qty">Ubah</button>
                                                            <button class="btn btn-danger btn-sm" name="hapus_barang" onclick="alert('Apa anda yakin?')">Delete</button>
                                                        <?php endif; ?>
                                                    </div>
                                                </form>
                                            </td>
                                            <td>Rp. <?= number_format($data['harga'] * $data['jumlah']) ?></td>
                                                ...
                                                <!--    <a class="btn btn-sm btn-primary" href="formpoinner.php?id=<?= $idpoproduk ?>&invoice=<?= $invoice ?>">Tambah Produk</a>-->
                                                <!--</td>-->
                                        </tr>
                                    </tbody>
                                <?php 
                        ...
                        <div class="col-sm-12 text-center">
                            <?php if ($datapo['status'] == "Belum DP" || $sisa >= $subtotal) : ?>
                                <a href="popembayaran.php?invoice=<?= $invoice ?>&total=<?= $idpoproduk == 259 ? 100000 : $dp1 ?>&bayar=<?= $subtotal ?>&idpo=<?= $idpoproduk ?>&jenis=Payment 1" class="btn btn-success btn-sm">Konfirmasi Pembayaran</a>
                                <?php if ($idpoproduk == 314) : ?>
                                    <a class="btn btn-sm btn-primary" href="formpoinner.php?id=<?= $idpoproduk;?>&invoice=<?= $invoice;?>">Tambah Barang</a>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                    </div>

<?php
    ...
    $query_berat = $koneksi->query("SELECT 
                                            podetail.berat, pomitra.jumlah, poproduk.namapo
                                        FROM
                                            pomitra
                                                INNER JOIN
    ...
    while ($data_berat = $query_berat->fetch_assoc()) {
        ...
        $namapo = $data_berat['namapo'];
    }

    $sql_ds = $koneksi->query("SELECT 
                                        podropship.*
                                    FROM
                                        podropship
                                    WHERE
...
<html lang="en">
    <head>
        ...
        <title>WNJ.ID | Form Alamat Konin 2025</title>
    ...
    <body>
        <nav class="navbar bg-body-tertiary">
            <div class="container d-flex align-items-center">
                ...
                <p class="navbar-brand text-uppercase fw-semibold mb-0"><?= $namapo ?></p>
        ...
        <div class="container mt-2 mb-5 pb-5">
            <div class="col-sm-12 text-center">
                <h5 class="text-uppercase mb-0 fw-normal">Form Ubah Alamat</h5>
                <h3>#<?= $invoice ?></h3>
            </div>
                    ...
                    <form method="post" class="row" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-select form-select-sm" id="jenis-pengiriman" name="jenis" required>
                                    <?php if ($data_ds['dropship'] == 0) : ?>
                                        <option value="Dropship" selected>Dropship</option>
                                    <?php else : ?>
                                        <option value="Alamat Pribadi" selected>Alamat Pribadi</option>
                                    <?php endif;  ?>
                                    <optgroup label="SELECT JENIS PENGIRIMAN">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" id="alamat" name="alamat" rows="4" placeholder="Masukan alamat pengiriman..."><?= $data_ds['alamatpenerima'] ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select form-select-sm" id="provinsi" name="provinsi">
                                    <option value="<?= $data_ds['provinsi'] ?>" selected><?= $data_ds['province_name']; ?></option>
                                        <?php

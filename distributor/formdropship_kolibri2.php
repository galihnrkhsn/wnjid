...
<!--================ NAVBARU END =================-->
    ...
    <form method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" value="<?= $datapo['namapengirim'] ?>" name="namapengirim" required readonly>
        </div>
    
        <div class="form-group">
          <label>Telepon Pengirim</label>
          <input type="number" class="form-control" value="<?= $datapo['tlppengirim'] ?>" name="tlppengirim" required maxlength="17" readonly>
        </div>    
<hr>
    
      <div class="form-group">
          <label>Nama Penerima</label>
          <input type="text" class="form-control" value="<?= $datapo['namapenerima'] ?>" name="namapenerima" required readonly>
      </div>
    
      <div class="form-group">
        <label>Telepon Penerima</label>
        <input type="number" class="form-control" value="<?= $datapo['tlppenerima'] ?>" name="tlppenerima" required maxlength="17" readonly>
      </div>
          ...
          <?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="jenis" id="jenis" required>
                          ...
                          <option value="Pribadi">Alamat Pribadi</option>           
                        </select>
                    </div>
...
// echo "<script>alert('$idadmin , $idpoproduk, $invoice, $namapengirim, $tlppengirim, $namapenerima, $tlppenerima, $alamat, $provinsi, $kabupaten, $kecamatan, $keterangan, $ekspedisi, $layananku, $ongkir, $biayad, $jenis');</script>";

    $query = "UPDATE podropship SET 

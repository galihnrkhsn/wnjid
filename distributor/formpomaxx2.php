...
echo "
    ...
    <center><b>Anda sudah mengisi Formulir $namapo , Klik Tombol Dibawah ini Jika ingin melihat atau merevisi Invoice, 
      ...
      <a class='btn btn-info' href='datapomax.php?idmitra=$idadmin&id=$id'> INVOICE</a> </center>";
    }
?>
  </table>
  </div><br><br>
                                           ...
                                           // for($x=0;$x<$jmlhtotal;$x++){
                                            //echo number_format($total, 2);
                                             ...
                                             if($sisa['stok']>$jmlh[$x]){
        					                   ...
        					                   (null,'$idadmin','0','0','0','$idpoproduk','$idpo[$x]','$idpodetail[$x]','$jmlh[$x]','$total','D$idpoproduk-$idadmin','Belum DP',NOW())");

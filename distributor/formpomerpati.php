...
?>
  ...
  <div class="container panel panel-default">
		...
		<div style="padding: 0 15px;">
			...
			<li class="active"><a data-toggle="tab" href="#home">Dress</a></li>
			<li><a data-toggle="tab" href="#menu1">Khimar</a></li>
				<li><a data-toggle="tab" href="#menu2">Set</a></li>
		</ul>
		...
		<div class="tab-content">
			<div id="home" class="tab-pane fade in active">
				<?php
						...
						$total = 0;
						$index = 0;
						$sql = "SELECT * FROM poproduk inner join pokategori inner join podetail on poproduk.idpoproduk=pokategori.idpoproduk and pokategori.idpo=podetail.idpo where poproduk.idpoproduk='$idpoproduk' order by podetail.idpodetail asc limit 36";
			...
			<div id="menu1" class="tab-pane fade">
				<?php
						...
						$total = 0;
						$index = 0;
						$sql2 = "SELECT * FROM poproduk inner join pokategori inner join podetail on poproduk.idpoproduk=pokategori.idpoproduk and pokategori.idpo=podetail.idpo where poproduk.idpoproduk='$idpoproduk' order by podetail.idpodetail asc limit 36,12";
				...
				<?php
						...
						$total = 0;
						$index = 0;
						$sql2 = "SELECT * FROM poproduk inner join pokategori inner join podetail on poproduk.idpoproduk=pokategori.idpoproduk and pokategori.idpo=podetail.idpo where poproduk.idpoproduk='$idpoproduk' order by podetail.idpodetail asc limit 48,72";
						$query2 = $koneksi->query($sql2);
							while($row2 = $query2->fetch_assoc()){
								?>

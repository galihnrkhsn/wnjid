...
-->  
<div class="container">
    <a class="btn btn-success" href="inputagen.php">Tambah Mitra</a> 
    <a class="btn btn-danger" href="dataagen_hapus.php">Hapus</a><br><br>
   ...
   <div class="table-responsive">
    ...
    <thead>
	 ...
	 $limit_start = ($page - 1) * $limit;
      ...
      ?>
      <tr>
          <form method="post"><input type="hidden" name="idmitraagen" value=<?php echo $distributor['idmitraagen']; ?>>
							                    <td class="align-middle">
							                    <select name="status">
							                        <option value="Agen">Agen</option>
							                        <option value="Reseller">Reseller</option>
							                        <option value="Marketer">Marketer</option></select>
							                    <button type="submit" class="btn btn-primary" name="ubah">Ubah</button></td>
							                        </form>

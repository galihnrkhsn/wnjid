    ...
    <body>
        ...
        <div class="container mx-auto mt-2 mb-3">
            ...
            <?php
                ...
                $sqlcheck2      = $koneksi->query("SELECT * FROM ordermitra WHERE invoice = '$invoice'");
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                            $no = 1;
                            $sql = $koneksi->query("SELECT * FROM ordermitra
                ...
                <div class="text-center mt-3">
                    <a href="formpembayaran2.php?id=<?= $invoice;?>&total=<?= $grandtotal ?>" class="btn btn-sm btn-success">Konfirmasi Pembayaran</a>
                </div>
            </div>
        </div>

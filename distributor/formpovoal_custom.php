    ...
    <body>
                    ...
                    <div class="col-lg-5">
                        ...
                        ?>
                            <div class="form-group mb-2">
                                ...
                                <input type="number" name="qty[]" id="<?= $item['idpodetail'] ?>" value="0" min="0" max="<?= $item['stok'] ?>" class="form-control form-control-sm">
        ...
        <?php
            if(isset($_POST['kirim'])) {
                ...
                $angka_acak = generateAngkaAcak($length);
                $invoice = 'D'. $idadmin . '-' . $angka_acak;

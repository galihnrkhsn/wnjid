		...
		<div class="container" align="center">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					$subtotal=0;
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT poproduk.namapo,pokolibri.status,pokategori.namakategori,podetail.variant,pokolibri.idpokolibri,pokolibri.jumlah,pokolibri.invoice,pokolibri.total,podetail.harga 
				    ...
				    <?php if($status=='Belum DP'){
							      echo "<center><button type='submit' class='btn btn-primary' name='cari' id='linkraya'><a style='color:white' href='popembayaran_kolibri.php?invoice=$invoice&total=$payment1'>Konfirmasi Payment 1</a></button><p id='demoraya'></p></center>";
				         }else {

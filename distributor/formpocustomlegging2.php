...
<body>
  ...
  <?php
    if(isset($_POST["save"])){
      ...
      $invoice = 'DLC' . $idadmin . '-' . $idpoproduk;
      $queries = array();
      ...
      for ($i = 0; $i < $countQty; $i++) {
        ...
        if (!empty($idpodetail_item) && $jmlh_item >= 0 && $custom_item !== null && $font_item !== null) {
          $queries[] = "INSERT INTO pomitra (idpomitra, idmitra, idpoproduk, idpo, idpodetail, jumlah, custom, font, total, invoice, status, tgl, waktu) VALUES

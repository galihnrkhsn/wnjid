...
<body>
    ...
    <?php
        if(isset($_POST['kirim'])){
            ...
            VALUES (NULL, '$idadmin', '0', '0', '0', '$idpoproduk', '$invoice', '$no_ds', '$namapengirim', '$tlppengirim', '$namapenerima', '$tlppenerima', '$alamatpenerima', '$provinsi', '$kabupaten', '$kecamatan', '$keterangannya', '$ekspedisi')";

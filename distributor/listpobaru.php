...
<div style="padding: 0 15px;">
    ...
    <ul class="nav nav-tabs">
		...
		<li><a data-toggle="tab" href="#menu1" class="btn btn-primary">List PO Kolibri</a></li>
		<li><a data-toggle="tab" href="#menu2" class="btn btn-primary">List PO Kolibri SubDB</a></li>
	</ul>

	...
	<?php include "assets/components/Navbar/navbar.php"; ?>
		...
		<div class="container">
			<div class="panel-body">
				<div class="row">
					<div class="col-md-6">
						<p align="right"><input type="radio" onclick="javascript:window.location.href='formpengirimanb.php?id=<?php echo $invoice; ?>&berat=<?php echo $berat; ?>'; "> Dropship  <input type="radio" onclick="javascript:window.location.href='formpengiriman2.php?id=<?php echo $invoice; ?>&berat=<?php echo $berat; ?>';"  checked="checked"> Kirim Ke Alamat Pribadi</p>
						<form method="post">

...
include "koneksi.php";
    ...
    $idpoproduk=$_GET["idpo"];
	  ...
	  $koneksi->query("insert into popembayaran_kolibri (idpembayaran,invoice,bankpengirim,rekeningpengirim,metodebayar,tgl,payment2) values
	  ('null','$invoice','$bankpengirim','$rekeningpengirim','$metodebayar',NOW(),'$jmlhtransfer')");
     $koneksi->query("UPDATE pokolibri SET status='Sudah Confirm Payment 2' where invoice='$invoice' ");        

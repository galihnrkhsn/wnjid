  ...
  <div class="container panel panel-default">
    ...
    <div style="padding: 0 15px;">
        ...
        <?php
            ...
            $total = 0;
            $index = 0;
            $sql = "SELECT * FROM poproduk inner join pokategori inner join podetail on poproduk.idpoproduk=pokategori.idpoproduk and pokategori.idpo=podetail.idpo where poproduk.idpoproduk='$idpoproduk' and SUBSTRING(podetail.variant, 1, 6)='Custom' order by pokategori.idpo asc";
              ...
              while($row = $query->fetch_assoc()){
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="harga[]" value="<?php echo $row['harga']; ?>">
                      ...
                      <img src="img/contohinput.PNG" width="100%"><br>
                      
                      <label>Contoh Font Teks : </label><br>
                  <img src="img/mikifont.jpeg" width="100%"><br><br>
                  <img src="img/mikicustom.jpeg" width="100%"><br><br>
                  <img src="img/mikicustom2.jpeg" width="100%">
                   ...
                   $sql = mysqli_query($koneksi, "SELECT idpomitra FROM pomitra order by iddropship desc limit 1");
                   $data = mysqli_fetch_array($sql);
                   $no=$data['idpomitra'];
                   $ab=1;
                   $nobaru=$no+$ab;
                             ...
                             $jumlah_dipilih = count($jmlh);
                                    ...
                                    for($x=0;$x<$jumlah_dipilih;$x++){
                                     ...
                                     (null,'$idadmin','$idpoproduk','$idpo[$x]','$idpodetail[$x]','$jmlh[$x]','$custom[$x]','$total','M$idpoproduk-$idadmin-$nobaru','Belum DP',NOW())");

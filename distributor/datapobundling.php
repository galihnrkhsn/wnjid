<?php
    ...
    $querybukapo    = "SELECT bukapo.idbpo, bukapo.jenis_mitra, bukapo.jenis_po,
                                bukapo.idpoproduk, bukapo.tgl_ubah, bukapo.tgl_dropship,
                    ...
                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                    ...
                                    ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($todayRaw > $selesai) : ?>
                                                    <?php elseif ($todayRaw <= $selesai) : ?>
                                                        <a href="editpobundling.php?id=<?= $idpoproduk ?>&invoice=<?= $invoice ?>&bundling=<?= $string ?>" class="btn btn-success btn-sm">
                        ...
                        <div class="col-sm-12 text-center my-2">
                            <?php if ($datapo['status'] === "Belum DP") : ?>
                                ...
                                <?php elseif ($todayRaw <= $selesai) : ?>
                                    <?php if ($databukapo['jenis_po'] == 'PO Set') : ?>
                                        <a href="ubahpobundlingset.php?id=<?= $idpoproduk ?>&invoice=<?= $invoice ?>" class="btn btn-warning btn-sm">Ubah PO</a>
                                    <?php else :?>

...
<div class="row ">
    <div class="col-6 col-lg-6"><a href="listnewpo">
        <img src="img/preorder.png" class="d-block w-100"></a>
    </div>
    <?php if($mode['mode']=='store'){
      echo " <div class='col-6 col-lg-6'><a href='store'>
        <img src='img/readystock.png' class='d-block w-100'></a>
        </div> ";
        //   echo " <div class='col-6 col-lg-6'><a href='#'>
        //     <img src='img/readystock.png' class='d-block w-100'></a>
        // </div> ";
      }else if($mode['mode']=='store2'){
           echo " <div class='col-6 col-lg-6'><a href='store2'>
            <img src='img/readystock.png' class='d-block w-100'></a>
        </div> ";
        //  echo " <div class='col-6 col-lg-6'><a href='#'>
        //     <img src='img/readystock.png' class='d-block w-100'></a>

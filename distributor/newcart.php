...
<!--================ NAVBARU END =================-->
      <div class="container">
		...
		?>	   
			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					<?php
						...
						$sql = "SELECT * FROM keranjang inner join produk on keranjang.idproduk=produk.idproduk WHERE idmitra='$idmitra' and jmlh>0 ";
			...
			<input type="checkbox" name="idkeranjang[]" value="<?php echo $row['idkeranjang']; ?>"/></td>
								...
								$max1=$max+1;
								?>
								<td><input type="number" min="0" class="form-control" value="<?php echo $row['jmlh']; ?>" name="jmlhbaru[]">Ready Stock : <?php echo $row['stock']; ?></td>

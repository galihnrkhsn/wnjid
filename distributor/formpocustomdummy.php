                        ...
                        for (i = 0; i < provinsiKedua<?php echo $row['idpodetail']; ?>; i++) {
                          text += "No. "+ (i+1) +"<?php
                            echo "<div class='row'>";
                              ...
                              echo "<div class='form-group col-sm-12'>";
                                echo "<input type='hidden' name='is_custom[]' value='1'>";
                              echo "</div>";
    ...
    if (isset($_POST["save"])) {
        ...
        for ($i = 0; $i < $countQty; $i++) {
            ...
            if(isset($_POST["namacustom"]) && $_POST["namacustom"][$i] !== null  && $_POST["namacustom"][$i] !== "") {
                $custom_item = $variant_item[$i] . " | " . $goura[$i]. " ( " . $_POST["namacustom"][$i] . " )";
            ...
            // var_dump($idpodetail_item . " , " . $idpo_item . " , " . $custom_item . " , " . $harga_item . " , " . $qty_item);

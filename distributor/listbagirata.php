...
if(!isset($_SESSION["admin_mitra"])){
  ...
  $data = mysqli_fetch_array($sql);
    ...
    $querydb = "SELECT * FROM admin_mitra WHERE idadmin='$idadmin'";
  $sqldb = mysqli_query($koneksi, $querydb);  
  $datadb = mysqli_fetch_array($sqldb);
  ...
  <div class="container panel panel-default">
    ...
    <div style="padding: 0 15px;">
        ...
        <?php
            ...
            $total = 0;
            $index = 0;
            $sql = "SELECT * FROM poproduk inner join pokategori inner join podetail on poproduk.idpoproduk=pokategori.idpoproduk and pokategori.idpo=podetail.idpo where poproduk.idpoproduk='$idpoproduk' order by pokategori.idpo desc";
            $query = $koneksi->query($sql);
              while($row = $query->fetch_assoc()){
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="jmlh[]" class="form-control" style="width:300px;" value="1">
                    <input type="text" name="custom[]" class="form-control" style="width:300px;" value="<?= $namamitra; ?>" disabled>
                         ...
                         $idpodetail=$_POST["idpodetail"];
                             ...
                             $jumlah_dipilih = count($jmlh);
                                    ...
                                    for($x=0;$x<$jumlah_dipilih;$x++){
                                     ...
                                     (null,'$idadmin','$idpoproduk','$idpo[$x]','$idpodetail[$x]','$jmlh[$x]','$namamitra','$total','D$idpoproduk-$idadmin','Belum DP',NOW())");

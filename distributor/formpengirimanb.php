...
<body>
    ...
    <div class="container">
        <div class="panel-body">
            <div class="row">
                <div class="col-md-6">
                    <p align="right">
                        <input type="radio" onclick="javascript:window.location.href='formpengirimanb.phpid=<?php echo $invoice; ?>&berat=<?php echo $berat; ?>&jenis=<?= $jenis ?>'; " checked="checked"> Dropship  
                        <input type="radio" onclick="javascript:window.location.href='formpengiriman2.php?id=<?php echo $invoice; ?>&berat=<?php echo $berat; ?>&jenis=<?= $jenis ?>'; "> Kirim Ke Alamat Pribadi
                    </p>
                    <form method="post">
    ...
    <?php
        ...
        if(isset($_POST['kirim'])){
            ...
            if (empty($layananku)) {
                $layananku = "NULL"; // Set NULL untuk database jika layanan kosong
                $ongkir = 0;         // Ongkir menjadi 0
            } else {
                $ongkir = (int) ($result_explode[1] ?? 0); // Default ongkir ke 0 jika tidak ada
            }
            ...
            if ($pengirimancek) {
                ...
                $query          = "INSERT INTO orderpengiriman 
                                    ...
                                    (
                                        ...
                                        '$kabupaten','$kecamatan','$ekspedisi'," . ($layananku === "NULL" ? "NULL" : "'$layananku'") . ",
            ...
            if ($sql == TRUE) {
                ...
                echo "<script>location='formpengirimanb.php?id=$_GET[id]&berat=$_GET[berat]'</script>";
            }
        }
    ?>	
</html>

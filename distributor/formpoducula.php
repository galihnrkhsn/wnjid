...
<body>
  ...
  <div class="container mt-5 py-5">
    ...
    <?php
      $sql650 = "SELECT SUM(pomitra.jumlah) AS total_pcs FROM pomitra WHERE idpoproduk = 287";
      ...
      <?php else : ?>
        <div class="col-sm-12 text-center">
            ...
            <?php if ($data['jumlah'] > 1) : ?>
                <a href="datapo.php?idmitra=<?= $idadmin; ?>&id=<?= $idpoproduk; ?>&invoice=<?= $invoice ?>" class="badge btn btn-primary">Invoice</a>
            <?php endif; ?>
        </div>

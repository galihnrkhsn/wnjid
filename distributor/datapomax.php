...
if(!isset($_SESSION["admin_mitra"])){
 ...
 $idpoproduk = $_GET['id'];
  ...
  $query = "SELECT COUNT(*) as jumlah,poproduk.idpoproduk,poproduk.namapo,poproduk.status,poproduk.note FROM poproduk inner join pomaximus on poproduk.idpoproduk=pomaximus.idpoproduk WHERE poproduk.idpoproduk='$idpoproduk' AND pomaximus.idadmin='$idadmin'";
		...
		echo "Dropship bisa di lihat di <a href='listnewpo.php'>Menu Listdropship</a>";
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					FROM poproduk inner JOIN pokategori inner join podetail inner join pomaximus on poproduk.idpoproduk=pomaximus.idpoproduk and pokategori.idpo=pomaximus.idpo and podetail.idpodetail=pomaximus.idpodetail WHERE pomaximus.idadmin='$idadmin' and pomaximus.idpoproduk='$idpoproduk' and pomaximus.jumlah>0");
...
var countDownDateme = new Date("Jun 22, 2021 12:59:00").getTime();

...
<!--================ NAVBARU END =================-->
<?php
$queryp = "SELECT privateorder FROM admin_mitra WHERE idadmin='$idadmin'";
$sqlp = mysqli_query($koneksi, $queryp);  
$datap = mysqli_fetch_array($sqlp);
$privateorder=$datap["privateorder"]; 
...
?>
 ...
 <?php } else {
  echo "<center>Anda tidak terdaftar untuk mengikuti PO ini</center>";
  }
 ?>
                                           ...
                                           // for($x=0;$x<$jmlhtotal;$x++){
                                            //echo number_format($total, 2);
                                             ...
                                             // if($stok>$jmlh[$x]){
        					                   ...
        					                   (null,'$idadmin','$idpoproduk','$idpo[$x]','$idpodetail[$x]','$jmlh[$x]','$total','D$idpoproduk-$idadmin','Belum DP',NOW())");

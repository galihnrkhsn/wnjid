                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <a class="btn btn-info btn-xs" href="add_chart4.php?namaproduk=<?php echo $data['namaproduk']; ?>&id=<?php echo $data['idproduk']; ?>&harga=<?php echo $data['harga']; ?>" class="btn btn-primary"> <span class="fas fa-cart-shopping"></span></a>
                            <?php else: ?>

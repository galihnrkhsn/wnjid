...
$stock = $_POST["stock"];
  ...
  $query = "INSERT INTO produkdb (idprodukdb,idproduk,idadmin,namaproduk,harga,berat,stock,tgl,foto) VALUES ('null','$idproduk','$idadmin','$namaproduk','$harga','$berat','$stock',NOW(),'$foto')";    

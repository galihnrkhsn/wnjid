                                        ...
                                        <?php else : ?>
                                            ...
                                            <?php else : ?>
                                                <?php
                                                    ...
                                                    // Daftar tanggal start dan end
                                                    $dates = [
                                                        ["start" => "2024-11-14", "end" => "2024-11-16"],
                                                        ["start" => "2024-11-30", "end" => "2024-12-03"],
                                                    ...
                                                    // Periksa apakah tanggal saat ini berada dalam salah satu rentang
                                                ...
                                                ?>
                                                <?php if (!$canPay) : ?>
                                                    <p class="fw-semibold">Konfirmasi pembayaran dilakukan pada tanggal yang telah ditentukan.</p>
                                                <?php else : ?>

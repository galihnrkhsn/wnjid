<?php 
    header("Location: http://wnj.id/distributor/store4.php");
    exit();
session_start();
...
<div class="container">
            ...
            <div class="row">
				  ...
				  // Include / load file koneksi.php
					...
					$namaproduk=$_GET['namaproduk'];
					$sql = mysqli_query($koneksi, "SELECT * from produk WHERE stock>0  and namaproduk LIKE '%$namaproduk%' and idkategori>0 and namaproduk LIKE '%Voal Hampers%' and status<>1");
				 ...
				 // Include / load file koneksi.php
					...
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT * from produk WHERE stock>0  and idkategori>0 and namaproduk LIKE '%Voal Hampers%' and status<>1 order by tgl desc, idproduk desc LIMIT ".$limit_start.",".$limit);
  ...
  <?php endif ?>                      	
			...
			<ul class="pagination">
				...
				$sql2 = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM produk where stock>0  and idkategori>0 and namaproduk LIKE '%Voal Hampers%' and status=0");

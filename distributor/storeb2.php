...
<div class="container row fixed-top navbaru" >
  ...
  <div class="col-2"><a href="store.php"><span class="glyphicon glyphicon-chevron-left"</span></a></div>
		...
		<p align="right"><input type="radio" onclick="javascript:window.location.href='storeb2.php'; " checked="checked"> Mode Hemat &nbsp&nbsp <input type="radio" onclick="javascript:window.location.href='storeb.php'; "> Mode Cantik</p>
                ...
                <table class="w3-table-all" id="dataTables-example" border="0" >
				  ...
				  // Include / load file koneksi.php
					...
					$sql = mysqli_query($koneksi, "SELECT * from produk WHERE stock>0 and harga>0 and namaproduk LIKE '%$namaproduk%' and idkategori=2 and status=0");
				 ...
				 // Include / load file koneksi.php
					...
					?>
						...
						<tr>
						<td><a class="btn btn-info btn-xs" href="add_chartb2.php?id=<?php echo $data['idproduk']; ?>&harga=<?php echo $data['harga']; ?>"> <span class="glyphicon glyphicon-plus"></span></a> </td>
			...
			<ul class="pagination">
				...
				$sql2 = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM produk where stock>0 and harga>0 and status=0 and idkategori=2");

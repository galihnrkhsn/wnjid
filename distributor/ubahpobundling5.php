                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-sm-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" class="form-control form-control-sm" min="0" value="0" name="qty[]" id="form${formCount + 1}_3" required>
                                                        <input type="hidden" class="form-control form-control-sm" min="0" value="0" name="qty[]" id="form${formCount + 1}_4" required>
                                                    </div>
                                                </div>

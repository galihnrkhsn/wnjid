...
<head>
  ...
  <title>WNJ.ID | Form Inner Custom</title>
  ...
  <?php
    if(isset($_POST["save"])) {
      ...
      for ($i = 0; $i < $total; $i++) {
        ...
        $queries[] = "INSERT INTO pomitra (idpomitra, idmitra, idpoproduk, idpo, idpodetail, jumlah, template, custom, font, total, invoice, status, tgl, waktu) VALUES (NULL, '$idadmin', '$idpoproduk', '$itemIdpo', '$itemIdpodetail', '$itemQty', NULL, '$custom_data', NULL, '$itemTotal', '$invoice', 'Belum DP', NOW(), '$waktu')";
      }

...
<script type="text/javascript">
        $(document).ready( function () {
    $('#tbspecialorder_koalisi').DataTable({
...
<script type="text/javascript">
        $(document).ready( function () {
    $('#tbspecialorder_series').DataTable({
...
<script type="text/javascript">
        $(document).ready(function() {
            if (!$.fn.dataTable.isDataTable('#tb_lunas')) {
                $('#tb_lunas').DataTable({
                    "language": {
                    "decimal":        "",
                    "emptyTable":     "Tidak ada data di dalam tabel",

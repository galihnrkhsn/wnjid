...
<body>
  ...
  <div class="row fixed-top navbaru py-2">
    <div class="col-2">
      <a href="detailkolibri.php?id=<?= $idpoproduk ?>">
          ...
          <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
            ...
            <div class="col-sm-12 d-flex justify-content-end">
              <div class="table-resposive">
                <table border="0">
                  ...
                  <?php
                    ...
                    if ($idpoproduk == 153 or $idpoproduk == 239) {
                      $dp1 = intval($subtotal * 30/100);
                      $dp2 = intval($subtotal * 25/100);
                      $dp3 = intval($subtotal * 25/100);
                      $dp4 = intval($subtotal * 20/100);
                    }
                  ?>
                ...
                <hr />
                <table>
                  <?php if($data['status'] == "Sudah Confirm Payment 2" || $data['status'] == "Sudah Confirm Payment 3" || $data['status'] == "Sudah Confirm Payment 4" || $data['status'] == "Sudah Confirm Payment 5" ) : ?>
                    <tr class="text-decoration-line-through">
                      <th width="150">Payment 1</th>
                      <td width="20">:</td>
                      <td>
                        <?php if ($idpoproduk == 239) : ?>
                  ...
                  <tr>
                    ...
                    <td width="20">:</td>
                    <td>
                      <?php if ($idpoproduk == 239 and $total < 100000 ) : ?>
                ...
                <table>
                  ...
                  ?>
                    <tr>
                      <th width="150">Konfirmasi Payment</th>
                      <td width="20">:</td>
            ...
            <div class="col-sm-12 text-center">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Ubah QTY Variant</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <form method="post" enctype="multipart/form-data">
                        <div class="modal-body text-start">
                          <?php
                            $sql_qty = mysqli_query($koneksi, "SELECT
                                                    podetail.variant,
                                                    podetail.harga,
                                                    pomitra.jumlah,
                                                    pomitra.idpomitra
              ...
              <?php if ($payment < $subtotal) : ?>
                <div class="alert alert-danger text-center mt-3" role="alert">
                  <?php if ($datapengiriman['province_name'] == "") : ?>
                    <p style="margin-bottom: 0; font-size: .75rem">Silahkan Isi Alamat. <br /> Segera Lakukan Pembayaran Payment 1.</p>
                  <?php endif; ?>
                  ...
                  <div id="linkmiki">
                    ...
                    <?php else : ?>
                      <?php if ($datapo['status'] == "Belum DP") : ?>
                        <p class="mb-1">Silahkan Lakukan Payment 1 <br /> Rp. <?= number_format($dp1); ?></p>

                        <a href="popembayaran.php?invoice=<?= $invoice ?>&total=<?= $idpoproduk == 239 ? 100000 : $dp1 ?>&bayar=<?= $dp1 ?>&idpo=<?= $idpoproduk ?>&jenis=Payment 1" class="btn btn-primary btn-sm">Konfirmasi Pembayaran</a>
                      ...
                      <?php elseif($datapo['status'] == "Sudah Confirm Payment 2" || $payment < $subtotal) : ?>
                        <p class="mb-1">
                          Rp. <?= number_format($dp3) ?>
                          <br />
                          <b style="font-size: .75rem">Minimal Rp. <?= number_format(100000) ?></b>
                      ...
                      <?php elseif($datapo['status'] == "Sudah Confirm Payment 3" || $payment < $subtotal) : ?>
                        <p class="mb-1">
                          Rp. <?= number_format($dp4) ?>
                          <br />
                          <b style="font-size: .75rem">Minimal Rp. <?= number_format(100000) ?></b>

...
<div class="container">
    ...
    <p align="right"><input type="radio" onclick="javascript:window.location.href='store.php'; "> Mode Hemat  &nbsp&nbsp<input type="radio" onclick="javascript:window.location.href='store2.php'; " checked="checked"> Mode Cantik</p>
          ...
          <form method="get"><p align="left"><input type="text" name="namaproduk" placeholder="Masukan Nama Produk ..." /> <button class="btn btn-primary" name="cari" type="submit"><span class="glyphicon glyphicon-search"></span></button> <button class="btn btn-primary" name="tampil" type="submit">Tampil Semua</button></p></form>     
...
<div class="container">
          ...
          header("location:store.php?namaproduk='$namaproduk'");
          ...
          $namaproduk=$_GET['namaproduk'];
          $sql = mysqli_query($koneksi, "SELECT * from produk WHERE  harga>0 and namaproduk LIKE '%$namaproduk%' and idkategori=52 and stock>0 order by tgl desc, idproduk desc");
         ...
         // Include / load file koneksi.php
          ...
          // Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
          $sql = mysqli_query($koneksi, "SELECT * from produk WHERE  harga>0 and idkategori=52 and stock>0 order by tgl desc, idproduk desc LIMIT ".$limit_start.",".$limit);
          ...
          ?>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-6" style="margin-bottom: 2%;">
                    <!-- MODIF AWAL -->
                   <div class="card img" style="width:500px;object-fit: cover;height: 500px;border: 0px !important">
                    <?php if ($data['foto']<>""): ?>
                    <img class="card-img-top" src="foto/<?php echo $data['foto']; ?>" alt="Card image" style="width:100%;object-fit: cover;height: 50%">
                    <?php endif ?>
                    <?php if ($data['foto']==""): ?>
                      <img class="card-img-top" src="foto/nophoto.png" alt="Card image" style="width:100%">
                    <?php endif ?>
                    <div class="card-body">
  ...
  <?php endif ?>  
      ...
      <ul class="pagination">
        ...
        $sql2 = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM produk where  harga>0 and idkategori=52 ");

                    ...
                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                ...
                                                <?php 
                                                        ...
                                                        if ($databukapo['jenis_po'] === 'PO Custom Stok') {
                                                            if ($idpoproduk == 506) {
                                                                $harga = (int)$data_produk['harga'] * (int)$pack * 3 - (15000 * $pack);
                                                            }
                                                        } else {
                                            ...
                                            <?php if ($today > $selesai) : ?>
                                            <?php elseif ($today <= $selesai) : ?>
                                                <td><a href="editpobundling.php?id=<?= $idpoproduk ?>&invoice=<?= $invoice ?>&bundling=<?= $string ?>" class="btn btn-success btn-sm"><i class="bi bi-pencil-square"></i></a></td>
                                            <?php endif; ?>
                                        </tr>
                                    </tbody>
                                <?php
                        ...
                        <div class="col-sm-12 text-center my-2">
                            <?php if ($datapo['status'] === "Belum DP") : ?>
                                <a href="popembayaran.php?invoice=<?= $invoice ?>&total=<?= $idpoproduk == 259 ? 100000 : $dp1 ?>&bayar=<?= $subtotal ?>&idpo=<?= $idpoproduk ?>&jenis=Payment1" class="btn btn-primary btn-sm">Konfirmasi Pembayaran</a>
                                <?php if ($today > $selesai) : ?>

                                <?php elseif ($today <= $selesai) : ?>
                                    <?php if ($databukapo['jenis_po'] == 'PO Bundling 5') : ?>
                                        <a href="ubahpobundling5.php?id=<?= $idpoproduk ?>&invoice=<?= $invoice ?>" class="btn btn-warning btn-sm">Ubah PO</a>
                                    <?php else: ?>
                                        <a href="ubahpobundling2.php?id=<?= $idpoproduk ?>&invoice=<?= $invoice ?>" class="btn btn-warning btn-sm">Ubah PO</a>
                                    <?php endif; ?>
                                <?php endif; ?>
                            <?php elseif ($datapo['status'] === "Sudah Confirm Payment 1") : ?>
                                <a href="popembayaran.php?invoice=<?= $invoice ?>&total=<?= $idpoproduk == 259 ? 100000 : $dp1 ?>&bayar=<?= $subtotal ?>&idpo=<?= $idpoproduk ?>&jenis=Payment2" class="btn btn-primary btn-sm">Konfirmasi Pembayaran</a>
                            <?php endif; ?>
                            <a class="btn btn-success btn-sm" href="invoice-bundling2.php?idmitra=<?= $idadmin; ?>&id=<?= $idpoproduk ?>&invoice=<?= $invoice ?>">Download PDF</a>
                        </div>
                    </div>

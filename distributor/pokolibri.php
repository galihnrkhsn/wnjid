...
<!--================ CONTAINER =================-->
  ...
  <div class="container"> 
    ...
    <form method="POST">
      ...
      <div class="form-group">
        <label>Telepon Penerima / Keluarga</label>
      ...
      $invoice=$huruf.$idadmin.'-'.$nobaru;
        ...
        $sql = $koneksi->query("INSERT into podropship (iddropship,
         ...
         if ($sql) {
            ...
            echo "<script>location='formpo_kolibri?invoice=$invoice&idadmin=$idadmin';</script>";
         }else{
            echo "<script>alert('data gagal dikirim');</script>";
            echo "<script>location='pokolibri?id=$idpoproduk&idadmin=$idadmin';</script>";
         }

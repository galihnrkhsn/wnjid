...
<!--================ NAVBARU END =================-->
 ...
 <form method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
          <label>Nama</label>
    <input class="form-control" name="nama" value="<?php echo $_SESSION['admin_mitra']['namamitra']; ?>" required>
    </div>
    ...
    <textarea class="form-control" name="targetkota" required></textarea>
    </div>
...
$whatsapp=addslashes(htmlspecialchars($_POST['whatsapp']));
$targetkota=addslashes(htmlspecialchars($_POST['targetkota']));
$program=$_POST['program'];
    
  $query = "INSERT INTO adsmitra (idads,idmitra,tgl,nama,whatsapp,targetkota,program,status) VALUES (null,'$idmitra',NOW(),'$nama','$whatsapp','$targetkota','$program','Belum Transfer')";    
  ...
  if($sql){ // Cek jika proses simpan ke database sukses atau tidak
    ...
    echo "Maaf, Terjadi kesalahan saat mencoba untuk menyimpan data ke database.";
		echo "<script>location='inputads.php';</script>";
  }
}  
?>  

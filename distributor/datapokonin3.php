...
<body>
  ...
  <div class="row fixed-top navbaru py-2">
    <div class="col-2">
      <a href="detailkonin.php?id=<?= $idpoproduk; ?>">
        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
            ...
            <div class="col-sm-12 text-center">
              ...
              <?php
                if(isset($_POST["simpan_qty"])) {
                  ...
                  if ($sql) {
                    ...
                    echo "<script>location='datapokonin3?invoice=$invoice';</script>";
                  }else{
              ...
              <?php if ($datapo['status'] == "Belum DP" or $datapo['status'] == "Sudah Confirm Payment 1" or $datapo['status'] == "Sudah Confirm Payment 2" or $datapo['status'] == "Sudah Confirm Payment 3" or $datapo['status'] == "Sudah Confirm Payment 4") : ?>

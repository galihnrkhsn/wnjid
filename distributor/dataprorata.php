...
<input type="text" name="namaproduk">  <button type="submit" class="btn btn-primary" name="cari">Cari</button>  <button type="submit" class="btn btn-primary" name="tampil">Tampil Semua</button></form></pre>-->  
		...
		//	}else 
	if($idpoproduk==29) {
		echo "<p align='right'><a class='btn btn-info' href='formdropship.php?idadmin=$idadmin&idpo=$idpoproduk&invoice=$data2[invoice]' id='linkdropshipp'>Dropship</a>  <p align='right' id='demodropshipp'></p> </p>";
		}
			?>
					...
					?>
				       ...
				       if($idpoproduk==24) {
				          echo "<a class='btn btn-primary' href='popembayaran.php?invoice=$invoice&total=$dp'>Konfirmasi DP</a>";
				            ...
				            else if($idpoproduk==40) {
				         echo "<a class='btn btn-success' href='ubahpostok.php?id=$idpoproduk' id='linkme'>Ubah</a>  <p id='demome'></p>";
				         }
				           else if($idpoproduk==48) {
				          echo "<a class='btn btn-success' href='ubahprorata.php?id=$idpoproduk' id='linkle'>Ubah</a>  <p id='demole'></p>";
				          
				          
				          }
				        else {
				          echo "<center>Fix</center>";
				        }
...
var countDownDateme = new Date("Apr 19, 2021 17:00:00").getTime();
...
<script>
// Mengatur waktu akhir perhitungan mundur
var countDownDatele = new Date("May 27, 2021 23:59:00").getTime();
...
<script>
// Mengatur waktu akhir perhitungan mundur
var countDownDatedropp = new Date("Feb 07, 2021 23:59:00").getTime();

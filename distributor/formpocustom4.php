                        ...
                        <?php if ($idadmin == 10) : ?>
                            <div class="col-sm-12">
                                <div class="form-group my-1">
                                    ...
                                    <?php
                                        $query = $koneksi->query("SELECT * FROM admin_mitra ORDER BY namamitra ASC");
                                        while ($data = $query->fetch_assoc()) {
                                    ?>
                                        <option value="<?= $data['idadmin'] ?>"><?= $data['namamitra'] ?> (<?= $data['idadmin'] ?>)</option>
                                    <?php } ?>
                                    </select>
                                </div>
                            </div>
            ...
            try {
                ...
                if (isset($_GET['invoice'])) {
                    ...
                    if ($jenis_po === "Set") {
                        ...
                        $invoice = 'D' . $idpoproduk . '-' . $iddb . $angka_acak;
                    } else {
                        $invoice = 'D' . $idpoproduk . '-' . $iddb;
                    }
                }
                ...
                $query_check = $koneksi->query("SELECT COUNT(*) AS jumlah_invoice FROM pomitra WHERE invoice = '$invoice' AND idmitra = '$iddb'");
                        ...
                        if ($total_item % 3 == 0) {
                            ...
                            echo "
                                <script>
                                    ...
                                    location='formpocustom4.php?id=$idpoproduk&jenis=$jenis_po';
                                </script>
                            ";
                            break;
                        }
                        ...
                        if ($check['jumlah_invoice'] < 1) {
                            ...
                            echo "
                                <script>
                                    ...
                                    location='formpocustom4.php?id=$idpoproduk&invoice=$invoice&jenis=$jenis_po';
                                </script>
                            ";
                        }
                    }

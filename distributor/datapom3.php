              ...
              <?php if ($payment < $subtotal) : ?>
                <div class="alert alert-danger text-center mt-3" role="alert">
                  <?php if ($datapengiriman['province_name'] == "") : ?>
                    <p style="margin-bottom: .5rem; font-size: .75rem">Segera Lakukan Pembayaran</p>
                  <?php endif; ?>
                  ...
                  <div id="linkmiki">
                      <?php if ($datapo['status'] == "Belum DP") : ?>
                        ...
                        <?php if($idpoproduk == '285') : ?>
                            <a class="btn btn-sm btn-success" href="ubahpostok.php?id=<?= $idpoproduk;?>&invoice=<?= $invoice;?>">Ubah Qty</a>
                        <?php else : ?>
                            <a class="btn btn-sm btn-success" href="ubahpo.php?id=<?= $idpoproduk;?>&invoice=<?= $invoice;?>">Ubah Qty</a>
                        <?php endif; ?>

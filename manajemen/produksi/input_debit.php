...
<body>
    ...
    <div class="container mt-4">
        ...
        <h4><i class="fa fa-minus"></i> Debit</h4>
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" min="0" class="form-control" id="debit" name="debit" placeholder="Masukkan Total Debit" required/>
            </div>
            <div class="form-group">
        ...
        if (isset($_POST["kirimdebit"])) {
            ...
            if (move_uploaded_file($tmp, '../../image/bukti_transfer' . $namaFileBaru)) {
                $insert = $koneksi->query("INSERT INTO rekeningkoran 
                                            ...
                                            VALUES 
                                                (null, '$iduser', '$tanggal', '$waktu', '$keterangan', '0', 
                                                '$debit', '$sisa', '$namaFileBaru', '$tipe', '$kategori')");
                ...
                if ($kategori == "7") {
                    $pindah = $koneksi->query("INSERT INTO rekeningkoran 
                                                    (idrk, iduser, tanggal, waktu, keterangan, kredit, debit, 
                                                        sisasaldo, buktitf, tipe, kategori_id)   
                                                VALUES 
                                                    (NULL, '$iduser', '$tanggal', '$waktu', '$keterangan', '$debit', 

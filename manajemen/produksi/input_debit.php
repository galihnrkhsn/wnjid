...
<body>
    ...
    <div class="container mt-4">
        ...
        <p class="statusMsg"></p>
        <form method="POST" enctype="multipart/form-data" id="formDebit">
            ...
            <div class="form-group">
                ...
                <input type="number" min="0" class="form-control" id="debit" name="jumlah" placeholder="Masukkan Total Debit" required/>
            </div>
            <div class="form-group">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const form = document.getElementById('formDebit');

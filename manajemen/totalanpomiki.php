...
header("Content-Disposition: attachment; filename=Data Total PO Miki Custom.xls");
?>
            ...
            ?>
                      <tr>
                       ...
                       <!--  <td>
                        ...
                        <td>
                            <?php if ($tampilkan2['namakategori']=='Cream' or $tampilkan2['namakategori']=='Silver' 
                              or $tampilkan2['namakategori']=='White' or $tampilkan2['namakategori']=='Grey') {
                              echo "Black"; 
                              } else {
                              echo "Gold";  
                              } 

                                ...
                                <div class="collapse" id="collapseCardExample">
                                    <div class="card-body">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                              ...
                                              <div class="h6 mb-0 font-weight-bold text-gray-800">Rp <?= number_format($datap['sisa']); ?></div>
                                            </div>
<hr>
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                              ...
                                              <div class="h6 mb-0 font-weight-bold text-gray-800">Rp <?= number_format($dataaf['sisa']); ?></div>
                                            </div>
<hr>                                            
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                              ...
                                              <div class="h6 mb-0 font-weight-bold text-gray-800">Rp <?= number_format($datam['sisa']); ?></div>
                                            </div>
                                    </div>
                                </div>
                                </div>
  ...
  transform: translate(-50%, -50%);
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Header - Accordion -->
                                <a href="#collapsePenjualan" class="d-block card-header py-3" data-toggle="collapse"
                                    role="button" aria-expanded="true" aria-controls="collapsePenjualan" style="margin-top: -2%;">
...
// echo $sekarang;
            $data_harian=$koneksi->query("SELECT surat_jalan.invoice,
                                            ...
                                            AND SUBSTRING(surat_jalan.waktu, 1, 10) LIKE '%$sekarang%'
...
$totalsemua += $totalnya;   
            ...
            $datapo_harian=$koneksi->query("SELECT surat_jalan_po.invoice,
                      ...
                      SUM(surat_jalan_po.progres) as jumlah,
                                            ...
                                            AND SUBSTRING(surat_jalan_po.waktu, 1, 10) LIKE '%$sekarang%'
...
// ====================================================================================KEMARIN====================================================================================
 $data_harian_1=$koneksi->query("SELECT surat_jalan.invoice,
                                            ...
                                            FROM surat_jalan
                                            WHERE surat_jalan.status <> 'Ambil Barang' 
                                            AND SUBSTRING(surat_jalan.waktu, 1, 10) LIKE '%$kemarin%'
                                            GROUP BY surat_jalan.no_sj
                                            ORDER BY surat_jalan.waktu DESC, surat_jalan.invoice");
...
$totalsemua_1 += $totalnya_1;   
            ...
            $datapo_harian_1=$koneksi->query("SELECT surat_jalan_po.invoice,
                      ...
                      SUM(surat_jalan_po.progres) as jumlah,
                                            ...
                                            WHERE surat_jalan_po.status <> 'Ambil Barang' 
                                            AND SUBSTRING(surat_jalan_po.waktu, 1, 10) LIKE '%$kemarin%'
                                            GROUP BY surat_jalan_po.no_sj
                                            ");
...
$totalpo_semua_1 += $totalpo_nya_1;             
            ...
            $data_harian_manual_1=$koneksi->query("SELECT surat_jalan_manual.invoice,
                                            ...
                                            FROM surat_jalan_manual
                                            WHERE surat_jalan_manual.status = 'INV' 
                                            AND SUBSTRING(surat_jalan_manual.waktu, 1, 10) LIKE '%$kemarin%'
                                            GROUP BY surat_jalan_manual.no_sj
                                            ORDER BY surat_jalan_manual.waktu DESC, surat_jalan_manual.invoice");
...
// ====================================================================================KEMARIN LUSA====================================================================================
            $data_harian_2=$koneksi->query("SELECT surat_jalan.invoice,
                                            ...
                                            FROM surat_jalan
                                            WHERE surat_jalan.status <> 'Ambil Barang' 
                                            AND SUBSTRING(surat_jalan.waktu, 1, 10) LIKE '%$kemarin_lusa%'
                                            GROUP BY surat_jalan.no_sj
                                            ORDER BY surat_jalan.waktu DESC, surat_jalan.invoice");
...
$totalsemua_2 += $totalnya_2;   
            ...
            $datapo_harian_2=$koneksi->query("SELECT surat_jalan_po.invoice,
                      ...
                      SUM(surat_jalan_po.progres) as jumlah,
                                            ...
                                            WHERE surat_jalan_po.status <> 'Ambil Barang' 
                                            AND SUBSTRING(surat_jalan_po.waktu, 1, 10) LIKE '%$kemarin_lusa%'
                                            GROUP BY surat_jalan_po.no_sj
                                            ");
...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true" data-interval="false">
  ...
  <div class="centered"><strong>Penjualan Hari ini (<?= $tanggal_sekarang; ?>) <br> Rp <?= number_format($total_harian = $totalsemua + $totalpo_semua + $totalsemua_manual + $totalsemua_manual_po); ?></strong></div>       
        
    </div>
    <div class="carousel-item">
  <img src="img/bg-white.png" class="d-block w-100" style="width:100%;height: 100px">

  <div class="centered"><strong>Penjualan Kemarin (<?= $day_before; ?>) <br> Rp <?= number_format($total_harian_1 = $totalsemua_1 + $totalpo_semua_1 + $totalsemua_manual_1 + $totalsemua_manual_po1); ?></strong></div> 
    </div>
    <div class="carousel-item">
  <img src="img/bg-white.png" class="d-block w-100" style="width:100%;height: 100px">

  <div class="centered"><strong>Penjualan Kemarin Lusa (<?= $day_lusa; ?>) <br> Rp <?= number_format($total_harian_2 = $totalsemua_2 + $totalpo_semua_2 + $totalsemua_manual_2 + $totalsemua_manual_po2); ?></strong></div> 
    </div>
  </div>
...
<?php if ($tipe=="O"): ?>  
 <?php  
$ambil_stock=$koneksi->query("SELECT stock, harga from produk WHERE stock>0 and harga>0 and idkategori>0 and status=0 ORDER BY idproduk DESC"); 
...
<br>                                            
                                            ...
                                            <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">
                                              <a href="inventorystok.php">
                                                Inventory Stock
                                              </a>
                                           
                                              <div class="h6 mb-0 font-weight-bold text-gray-800">Rp <?= number_format($total_inventory); ?></div>
                                            </div>
<hr>
                                            <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">
                                              <a href="cashbank.php">
                                              ...
                                              <div class="h8 mb-0 font-weight-bold" style="color: #8a8a8a"><?= $tampil_cash["waktu"]; ?></div>
                                              <div class="h6 mb-0 font-weight-bold text-gray-800">Rp <?= number_format($tampil_cash["total"]); ?></div>
                                            </div>  
<hr>
                                            <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">
                                              <a href="aset.php">
                                              ...
                                              <div class="h6 mb-0 font-weight-bold text-gray-800">Rp <?= number_format($tampil_aset["total"]); ?></div>
                                            </div>                                                                                        
...
<hr>                                            
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                              <a href="finance.php?tipe=PM">
                                                Kas Pemotretan
                                              </a>
                                              <div class="h6 mb-0 font-weight-bold text-gray-800">Rp <?= number_format($datapm['sisa']); ?></div>
                                            </div>                                            
                                    </div>
                                </div>
                              </div>
  ...
  <table class="table" id="tb_po">
                      ...
                      <tbody>
                        ...
                        <td>
                          ...
                          <td>
                            <?php if ($tampilkan['idpoproduk']=='159'): ?>
                                3823
                                <?php else: ?>
                          ...
                          <td class="align-middle" style="text-align: center;">
                            <?php if ($tampilkan['status']=='open'): ?>
                              ...
                              </div> <p align='center' id='demo<?php echo $tampilkan['idpoproduk']; ?>'></p>
                            <?php else: ?>
                                <div class="badge bg-light rounded-pill" style='color:red'><?php echo strtoupper($tampilkan['status']); ?></div> 
                            <?php endif ?>   
                 <script>

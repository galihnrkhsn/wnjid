            ...
            <!-- OWNER -->
                            ...
                            <div class="collapse" id="collapseCardExample">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        <a href="finance.php?tipe=O">Kas Owner</a>
                                        <div class="h6 mb-0 font-weight-bold text-gray-800">
                                            Rp. <?= number_format($dataO) ?>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                    ...
                    <div class="card shadow-sm border-left-success mb-4">
                        ...
                        <div class="collapse" id="collapseCardPemasukan">
                            <div class="card-body pt-3">
                                <div class="mb-3">
                                    <a href="pemasukan.php" class="text-success font-weight-bold text-uppercase small">Lihat Detail Pemasukan</a>
                                </div>
                                <?php
                                    $getHarian = $koneksi->query("SELECT 
                                                                    CASE 
                                                                        WHEN tanggal = CURDATE() THEN 'Hari Ini'
                                                                        WHEN tanggal = DATE_SUB(CURDATE(), INTERVAL 1 DAY) THEN 'Kemarin'
                                                                        WHEN tanggal = DATE_SUB(CURDATE(), INTERVAL 2 DAY) THEN '2 Hari Kemarin'
                                                                    END AS kategori,
                                                                        SUM(nominal) AS total_jumlah
                                                                    FROM catatan
                                                                    WHERE tanggal BETWEEN DATE_SUB(CURDATE(), INTERVAL 2 DAY) AND CURDATE()
                                                                    GROUP BY kategori
                                    ...
                                    while ($dataHarian = $getHarian->fetch_assoc()) {
                                        $kategori   = $dataHarian['kategori'];
                                        $total      = $dataHarian['total_jumlah'];
                                        
                                        if ($kategori == 'Hari Ini') {
                                            $totalHariIni = $total;
                                        } elseif ($kategori == 'Kemarin') {
                                            $totalKemarin = $total;
                                        } elseif ($kategori == '2 Hari Kemarin') {
                                            $totalDuaHariLalu = $total;
                                        }
                                    }
                                ?>
                                    ...
                                    <div class="carousel-inner text-center text-dark">
                                        <div class="carousel-item active">
                                            <div class="p-3 bg-white rounded shadow-sm">
                                                <strong>Pemasukan Hari Ini (<?= $dateNow; ?>)</strong><br>
                                                <span class="h5 text-success">Rp <?= number_format($totalHariIni); ?></span>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="p-3 bg-white rounded shadow-sm">
                                                <strong>Pemasukan Kemarin (<?= $dayKemarin; ?>)</strong><br>
                                                <span class="h5 text-success">Rp <?= number_format($totalKemarin); ?></span>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="p-3 bg-white rounded shadow-sm">
                                                <strong>Pemasukan Kemarin Lusa (<?= $dayLusa; ?>)</strong><br>
                                                <span class="h5 text-success">Rp <?= number_format($totalDuaHariLalu); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <?php 
                                        $getHarian = $koneksi->query("SELECT 
                                                                        ...
                                                                        GROUP BY 
                                                                            surat_jalan.no_sj
                                                                        ORDER BY 
                                                                            surat_jalan.waktu DESC;
                                                                    ");
                                            while($queryHarian  = $getHarian->fetch_assoc()){
                                                $no_sj          = $queryHarian['no_sj'];
                                                $totala         = 0;
                                                $getHarga       = $koneksi->query("SELECT variants.harga, surat_jalan.progres 
                                                                                    FROM surat_jalan 
                                                                                    INNER JOIN variants ON variants.id = surat_jalan.idproduk 
                                        ...
                                        $getharianManual=$koneksi->query("SELECT 
                                            ...
                                            while($queryHarianManual    = $getharianManual->fetch_assoc()) {
                                                ...
                                                $totala_manual          = 0;
                                                $getManual              = $koneksi->query("SELECT variants.harga, surat_jalan_manual.progres 
                                                                                            FROM surat_jalan_manual 
                                                                                            INNER JOIN variants ON variants.id = surat_jalan_manual.idproduk 
                                        ...
                                        $getManualPo    = $koneksi->query("SELECT 
                                                                        ...
                                                                        WHERE 
                                                                            ...
                                                                            AND SUBSTRING(surat_jalan_manual.waktu, 1, 10) LIKE '%$dateNow%'
                                                                        GROUP BY 
                ...
                <!-- PIUTANG -->
                    <div class="card shadow mb-4">
                        <div class="card border-left-success shadow h-100" >                              
                            <!-- Card Header - Accordion -->
                            <a href="#collapseCardExample1" class="d-block card-header py-3" 
                                role="button" aria-expanded="true" aria-controls="collapseCardExample1" style="margin-top: -2%;">
                                <h5 class="m-0 font-weight-bold text-dark">Piutang</h5>
                            </a>
                            <!-- Card Content - Collapse -->
                            <div id="collapseCardExample1">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                        <a href="manajemen/bill.php">Piutang</a>
                                        <div class="h6 mb-0 font-weight-bold text-gray-800">
                                        </div>
                                    </div>
                                </div>
                ...
                <!-- REKAP -->
                    <div class="card shadow mb-4">
                        <div class="card border-left-success shadow h-100" >                              
                            ...
                            <a href="#collapseCardExample1" class="d-block card-header py-3" 
                                role="button" aria-expanded="true" aria-controls="collapseCardExample1" style="margin-top: -2%;">
                                <h5 class="m-0 font-weight-bold text-dark">Rekap</h5>
                            </a>
                            <!-- Card Content - Collapse -->
                            <div id="collapseCardExample1">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                        <a href="https://docs.google.com/spreadsheets/d/e/2PACX-1vQPu8hHtdwcdzfdJrbVgpGxeroyIs1AmaFHNrHaDzQnZr3pQNeEVovxuf_U4YDwJDLiT1wbRzkWMkss/pubhtml#" target="_BLANK">Rekap</a>
                                        <div class="h6 mb-0 font-weight-bold text-gray-800">
                                        </div>
                                    </div>
                                </div>
                ...
                <!-- ASET -->
                    <?php
                        $ambil_stock = $koneksi->query("SELECT variants.stock, variants.harga FROM variants
                        ...
                        <div class="card border-left-success shadow h-100" >                              
                            ...
                            <div id="collapseCardExample">
                                <div class="card-body">
                                    ...
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                        <a href="finance.php?tipe=MF">Mutasi Finance</a>
                                        <div class="h6 mb-0 font-weight-bold text-gray-800">
                                        </div>
                                    </div>
            ...
            <!-- PRODUKSI -->
                                        ...
                                        <tbody>
                                                <?php  
                                                    ...
                                                    while ($tampil = $ambil->fetch_assoc()) {
                                                        ...
                                                        $data_masuk = $query_ambil->fetch_assoc();
                                                        $barang_masuk = $data_masuk['total_masuk'] ?? 0; // Jika null, default ke 0
                                                        
                                                        $query_kekurangan = $tampil['jumlahnya'] - $barang_masuk; // Hitung kekurangan
                                                        $persentase = $barang_masuk / $tampil['jumlahnya'] * 100; // Hitung persentase
                                                ?>  
                                                <tr>
                                                <td class="d-none"><?= $no++; ?></td>
                                                    <td>
                                                        <a href="produksi/preorder?id=<?= $idpoproduk; ?>" class="text-decoration-none text-danger"><?= $tampil['namapo']; ?></a>
                                                        <div class="progress bg-white mt-2" role="progressbar" aria-valuenow="<?= $barang_masuk ?>" aria-valuemin="0" aria-valuemax="<?= $tampil['jumlahnya'] ?>">
                                                            <div class="progress-bar bg-primary" style="width: <?= $persentase ?>%"><?= round($persentase) ?>%</div>
                                                        </div>
                                                        <div class="d-flex justify-content-between align-items-center mt-2">
                                                            <p class="mb-0"><?= $barang_masuk ?></p>
                                                            <p class="mb-0">-<?= $query_kekurangan ?></p>
                                                            <p class="mb-0"><?= $tampil['jumlahnya'] ?></p>
                                                        </div>
                                                        <hr>
                                                        <div>
                                                            <span id="dots<?= $tampil['idpoproduk']; ?>"></span>
                                                            <span id="more<?= $tampil['idpoproduk']; ?>" style="display:none;">
                                                                <?php 
                                                                $vendor = $koneksi->query("SELECT vendor.vendor, sjk.vendor AS idvendor FROM sjk INNER JOIN vendor ON vendor.id = sjk.vendor WHERE sjk.idpoproduk = '$idpoproduk' GROUP BY sjk.vendor"); 
                                                                if (!$vendor) {
                                                                    die("Query Error: " . $koneksi->error);
                                                                }
                                                                while($data_vendor = $vendor->fetch_assoc()) { ?>
                                                                    <a href="vendor.php?id=<?= $idpoproduk;?>&vendor=<?= $data_vendor['idvendor']; ?>" class="d-block custom-text-color2" ><?= $data_vendor['vendor']; ?></a>
                                                                <?php } ?>
                                                            </span>
                                                            <div class="d-flex justify-content-between align-items-center mt-2">
                                                                <button onclick="toggleDetails('<?= $tampil['idpoproduk']; ?>')" id="myBtn<?= $tampil['idpoproduk']; ?>" class="btn btn-success btn-outline-secondary btn-sm">
                                                                    <i class='fa fa-eye text-dark'></i>
                                                                </button>
                                                                <a href="input_sjv?id=<?= $idpoproduk; ?>" class="btn btn-success btn-outline-secondary btn-sm text-dark">Tambah SJV</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                ...
                <!-- END SJV -->
                 ...
                 <div class="card shadow mb-4">
                        <div class="card border-left-success shadow h-100" >                              
                            <!-- Card Header - Accordion -->
                            <a href="finance.php?tipe=P" class="d-block card-header py-3" 
                                role="button" aria-expanded="true" aria-controls="collapseCardExample" style="margin-top: -2%;">
                                <h5 class="m-0 font-weight-bold text-dark">Finance</h5>
                            </a>
                            <!-- Card Content - Collapse -->
            ...
            <!-- GUDANG -->
                ...
                <div class="card shadow mb-4">
                    <div class="card shadow h-100">
                        ...
                        <div class="collapse" id="collapseCardProgres">
                            <!-- <div class="mb-3">
                                <input type="text" id="searchInput" class="form-control" placeholder="Cari Nama PO..." onkeyup="searchTable()">
                            </div>
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="tb_gudang">
                                    <thead>
                                        <tr>
                                            <th class="d-none">No</th>
                                        </tr>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="tb_gudang">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="produksi/preorder?id=<?= $idpoproduk; ?>" class="text-decoration-none text-danger namapo"><?= $tampil['namapo']; ?></a>
                                                <div class="progress bg-white mt-2" role="progressbar" aria-valuenow="<?= $barang_masuk ?>" aria-valuemin="0" aria-valuemax="<?= $tampil['jumlahnya'] ?>">
                                                    <div class="progress-bar bg-primary" style="width: <?= $persentase ?>%"><?= round($persentase) ?>%</div>
                                                </div>
                                                <div class="d-flex justify-content-between align-items-center mt-2">
                            ...
                            <script>
                                function searchTable() {
                                    ...
                                    let rows = document.querySelectorAll("#tb_gudang tbody tr");

                                    rows.forEach(row => {
                                        let namapo = row.querySelector(".namapo").textContent.toLowerCase();
                                        if (namapo.includes(input)) {
                                            row.style.display = "";
                                        } else {

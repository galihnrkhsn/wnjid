...
<table id="myJudul" class="w3-table-all w3-centered">
  ...
  <div class="panel panel-default">
    	...
    	<p align="right"><input type="radio" onclick="javascript:window.location.href='formpengirimandb.phpid=<?php echo $invoice; ?>&berat=<?php echo $berat; ?>'; " checked="checked"> Dropship  <input type="radio" onclick="javascript:window.location.href='formpengirimandb2.php?id=<?php echo $invoice; ?>&berat=<?php echo $berat; ?>'; "> Kirim Ke Alamat Pribadi</p>

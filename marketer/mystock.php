	     ...
	     <form method="post"><input type="text" name="namaproduk">  <button type="submit" class="btn btn-primary btn-xs" name="cari">Cari</button> <button type="submit" class="btn btn-primary btn-xs" name="tampil">Tampil Semua</button></form><br>
		      <!--  <a class="btn btn-default" href="tambahproduk.php">Tambah Produk</a> <a class="btn btn-default" href="requestproduk.php">Request Produk</a> -->
                ...
                <thead>
					...
					$sql = mysqli_query($koneksi, "SELECT DISTINCT stockmitra.idstockmitra,produk.idproduk,produk.namaproduk,stockmitra.stock FROM stockmitra inner join produk inner join mitrareseller
					ON stockmitra.idproduk=produk.idproduk and stockmitra.idadmin=mitrareseller.idadmin WHERE mitrareseller.idadmin='$idadmin' and produk.namaproduk LIKE '%$namaproduk%' ");
					...
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT DISTINCT stockmitra.idstockmitra,produk.idproduk,produk.namaproduk,stockmitra.stock FROM stockmitra inner join produk inner join mitrareseller
					ON stockmitra.idproduk=produk.idproduk and stockmitra.idadmin=mitrareseller.idadmin WHERE mitrareseller.idadmin='$idadmin' LIMIT ".$limit_start.",".$limit);

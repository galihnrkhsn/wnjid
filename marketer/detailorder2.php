  ...
  <div class="container mt-2">
    ...
    <?php
        ...
        $sql    = "SELECT * FROM ordermarketer 
                    INNER JOIN variants ON variants.id = ordermarketer.idproduk
                    INNER JOIN products ON variants.idproducts = products.id 
                    WHERE ordermarketer.invoice = '$invoice' AND ordermarketer.jumlah > 0 AND products.idkategori = 2";
        $query  = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM ordermarketer 
                        INNER JOIN variants ON variants.id = ordermarketer.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE ordermarketer.invoice = '$invoice' AND ordermarketer.jumlah > 0 AND products.idkategori = 5";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM ordermarketer 
                        INNER JOIN variants ON variants.id = ordermarketer.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE ordermarketer.invoice = '$invoice' AND ordermarketer.jumlah > 0 AND products.idkategori = 10";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM ordermarketer 
                        INNER JOIN variants ON variants.id = ordermarketer.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE ordermarketer.invoice = '$invoice' AND ordermarketer.jumlah > 0 AND products.idkategori = 15";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM ordermarketer 
                        INNER JOIN variants ON variants.id = ordermarketer.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE ordermarketer.invoice = '$invoice' AND ordermarketer.jumlah > 0 AND products.idkategori = 17";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM ordermarketer 
                        INNER JOIN variants ON variants.id = ordermarketer.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE ordermarketer.invoice = '$invoice' AND ordermarketer.jumlah > 0 AND products.idkategori = 20";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM ordermarketer 
                        INNER JOIN variants ON variants.id = ordermarketer.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE ordermarketer.invoice = '$invoice' AND ordermarketer.jumlah > 0 AND products.idkategori = 25";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql    = "SELECT MAX(variants.harga) AS subtotal 
                    ...
                    INNER JOIN variants ON variants.id = ordermarketer.idproduk
                    INNER JOIN products ON variants.idproducts = products.id 
                    WHERE ordermarketer.invoice = '$invoice' AND ordermarketer.jumlah > 0 AND products.idkategori = 52";
        $query  = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql        = "SELECT * FROM ordermarketer 
                        INNER JOIN variants ON variants.id = ordermarketer.idproduk
                        INNER JOIN products ON variants.idproducts = products.id 
                        WHERE ordermarketer.invoice = '$invoice' AND ordermarketer.jumlah > 0 AND products.idkategori = 51";
        $query      = $koneksi->query($sql);
    ...
    <?php
        ...
        $sql = "SELECT * FROM ordermarketer 
                    INNER JOIN variants ON variants.id = ordermarketer.idproduk
                    INNER JOIN products ON variants.idproducts = products.id  
                    WHERE ordermarketer.invoice = '$invoice' AND ordermarketer.jumlah > 0 AND products.idkategori BETWEEN 52 AND 80";
        $query = $koneksi->query($sql);
    ...
    <?php
        ...
        $p              = 0;
        $dummy          = "SELECT MAX(variants.harga) as harga FROM ordermarketer 
                            INNER JOIN variants ON variants.id = ordermarketer.idproduk
        ...
        if($ongkir == 0){
            if($kurir == 'Ahsan' or $kurir == 'Gosend' or $kurir == 'Ambil ke Pusat' or $kurir == 'Disatukan') {
                $ceksql = "SELECT * FROM ordermarketer 
                            INNER JOIN variants ON variants.id = ordermarketer.idproduk
                            INNER JOIN products ON variants.idproducts = products.id 
                            WHERE ordermarketer.invoice = '$invoice' AND ordermarketer.jumlah > 0 AND products.idkategori = 52";
                ...
                echo "Diskon subDB 10% : Rp. -$tdiskona<br>";
                if (isset($disc) && $disc > 0) {
                    echo "Diskon Tambahan $disc% : Rp. -$tdTambahan";
                }
                if ($jenis == 'Flash') {
                    echo "Diskon Tambahan 20% : Rp. -$flashSale<br>";
                }
                if($diskonb>0){
        ...
        //     }
        //     echo "Estimasi Ongkir : Rp. $tongkir<br>";
        //     echo "Diskon subDB 10% : Rp. -$tdiskon52<br>";

...
<body>
    ...
    <div class="container mt-5 justify-content-center">
        ...
        <p align="center"><strong><?= $data['namapo']; ?></strong></p><br>
        <p align="left">Nama Mitra  : <?= $queryUser["namaagen"]; ?></p>
        <p align="left">Alamat  : <?= $queryUser["alamat"]; ?> </p>
        <p align="left">No Invoice  : <?= $invoice; ?></p>
                ...
                foreach ($_POST['hiddenProductInput'] as $key => $index) {
                    ...
                    if ($jumlah > 0) {
                        ...
                        if ($pokategori['stok'] >= $jumlah) {
                            ...
                            (null, '$idmitramarketer', '$idpoproduk', '{$podetail['idpo']}', '$variant', '$jumlah', '$total', '$invoice', 'Belum DP', NOW(), '$waktu')");
                            if (!$insertPomitra) {

<?php
  ...
  $query = "SELECT COUNT(*) AS jumlah,
            ...
            AND pomitra.idmitramarketer = '$idadmin'
...
<head>
  ...
  <title>WNJ | Mitra <?= $_SESSION['mitramarketer']['namamitra']; ?></title>
          ...
          <div class="card card-body">
            ...
            <?php else : ?>
              <div class="col-sm-12">
                ...
                <a href="datapom2.php?idmitramarketer=<?= $idadmin; ?>&id=<?= $id; ?>&invoice=<?= $invoice; ?>" class="btn btn-sm btn-success">Invoice</a>
              </div>
            <?php endif; ?>
          </div>
        </div>

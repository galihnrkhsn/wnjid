		...
		<div class="tab-content">
			<div id="home" class="tab-pane fade in active">
				...
				<p>		<?php
					...
					$idmitra=$_SESSION['mitraagen']['idmitramarketer'];
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT DISTINCT * FROM `orderagendb` inner join mitramarketer on mitramarketer.idmitramarketer=orderagendb.idmitramarketer where orderagendb.idmitramarketer='$idmitra' and orderagendb.payment='Belum Bayar' GROUP BY invoice ORDER BY idorderdb DESC limit 20 ");
			...
			<div id="menu1" class="tab-pane fade">
				...
				<p>		<?php
					...
					if(isset($_POST["cari"])){
    					...
    					$limit_start = ($page - 1) * $limit;
    					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
    					$sql = mysqli_query($koneksi, "SELECT DISTINCT mitramarketer.namaagen,orderagendb.invoice,orderagendb.payment,orderagendb.status,orderagendb.tgl FROM `orderagendb` inner join mitramarketer on mitramarketer.idmitramarketer=orderagendb.idmitramarketer where orderagendb.idmitramarketer='$idmitra' and orderagendb.payment='Lunas' and invoice='$invoice' GROUP BY invoice ORDER BY idorderdb DESC");
					...
					$idmitra=$_SESSION['mitraagen']['idmitramarketer'];
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT mitramarketer.namaagen,orderagendb.invoice,orderagendb.payment,orderagendb.status,orderagendb.tgl FROM `pomitra` inner join poproduk
                    on pomitra.idpoproduk=poproduk.idpoproduk where pomitra.idmitra='$idmitra' and poproduk.status='open' order by pomitra.tgl desc");
					...
					$idmitra=$_SESSION['mitraagen']['idmitramarketer'];
					// Buat query untuk menampilkan data siswa sesuai limit yang ditentukan
					$sql = mysqli_query($koneksi, "SELECT DISTINCT mitramarketer.namaagen,orderagendb.invoice,orderagendb.payment,orderagendb.status,orderagendb.tgl FROM `orderagendb` inner join mitramarketer on mitramarketer.idmitramarketer=orderagendb.idmitramarketer where orderagendb.idmitramarketer='$idmitra' and orderagendb.payment='Lunas'  GROUP BY invoice ORDER BY idorderdb DESC limit 20 ");

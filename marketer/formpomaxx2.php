...
if(!isset($_SESSION["mitraagen"])){
  ...
  $query = "SELECT COUNT(*) as jumlah,poproduk.idpoproduk,poproduk.namapo,poproduk.status FROM poproduk inner join pomaximus on poproduk.idpoproduk=pomaximus.idpoproduk WHERE poproduk.idpoproduk='$idpoproduk' AND pomaximus.idmitramarketer='$idmitramarketer'";
...
echo "
    ...
    <center><b>Anda sudah mengisi Formulir $namapo , Klik Tombol Dibawah ini Jika ingin melihat atau merevisi Invoice, 
      ...
      <a class='btn btn-info' href='datapomax.php?idmitra=$idmitramarketer&id=$id'> INVOICE</a> </center>";
    }
?>
  </table>
  </div><br><br>
                                           ...
                                           // for($x=0;$x<$jmlhtotal;$x++){
                                            //echo number_format($total, 2);
                                             ...
                                             if($sisa['stok']>$jmlh[$x]){
        					                   ...
        					                   (null,'0','0','0','$idmitramarketer','$idpoproduk','$idpo[$x]','$idpodetail[$x]','$jmlh[$x]','$total','M$idpoproduk-$idmitramarketer','Belum Acc DB',NOW())");
        					                   $koneksi->query("update pokategori set stok=stok-'$jmlh[$x]' where idpo='$idpo[$x]'");
		                                        ...
		                                        echo "<script>location='datapomax.php?id=$idpoproduk';</script>";
        					                        ...
        					                        $total=0;
        					                   $koneksi->query("insert into pomaximus (idpomaximus,idadmin,idmitraagen,idmitrareseller,idmitramarketer,idpoproduk,idpo,idpodetail,jumlah,total,invoice,status,tgl) values
        					                   (null,'0','0','0','$idmitramarketer','$idpoproduk','$idpo[$x]','$idpodetail[$x]','$jmlh[$x]','$total','M$idpoproduk-$idmitramarketer','Belum DP',NOW())");

...
if(!isset($_SESSION["mitraagen"])){
  ...
  $idmitramarketer = $_GET['idmitraagen'];
  ...
  if (isset($_POST['ubah'])) {
	...
	$sql = "SELECT COUNT(*) as jumlah FROM mitramarketer WHERE idmitramarketer='$idmitramarketer' AND password = '$passwordlama' ";
	...
	//     cek pass
	    ...
	    if ($hasil['jumlah']==1) {
	      $query = "UPDATE mitramarketer SET password='".$passwordbaru."' WHERE idmitramarketer='".$idmitramarketer."'  ";
	      $sql = mysqli_query($koneksi, $query);
	      echo "<script>
...
<title>Mitra <?php echo $_SESSION['mitramarketer']['namaagen']; ?>| WNJ.ID </title>
...
<!--================ NAVBARU END =================-->
 ...
 <div class="container">
  ...
  <a class="btn btn-default" href='setting.php')>Batal</a>
  </form>

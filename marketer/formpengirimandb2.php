...
$invoice=$_GET["id"];
$berat=$_GET["berat"];
$provinsi=$_SESSION["mitraagen"]["provinsi"];
$kabupaten=$_SESSION["mitraagen"]["kota"];
$kecamatan=$_SESSION["mitraagen"]["kecamatan"];
?>
...
<table id="myJudul" class="w3-table-all w3-centered">
  ...
  <div class="panel panel-default">
    	...
    	<p align="right"><input type="radio" onclick="javascript:window.location.href='formpengirimandb.php?id=<?php echo $invoice; ?>&berat=<?php echo $berat; ?>'; "> Dropship  <input type="radio" onclick="javascript:window.location.href='formpengirimandb2.php?id=<?php echo $invoice; ?>&berat=<?php echo $berat; ?>';"  checked="checked"> Kirim Ke Alamat Pribadi</p>
               
<form method="post">
 
      <div class="form-group">
          <label>Nama Pengirim</label>
    <input type="text" class="form-control" name="namapengirim" value="<?php echo $_SESSION["mitraagen"]['namaagen']; ?>" readonly>
    </div>
    
     <div class="form-group">
          <label>Telepon Pengirim</label>
    <input type="text" class="form-control" name="tlppengirim" value="<?php echo $_SESSION["mitraagen"]['whatsapp']; ?>" readonly>
    </div>    
    ...
    <input type="text" class="form-control" name="namapenerima" value="<?php echo $_SESSION["mitraagen"]['namaagen']; ?>" readonly>
    </div>
    
    <div class="form-group">
    <label>Telepon Penerima</label>
    <input type="text" class="form-control" name="tlppenerima" value="<?php echo $_SESSION["mitraagen"]['whatsapp']; ?>" readonly>
    </div>
    
        <div class="form-group">
    <label>Alamat</label>
    <textarea class="form-control" name="alamat" readonly><?php echo $_SESSION["mitraagen"]['alamat']; ?></textarea>
    </div>
...
include "koneksi.php";
	...
	while($row = $query->fetch_assoc()){
	 ...
	 $total=$total+$ongkir;
	  ...
	  (null,'$namapengirim','$tlppengirim','$namapenerima','$tlppenerima','$alamat','$provinsi','$kabupaten','$kecamatan','$ekspedisi','$layananku','$berat','$ongkir','tidak','$kodepos','$invoice','$total',NOW())";

<?php
    ...
    $keranjang=0;
    $sql2 = "SELECT * FROM keranjang  WHERE idmarketer='$idmitra' and jmlh>0 AND status = 'Active'";
...
<body>
    <header class="container">
        <div class="navbar">
            <div class="logo">
                <a class="aNav" href="index2" onclick="history.back()"><i class="fa-solid fa-angle-left"></i> Kembali</a>
            </div>
            <ul class="links">
                <li style="font-size: 15px;"><a class="aNav" href="view_cart2"><i class="fa-solid fa-cart-shopping"><span class="badgeNav" style="border-radius: .25rem;padding: 3px 3px 3px 3px; background-color: #dc3545; color: white;"><?php echo $keranjang; ?></span></i></a></li>
        ...
        <div class="dropdown_menu">
            <ul class="links">
                ...
                <li><i class="fa-solid fa-cart-shopping"><span class="badgeNav" style="border-radius: .25rem;padding: 3px 3px 3px 3px; background-color: #dc3545; color: white;"><?php echo $keranjang; ?></span><a href="view_cart2" class="keranjang"> Keranjang</a></i></li>

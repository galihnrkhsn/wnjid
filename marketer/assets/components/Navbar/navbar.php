        ...
        <div class="navbar">
            ...
            <ul class="links">
                ...
                <li style="font-size: 15px;">
                    ...
                    <?php 
                    $mitra= $_SESSION ['idmitramarketer'];
                    $ambiljmlh=$koneksi->query("SELECT COUNT(*) as jmlh FROM tinbox where idmitramarketer='$mitra' and status='Belum Dibaca'"); 
            ...
            <ul class="links">
                ...
                <li>
                    ...
                    <span class="badge" style="border-radius: .25rem;padding: 3px 3px 3px 3px; background-color: #dc3545; color: white;">
                            ...
                            <a href="view_cart2" class="keranjang">Keranjang</a>
                        </i>
                    </li>

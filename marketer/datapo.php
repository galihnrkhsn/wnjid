<?php
    ...
    $query2 = "SELECT 
                ...
                FROM poproduk 
                inner join pomitra on poproduk.idpoproduk=pomitra.idpoproduk 
                WHERE poproduk.idpoproduk='$idpoproduk' AND pomitra.idmitramarketer='$idmitramarketer' AND pomitra.invoice = '$invoice'";
...
<body>
    ...
    <div class="container mt-3">
        ...
        <p class="text-left">Nama Mitra  : <?= $queryUser["namaagen"]; ?> </p>
        <p class="text-left">Alamat  : <?= $queryUser["alamat"]; ?> </p>
        ...
        <div class="tab-content mt-5">
            ...
            <div id="agen" class="container tab-pane active">
                <div class="table-responsive">
                        ...
                        <tbody style="float: right;">
                            <?php if ($idpoproduk == 186 || $idpoproduk == 187): ?>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-bottom: 5%;">:</td>
                                    <td style="padding-bottom: 5%;"><?= $angkavoal; ?></td>
                                </tr>
                            <?php endif ?>
                                <tr>
                            ...
                            <?php if ($angka1 % 3 == 0 and $angka2 % 3 == 0 and $angka3 % 3 == 0): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            $sqlharga2 = "SELECT MAX(total) as totalnya, invoice FROM `pomitra` WHERE `idpoproduk`= '$idpoproduk' AND idmitramarketer = '$idmitramarketer' GROUP BY invoice;";
                    ...
                    <p align="left"><strong>Note: </strong><?= $note ?></p>
                    <br>
                    <? if ($idpoproduk == 167 or $idpoproduk == 173 or $idpoproduk == 176): ?>
                        <? if ($angka1 % 3 <> 0): ?>
            ...
            <?php
                $sqlprogres = mysqli_query($koneksi, "SELECT 
                                                        ...
                                                        WHERE pomitra.idmitramarketer='$idmitramarketer' 
    ...
    <?php if ($data2['status'] == "Belum DP" || $data2['status'] == "Belum Acc DB"): ?>
        <?php 
        ...
        ?>
            <div class="d-flex justify-content-center">
                <?php if ($tampilkan['jenis_po'] == "PO dengan Stok"): ?>
                    <button type="submit" class="btn btn-success btn-sm text-center" name="cari" id="linkmiki<?= $tampilkan['idbpo']; ?>">
                        <a style="color:white" href="ubahpostok?id=<?= $idpoproduk; ?>&invoice=<?= $invoice; ?>">Ubah <?= $tampilkan['namapo']; ?></a>
                    </button>
            ...
            <div class="d-flex justify-content-center">
                <?php if ($tampilkan['jenis_po'] == "PO tanpa Stok" || $tampilkan['idpoproduk'] == '292'): ?>
                    <button type="submit" class="btn btn-success btn-sm text-center" name="cari" id="linkmiki<?= $tampilkan['idbpo']; ?>">
                        <a style="color:white" href="ubahpo?id=<?= $idpoproduk; ?>&invoice=<?= $invoice; ?>">Ubah <?= $tampilkan['namapo']; ?></a>
                    </button>
                ...
                <?php if ($tampilkan['jenis_po'] == "PO Custom Tab"): ?>
                    <div name="cari" id="linkmiki<?= $tampilkan['idbpo']; ?>">	
                        ...
                        <button type="submit" class="btn btn-primary btn-sm">
                            <a style="color:white" href="formpo_tabtambah?id=<?= $tampilkan['idpoproduk']; ?>&invoice=<?= $invoice; ?>">Tambah Variant</a>
                        </button>
                        <p id="demomiki<?= $tampilkan['idbpo']; ?>"></p>    
                    </div>     
                <?php endif ?>  
            ...
            <div class="d-flex justify-content-center">
                <?php if ($tampilkan['jenis_po'] == "PO Custom Tab Stok"): ?>
                    <div name="cari" id="linkmiki<?= $tampilkan['idbpo']; ?>">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm">
                            <a style="color:white" href="formpo_tabtambahstok?id=<?= $tampilkan['idpoproduk']; ?>&invoice=<?= $invoice; ?>">Tambah Variant</a>
                        </button>
                        <p id="demomiki<?= $tampilkan['idbpo']; ?>"></p>    
                    </div>          
                <?php endif ?>
            ...
            <div class="d-flex justify-content-center">
                <?php if ($tampilkan['jenis_po'] == "PO Custom Tab Stok Max"): ?>
                    <button type="submit" class="btn btn-success btn-sm" name="cari" id="linkmiki<?= $tampilkan['idbpo']; ?>">
                        <a style="color:white" href="ubahpo_tabmax?id=<?= $idpoproduk; ?>">Ubah <?= $tampilkan['namapo']; ?></a>
                    </button>
                    <p id="demomiki<?= $tampilkan['idbpo']; ?>"></p>
                <?php endif ?>
            </div>
            ...
            <script>
                ...
                var countDownDatemiki<?= $tampilkan['idbpo']; ?> = new Date("<?= $tampilkan['tgl_ubah']; ?> 23:59:00").getTime();

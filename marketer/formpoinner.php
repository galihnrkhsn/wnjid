...
<body>
    ...
    <div class="container mt-3">
        ...
        <form method="post" class="">
            ...
            <button type="submit" name="kirim" class="btn btn-primary btn-sm my-2">Kirim</button>
            <!-- INNER Bandana END -->
        </form>
    </div>
        ...
        if (isset($_POST['kirim'])) {
            try {
                ...
                if (isset($_GET['invoice'])) {
                    ...
                    $invoice = 'M' . $idpoproduk . '-' . $idmitraagen . $angka_acak;
                }
                for ($x = 0; $x < $count; $x++) {
                    $qty_item       = $qty[$x];
                    ...
                    $sql = $koneksi->query("INSERT INTO pomitra
                                                ...
                                                VALUES
                                                    (NULL, '$idmitramarketer', '$idpoproduk', '$idpo', '$idpodetail', '$qty_item', '$custom', '$total_harga', '$invoice', 'Belum Acc DB', NOW(), '$waktu')
                                            ");
                    ...
                    if ($sql) {
                        echo "
                            <script>
                                ...
                                location='datapoinner.php?id=$idpoproduk&invoice=$invoice'
                            </script>
                        ";
                    } else {
                        echo "
                            <script>
                                ...
                                location='formpoinner.php?id=$idpoproduk'
                            </script>
                        ";
                    }

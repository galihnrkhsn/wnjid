<?php
    ...
    $query = "SELECT * FROM mitramarketer 
    LEFT JOIN tb_ro_provinces on mitramarketer.provinsi = tb_ro_provinces.province_id
    LEFT JOIN tb_ro_cities on mitramarketer.kota = tb_ro_cities.city_id
    LEFT JOIN tb_ro_subdistricts on mitramarketer.kecamatan = tb_ro_subdistricts.subdistrict_id

    WHERE mitramarketer.idmitramarketer='$idmitramarketer'";
...
<body>
    ...
    <?php
        ...
        if(isset($_POST['kirim'])){
            ...
            $koneksi->query("UPDATE mitramarketer set alamat='$alamat', provinsi='$provinsi', kota='$kabupaten', kecamatan='$kecamatan', kodepos='$kodepos', titikkordinat='$titikkordinat' where idmitramarketer='$idmitramarketer' ");

<?php 
session_start();
header('Location: /marketer/listpreorder');
...
<!-- ===============================================================indexutama -->
    <table style="width:100%">
      <tr>
        <th>
          <p align="left"><input type="radio" onclick="javascript:window.location.href='modehemat.php'; "> Mode Hemat  &nbsp&nbsp<input type="radio" onclick="javascript:window.location.href='index.php'; " checked="checked"> Mode Cantik
        </p>
        </th>
        <th>
        </th>
...
<div class="container">
          ...
          $sql = mysqli_query($koneksi, "SELECT * from produk 
                                        ...
                                        and harga>0 
                                        and idkategori>0 
                                        and namaproduk LIKE '%$namaproduk%' 
                                        and status=0
         ...
         // Include / load file koneksi.php
          ...
          ?>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-6">
                    <!-- MODIF AWAL -->
                   <div class="card img my-2" style="width:500px;object-fit: cover;border: 0px !important">
                    <?php if ($data['foto']<>""): ?>
                    <img class="card-img-top" src="../distributor/foto/<?php echo $data['foto']; ?>" alt="Card image" style="width:100%;object-fit: cover;height: 50%">
                    <?php endif ?>
                    <?php if ($data['foto']==""): ?>
                      <img class="card-img-top" src="../distributor/foto/nophoto.png" alt="Card image" style="width:100%;object-fit: cover;height: 50%">
                    <?php endif ?>
                    <div class="card-body">
                      <h4 class="card-title">

        ...
        <table class="table table-bordered">
          ...
          ?>
            <tr>
              ...
              ?>
              <a href="listdropship.php?namapo=<?php echo $data['namapo']; ?>&invoice=<?php echo $data['invoice']; ?>&idmitra=<?php echo $idadmin; ?>&id=<?php echo $data['idpoproduk']; ?>"><?php echo $dropship['dropship']; ?></a>
            </td>

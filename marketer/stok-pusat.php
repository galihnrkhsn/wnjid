...
<div class="container">
    ...
    <center>
        <h6 style="font-family:verdana;" class="outset">List Stok Pusat yang tertera hanya sebagai informasi stok per periode, bukan realtime
        stock (perupdate). untuk data realtime dan order mitra menggunakan aplikasi APKWANOJA</h6>
        </center><br>
    ...
    <tbody>
     ...
     <?php
      ...
      $ambil=$koneksi->query("SELECT * FROM produk  LIMIT ".$limit_start.",".$limit." ");   

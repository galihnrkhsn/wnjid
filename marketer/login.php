<?php
// Portal marketer belum jalan (masih maintenance) - blokir login di sini dulu.
...
<html lang="en">
<head>
	<title>Login Mitra Marketer</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100 p-t-1 p-b-5">
				<form method="post" class="login100-form validate-form" >
					<span class="login100-form-title ">
						<img src="style/loginmarketer.png" alt="wanoja" width="90%">
					</span><br>
...
<br>
				...
				<?php 
					...
					if (isset($_POST["login"])) {
						...
						$ambil=$koneksi->query("SELECT * FROM mitramarketer WHERE email='$email' AND password='$pass' ");

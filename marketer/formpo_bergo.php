...
echo "
    ...
    <center><b>Anda sudah mengisi Formulir $namapo , Klik Tombol Dibawah ini Jika ingin melihat atau merevisi Invoice, 
      ...
      <a class='btn btn-info' href='datapo.php?idmitra=$idmitramarketer&id=$id'> INVOICE</a> </center>";
    }
?>
  </table>
  </div><br><br>
  ...
  <div class="container panel panel-default">
		...
		<div style="padding: 0 15px;">
			...
			<li class="active"><a data-toggle="tab" href="#home">Khimar Limosa</a></li>
			<li><a data-toggle="tab" href="#menu1">Khimar Limosa Black Luxury</a></li>
		</ul>
		<br>
		<div class="tab-content">
			<div id="home" class="tab-pane fade in active">								
				...
				<?php
						...
						where poproduk.idpoproduk='$idpoproduk' and pokategori.idpo <>788 order by pokategori.idpo asc";
...
<div id="menu1" class="tab-pane fade">
				...
				<?php
						...
						and pokategori.idpo = 788 order by pokategori.idpo asc";
						$query = $koneksi->query($sql);
							while($row = $query->fetch_assoc()){
								?>

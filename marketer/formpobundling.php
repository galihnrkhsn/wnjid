<?php
    ...
    $getUser = $koneksi->query("SELECT * FROM mitramarketer WHERE idmitramarketer = '$idmitramarketer'");
...
<body>
    ...
    <div class="container mt-3">
        ...
        <form method="post" class="">
            ...
            <!-- INNER KNIT END -->
            <?php 
                    $query  = "SELECT COUNT(*) as jumlah,poproduk.idpoproduk,poproduk.namapo,poproduk.status, pomitra.invoice
                                FROM poproduk 
            ...
            try {
                ...
                for ($x = 0; $x < $count; $x++) {
                    ...
                    $sql = $koneksi->query("INSERT INTO pomitra
                                                    (idpomitra, idmitramarketer, idpoproduk, idpo, idpodetail, jumlah, custom, total, invoice, status, tgl, waktu)
                                                VALUES
                                                    (NULL, '$idmitramarketer', '$idpoproduk', '$idpo', '$idpodetail', '$qty_item', '$custom', '$total_harga', '$invoice', 'Belum DP', NOW(), '$waktu')
                                            ");

...
<div class="container">
     <?php
      $idmitramarketer=$_SESSION["mitraagen"]["idmitramarketer"];
       $ambil=$koneksi->query("SELECT mode FROM mitramarketer where idmitramarketer='$idmitramarketer' "); 
...
if(isset($_POST['kirim'])){
    ...
    $koneksi->query("UPDATE mitramarketer set mode='$mode' where idmitramarketer='$idmitramarketer' ");

...
<html lang="en">
  <head>
    ...
    <title>Mitra <?= $_SESSION['mitraagen']['namaagen']; ?>| WNJ </title>
...
?>
      ...
      <button type="submit" class="btn btn-primary btn-lg" name="cari" id="linkmiki<?= $tampilkan['idbpo']; ?>">
        ...
        <?php if ($tampilkan['idpoproduk'] == '260') : ?>
            <a  style="color:white" href="formpocustomlegging?id=<?= $tampilkan['idpoproduk']; ?>">Link <?= $tampilkan['namapo']; ?></a>
        <?php elseif ($tampilkan['idpoproduk'] == '261') : ?>
            <a  style="color:white" href="formpocustomlegging2?id=<?= $tampilkan['idpoproduk']; ?>">Link <?= $tampilkan['namapo']; ?></a>
...
<?php endif ?>
            ...
            <center>
              ...
              <a href="listdropship.php?&invoice=<?= $data['invoice']; ?>&idmitra=<?= $idadmin; ?>&id=<?= $data['idpoproduk']; ?>" class="btn btn-sm btn-primary">List Dropship</a>
              <?php } ?>                
            </td>

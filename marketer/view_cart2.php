...
<body>
    ...
    <div class="container mt-2">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#home">Ready Stok Reguler</a></li>
            ...
            <div id="home" class="tab-pane fade show active">
                ...
                <form method="POST" action="save_cart.php">
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql = "SELECT keranjang.*, keranjang.status AS statusnya, variants.*, products.namaproduk FROM keranjang
                                        ...
                                        WHERE keranjang.idmarketer = '$idmitra'
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div class="p-2"></div>
                        <div class="p-2"><button type="submit" class="btn btn-success btn-s" name="newSave">Ubah Stock</button></div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        if($total==0) {
                            ...
                            echo "<button type='submit' class='btn btn-primary btn-lg' name='newCheckout'> CHECKOUT <i class='fa-solid fa-chevron-right'></i></button>";
                        }
                        ?>
                    </div>
                </form>
            ...
            <div id="get" class="tab-pane">
                ...
                <form method="POST" action="save_cart.php">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div class="p-2"></div>
                        <div class="p-2"><button type="submit" class="btn btn-success btn-s" name="newSave" id="ubahstock">Ubah Stock</button></div>
                    </div>
                    <div class="alert alert-success alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        Klik Ubah Stock sebelum checkout

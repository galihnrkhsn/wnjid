...
<body>
            ...
            <table class="table table-striped table-bordered table-hover" id="tb_rekening">
                ...
                <tbody>
                    <?php 
                        ...
                        $no=1;
                        $ambil=$koneksi->query("SELECT * FROM rekeningku where idmitramarketer='$idadmin'"); 
    ...
    <?php
      if (isset($_POST['tambah'])) {
          ...
          $sql = "INSERT INTO rekeningku (idrek, idmitramarketer, bank, namapemilik, rekening) VALUES (NULL, '$idadmin', '$bank', '$nama', '$rekening')";
